...
def readme():
    ...
    with io.open(path.join(this_directory, 'READMEPypi.md'), encoding='utf-8') as f:
      return f.read()
...
setup(
  ...
  download_url = 'https://github.com/ieconomics/open-api/raw/master/python/dist/tradingeconomics-0.2.942.zip', 
