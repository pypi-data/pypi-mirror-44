...
class AMQPLogstashHandler(mixins.ConfigFormatterClassMixin, SocketHandler, object):
    ...
    def __init__(self, host='localhost', port=5672, username='guest',
                 ...
                 fqdn=False, facility=None, exchange_routing_key='', formatter_path=None):
