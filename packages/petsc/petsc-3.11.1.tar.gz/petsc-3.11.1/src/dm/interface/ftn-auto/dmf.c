...
PETSC_EXTERN void PETSC_STDCALL  dmgetregionds_(DM dm,DMLabel label,PetscDS *ds, int *__ierr){
*__ierr = DMGetRegionDS(
	(DM)PetscToPointer((dm) ),
	(DMLabel)PetscToPointer((label) ),ds);
}
PETSC_EXTERN void PETSC_STDCALL  dmgetregionnumds_(DM dm,PetscInt *num,DMLabel *label,PetscDS *ds, int *__ierr){
*__ierr = DMGetRegionNumDS(
	(DM)PetscToPointer((dm) ),*num,label,ds);
}
PETSC_EXTERN void PETSC_STDCALL  dmsetregionds_(DM dm,DMLabel label,PetscDS ds, int *__ierr){
