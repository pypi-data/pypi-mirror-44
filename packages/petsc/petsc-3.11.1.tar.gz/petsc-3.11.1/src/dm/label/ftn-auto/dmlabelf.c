...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  dmlabeladdstratum_(DMLabel label,PetscInt *value, int *__ierr){
*__ierr = DMLabelAddStratum(
	(DMLabel)PetscToPointer((label) ),*value);
}
PETSC_EXTERN void PETSC_STDCALL  dmlabeladdstrata_(DMLabel label,PetscInt *numStrata, PetscInt stratumValues[], int *__ierr){
*__ierr = DMLabelAddStrata(
	(DMLabel)PetscToPointer((label) ),*numStrata,stratumValues);
}
PETSC_EXTERN void PETSC_STDCALL  dmlabeladdstratais_(DMLabel label,IS valueIS, int *__ierr){
*__ierr = DMLabelAddStrataIS(
	(DMLabel)PetscToPointer((label) ),
	(IS)PetscToPointer((valueIS) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmlabelreset_(DMLabel label, int *__ierr){
*__ierr = DMLabelReset(
	(DMLabel)PetscToPointer((label) ));
}
...
PETSC_EXTERN void PETSC_STDCALL  dmlabelcomputeindex_(DMLabel label, int *__ierr){
*__ierr = DMLabelComputeIndex(
	(DMLabel)PetscToPointer((label) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmlabelcreateindex_(DMLabel label,PetscInt *pStart,PetscInt *pEnd, int *__ierr){
*__ierr = DMLabelCreateIndex(
	(DMLabel)PetscToPointer((label) ),*pStart,*pEnd);
}
PETSC_EXTERN void PETSC_STDCALL  dmlabeldestroyindex_(DMLabel label, int *__ierr){
*__ierr = DMLabelDestroyIndex(
	(DMLabel)PetscToPointer((label) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmlabelgetbounds_(DMLabel label,PetscInt *pStart,PetscInt *pEnd, int *__ierr){
