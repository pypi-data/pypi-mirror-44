...
PETSC_EXTERN void PETSC_STDCALL  petscsectionsetfromoptions_(PetscSection s, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  petscsectiongetpointmajor_(PetscSection s,PetscBool *pm, int *__ierr){
*__ierr = PetscSectionGetPointMajor(
	(PetscSection)PetscToPointer((s) ),pm);
}
PETSC_EXTERN void PETSC_STDCALL  petscsectionsetpointmajor_(PetscSection s,PetscBool *pm, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  petscsectionextractdofsfromarray_(PetscSection origSection,MPI_Fint * dataType, void*origArray,IS points,PetscSection *newSection,void*newArray[], int *__ierr){
