...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define matfreeintermediatedatastructures_ MATFREEINTERMEDIATEDATASTRUCTURES
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define matfreeintermediatedatastructures_ matfreeintermediatedatastructures
#endif
...
PETSC_EXTERN void PETSC_STDCALL  matfreeintermediatedatastructures_(Mat mat, int *__ierr){
*__ierr = MatFreeIntermediateDataStructures(
	(Mat)PetscToPointer((mat) ));
}
#if defined(__cplusplus)
}
