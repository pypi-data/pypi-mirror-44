...
PETSC_EXTERN void PETSC_STDCALL  petscsortmpiintwithintarray_(PetscMPIInt *n,PetscMPIInt i[],PetscInt Ii[], int *__ierr){
*__ierr = PetscSortMPIIntWithIntArray(*n,i,Ii);
}
