...
PETSC_EXTERN void PETSC_STDCALL  dmplexgetcellnumbering_(DM dm,IS *globalCellNumbers, int *__ierr){
*__ierr = DMPlexGetCellNumbering(
	(DM)PetscToPointer((dm) ),globalCellNumbers);
}
PETSC_EXTERN void PETSC_STDCALL  dmplexgetvertexnumbering_(DM dm,IS *globalVertexNumbers, int *__ierr){
*__ierr = DMPlexGetVertexNumbering(
	(DM)PetscToPointer((dm) ),globalVertexNumbers);
}
PETSC_EXTERN void PETSC_STDCALL  dmplexcreatepointnumbering_(DM dm,IS *globalPointNumbers, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  dmplexcreatelabelfield_(DM dm,DMLabel label,Vec *val, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  dmplexcheckgeometry_(DM dm, int *__ierr){
*__ierr = DMPlexCheckGeometry(
	(DM)PetscToPointer((dm) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmplexcheckpointsf_(DM dm, int *__ierr){
*__ierr = DMPlexCheckPointSF(
	(DM)PetscToPointer((dm) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmplexcheckcellshape_(DM dm,PetscBool *output, int *__ierr){
*__ierr = DMPlexCheckCellShape(
	(DM)PetscToPointer((dm) ),*output);
}
