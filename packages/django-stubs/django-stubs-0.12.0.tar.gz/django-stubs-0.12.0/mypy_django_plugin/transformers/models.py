                ...
                for lvalue, rvalue in helpers.iter_call_assignments(model_defn):
                    if is_related_field(rvalue, module_file):
                        ...
                        if self.model_classdef.fullname == referenced_model_fullname:
                            ...
                            # related_name = helpers.evaluate_text_placeholders(related_name,
                            #                                                   class_name=model_defn.name)
                            # related_query_name = helpers.evaluate_text_placeholders(related_query_name,
                            #                                                         class_name=model_defn.name)
