import collections
from typing import Any, Callable, List, Optional, Tuple, Type, Union, Iterable, DefaultDict, Sequence
...
class Apps:
    ...
    def __init__(self, installed_apps: Optional[Union[Sequence[AppConfigStub], Sequence[str]]] = ...) -> None: ...
    def populate(self, installed_apps: Union[Sequence[AppConfigStub], Sequence[str]] = ...) -> None: ...
