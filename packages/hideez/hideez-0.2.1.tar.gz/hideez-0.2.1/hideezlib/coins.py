...
try:
    ...
    raise ImportError("Failed to load coins.json. "
                      "Check your installation.") from e
...
# fixup for Dogecoin
doge_blockcypher_url = 'https://api.blockcypher.com/v1/doge/main/'
tx_api['Dogecoin'] = TxApiBlockCypher(network='blockcypher_dogecoin',
                                      url=doge_blockcypher_url)
