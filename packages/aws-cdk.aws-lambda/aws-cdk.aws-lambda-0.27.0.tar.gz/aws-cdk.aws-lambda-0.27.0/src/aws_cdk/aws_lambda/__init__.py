...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-lambda", "0.27.0", __name__, "aws-lambda@0.27.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-lambda.CommonPipelineInvokeActionProps")
class CommonPipelineInvokeActionProps(aws_cdk.aws_codepipeline_api.CommonActionProps, jsii.compat.TypedDict, total=False):
    addPutJobResultPolicy: bool
    inputArtifacts: typing.List[aws_cdk.aws_codepipeline_api.Artifact]
...
class IFunction(aws_cdk.cdk.IConstruct, aws_cdk.aws_events.IEventRuleTarget, aws_cdk.aws_logs.ILogSubscriptionDestination, aws_cdk.aws_s3_notifications.IBucketNotificationDestination, aws_cdk.aws_ec2.IConnectable, aws_cdk.aws_stepfunctions.IStepFunctionsTaskResource, jsii.compat.Protocol):
    @staticmethod
    def __jsii_proxy_class__():
    ...
    def add_permission(self, id: str, *, principal: aws_cdk.aws_iam.PolicyPrincipal, action: typing.Optional[str]=None, event_source_token: typing.Optional[str]=None, source_account: typing.Optional[str]=None, source_arn: typing.Optional[str]=None) -> None:
        ...
    ...
    def grant_invoke(self, identity: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        ...
    ...
    @jsii.member(jsii_name="toCodePipelineInvokeAction")
    def to_code_pipeline_invoke_action(self, *, add_put_job_result_policy: typing.Optional[bool]=None, input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, output_artifact_names: typing.Optional[typing.List[str]]=None, user_parameters: typing.Any=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> "PipelineInvokeAction":
        ...


class _IFunctionProxy(jsii.proxy_for(aws_cdk.cdk.IConstruct), jsii.proxy_for(aws_cdk.aws_events.IEventRuleTarget), jsii.proxy_for(aws_cdk.aws_logs.ILogSubscriptionDestination), jsii.proxy_for(aws_cdk.aws_s3_notifications.IBucketNotificationDestination), jsii.proxy_for(aws_cdk.aws_ec2.IConnectable), jsii.proxy_for(aws_cdk.aws_stepfunctions.IStepFunctionsTaskResource)):
    ...
    @jsii.member(jsii_name="toCodePipelineInvokeAction")
    def to_code_pipeline_invoke_action(self, *, add_put_job_result_policy: typing.Optional[bool]=None, input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, output_artifact_names: typing.Optional[typing.List[str]]=None, user_parameters: typing.Any=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> "PipelineInvokeAction":
        props: CommonPipelineInvokeActionProps = {"actionName": action_name}
        ...
        return jsii.invoke(self, "toCodePipelineInvokeAction", [props])
...
class Permission(_Permission):
    principal: aws_cdk.aws_iam.PolicyPrincipal

class PipelineInvokeAction(aws_cdk.aws_codepipeline_api.Action, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda.PipelineInvokeAction"):
    def __init__(self, *, lambda_: "IFunction", add_put_job_result_policy: typing.Optional[bool]=None, input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, output_artifact_names: typing.Optional[typing.List[str]]=None, user_parameters: typing.Any=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> None:
        props: PipelineInvokeActionProps = {"lambda": lambda_, "actionName": action_name}
        ...
        jsii.create(PipelineInvokeAction, self, [props])
    ...
    def output_artifact(self, artifact_name: str) -> aws_cdk.aws_codepipeline_api.Artifact:
        return jsii.invoke(self, "outputArtifact", [artifact_name])

    @jsii.member(jsii_name="outputArtifacts")
    def output_artifacts(self) -> typing.List[aws_cdk.aws_codepipeline_api.Artifact]:
        return jsii.invoke(self, "outputArtifacts", [])


@jsii.data_type(jsii_type="@aws-cdk/aws-lambda.PipelineInvokeActionProps")
class PipelineInvokeActionProps(CommonPipelineInvokeActionProps, jsii.compat.TypedDict):
    lambda_: "IFunction"
...
class SingletonFunction(FunctionBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda.SingletonFunction"):
    ...
    @jsii.member(jsii_name="addPermission")
    def add_permission(self, name: str, *, principal: aws_cdk.aws_iam.PolicyPrincipal, action: typing.Optional[str]=None, event_source_token: typing.Optional[str]=None, source_account: typing.Optional[str]=None, source_arn: typing.Optional[str]=None) -> None:
        permission: Permission = {"principal": principal}
...
__all__ = ["Alias", "AliasProps", "AssetCode", "CfnAlias", "CfnAliasProps", "CfnEventSourceMapping", "CfnEventSourceMappingProps", "CfnFunction", "CfnFunctionProps", "CfnLayerVersion", "CfnLayerVersionPermission", "CfnLayerVersionPermissionProps", "CfnLayerVersionProps", "CfnPermission", "CfnPermissionProps", "CfnVersion", "CfnVersionProps", "Code", "CommonPipelineInvokeActionProps", "EventSourceMapping", "EventSourceMappingProps", "Function", "FunctionBase", "FunctionImportProps", "FunctionProps", "IEventSource", "IFunction", "ILayerVersion", "ImportedFunction", "InlineCode", "LambdaRuntimeProps", "LayerVersion", "LayerVersionBase", "LayerVersionImportProps", "LayerVersionProps", "LayerVersionUsageGrantee", "LogRetention", "LogRetentionProps", "Permission", "PipelineInvokeAction", "PipelineInvokeActionProps", "Runtime", "RuntimeFamily", "S3Code", "SingletonFunction", "SingletonFunctionProps", "SingletonLayerVersion", "SingletonLayerVersionProps", "StartingPosition", "Tracing", "Version", "VersionProps", "VersionWeight", "__jsii_assembly__"]
