...
class TestUrls(TestCase):
    ...
    def test_manage_box_listboard_url(self):
        url = reverse("edc_lab_dashboard:manage_box_listboard_url",
        ...
        self.assertEqual(
            "/edc_lab_dashboard/listboard/box/manage/ABC123/", url)
        ...
        self.assertEqual(
            "/edc_lab_dashboard/listboard/box/manage/ABC123/1/", url)

    def test_verify_box_listboard_url(self):
        url = reverse(
            "edc_lab_dashboard:verify_box_listboard_url", kwargs=dict(action_name="verify", position=22)
        )
        self.assertEqual("/edc_lab_dashboard/listboard/box/verify/22/", url)

        url = reverse(
            "edc_lab_dashboard:verify_box_listboard_url",
            kwargs=dict(action_name="verify",
                        box_identifier="ABC123", position=22),
        )
        self.assertEqual(
            "/edc_lab_dashboard/listboard/box/verify/ABC123/22/", url)
        ...
        self.assertEqual(
            "/edc_lab_dashboard/listboard/box/verify/ABC123/22/1/", url)

    def test_manage_manifest_listboard_url(self):
        url = reverse(
            "edc_lab_dashboard:manage_manifest_listboard_url",
            kwargs=dict(action_name="manage",
                        manifest_identifier="ABC123", page=1),
        )
        self.assertEqual(
            "/edc_lab_dashboard/listboard/manifest/manage/ABC123/1/", url)
        ...
        self.assertEqual(
            "/edc_lab_dashboard/listboard/manifest/manage/ABC123/", url)

        url = reverse(
            "edc_lab_dashboard:manage_manifest_listboard_url", kwargs=dict(action_name="manage")
        )
