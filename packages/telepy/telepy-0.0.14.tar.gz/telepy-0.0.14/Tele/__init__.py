...
def get_updates(offset=None, limit=None,
    ...
    try:
        return _call_api('getUpdates', params=params).json()['result']
    except KeyError:
...
def _offset(update_id=False):
    ...
    try:
        if update_id:
            return get_updates(offset=update_id + 1)
        else:
            return get_updates(offset=get_updates(-1)[-1]['update_id'] - 1)
...
def bot(filters=None, not_on=None, chat_id=None,
        chat_type=None, user_id=None, on_error=None):
    """
    ...
    :param user_id: (:obj:`int`, optional) user id
...
"""
    ...
    :param k: Array of Array of KeyboardButton see examples here:
...
"""
    ...
    :param k: Array of Array of InlineKeyboardButton see examples here:
     https://gitlab.com/2411eliko/tele/blob/master/Examples/keyboard_and_inlinekeyboard.py 
    :param num_line: ** optional ** number of buttons in each line.
