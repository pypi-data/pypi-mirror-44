 ...
 */
    temp = (double *)malloc(sizeof(double) * (degree + 1));
    pt = (double *)malloc(sizeof(double) * (degree + 1));
    p = (double *)malloc(sizeof(double) * (degree + 1));
    qp = (double *)malloc(sizeof(double) * (degree + 1));
    k = (double *)malloc(sizeof(double) * (degree + 1));
    qk = (double *)malloc(sizeof(double) * (degree + 1));
    svk = (double *)malloc(sizeof(double) * (degree + 1));
