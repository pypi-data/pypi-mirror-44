...
class XUnitExt(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option(
            '--xunitext-file', action='store',
            dest='xunitext_file', metavar="FILE",
    ...
    def configure(self, options, config):
        ...
        if self.enabled:
            ...
            self.errorlist = []
            self.alltests = []
            self.error_report_file_name = os.path.realpath(options.xunitext_file)
...
#             
        filename =self.error_report_file_name
...
#                 self.descriptor = descriptor
                ...
                actual.append(t)
                print t
                safe_pickle_dump(t, filename)
        safe_pickle_dump(actual, filename)   
