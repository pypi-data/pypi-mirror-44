...
id = "ba12fd34784addfc22755e6cf877b6e042c14aba"
date = "2019-04-13 13:40:48 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "ba12fd34784addfc22755e6cf877b6e042c14aba":
        return
    msg = "Program id (ba12fd34784addfc22755e6cf877b6e042c14aba) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
