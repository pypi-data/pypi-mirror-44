...
id = "ae6a3cb14c25bfd5fed0518dcfc6ea10a0efff26"
date = "2019-04-4 03:35:42 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "ae6a3cb14c25bfd5fed0518dcfc6ea10a0efff26":
        return
    msg = "Program id (ae6a3cb14c25bfd5fed0518dcfc6ea10a0efff26) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
