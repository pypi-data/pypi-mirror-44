...
from .....lib.image_proccessing.gan.deblur.utils import load_images_data, deprocess_image, write_log, load_predict_images_data, merge_image
...
class Deblur_GAN(Application):
    ...
    def save_merged_image(self, image, saved_path, data_path, now_image_path):
        ...
        image.save(os.path.join(saved_path, now_image_path))
