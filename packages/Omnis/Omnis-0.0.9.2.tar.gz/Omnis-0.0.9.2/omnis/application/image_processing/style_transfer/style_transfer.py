...
class Style_Transfer(Application):
    ...
    def generate(self, base_image_path = None, reference_image_path = None, base_image_array = None, reference_image_array = None,
        ...
        self.result = None
        for child in parent:
            self.generate_one_image(base_image_path, child, reference_image, iterations, output_type, output_path)
    ...
    def generate_one_image(self, base_image_path, child, reference_image, iterations, output_type, output_path):
        ...
        x, model = self.create_model(img_nrows, img_ncols, base_image_path, child, reference_image)
    ...
    def create_model(self, img_nrows, img_ncols, base_image_path, child, reference_image):
