...
class Image_Classification(Application):
    ...
    def train(self,
        ...
        if use_fit_generator == False:
            ...
            if self.get_image_from == 'directory':
                ...
                self.model.fit_generator(train_generator, steps_per_epoch=steps_per_epoch, epochs=epochs, verbose=verbose, callbacks=callbacks, shuffle=shuffle, workers = workers, use_multiprocessing = use_multiprocessing)
    ...
    def create_model(self):
        ...
        # Use multi gpu when available gpu is more than 1
        if self.gpu_num > 1:
