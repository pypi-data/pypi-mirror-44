    ...
    def predict(self, data_array = None, data_path = None, predict_classes = True, batch_size = 32, verbose = 0, steps = None):
        try:
            ...
            if os.path.isdir(data_path):
                ...
                for child in parent:
                    test_img = cv2.imread( os.path.join(data_path, child) )
                    ...
                    if type(predict_classes_list) == type(None):
                        ...
                        prediction_result = self.predict_one_image(predict_classes, data_array, batch_size, verbose, steps)
                        predict_classes_list.append(prediction_result)
    ...
    def evaluate(self, data_path = None):
        try:
            ...
            for class_folder in class_folders:
                one_class_folder = os.path.join(data_path, class_folder)
