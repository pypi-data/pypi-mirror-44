    ...
    def predict(self, data_array = None, data_path = None, predict_classes = True, batch_size = 16, verbose = 0, steps = None):
        try:
            ...
            if os.path.isdir(data_path):
                ...
                test_generator = test_datagen.flow_one_directory(
                ...
                nb_files = len(test_generator.image_filenames)
                probs = self.model.predict_generator(test_generator, steps=ceil(nb_files/float(batch_size)))
