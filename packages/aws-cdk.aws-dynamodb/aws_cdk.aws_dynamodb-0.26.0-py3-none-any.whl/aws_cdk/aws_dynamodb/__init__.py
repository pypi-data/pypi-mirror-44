...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-dynamodb", "0.26.0", __name__, "aws-dynamodb@0.26.0.jsii.tgz")
...
class IScalableTableAttribute(jsii.compat.Protocol):
    ...
    def scale_on_utilization(self, *, target_utilization_percent: jsii.Number) -> None:
        ...
...
class Table(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dynamodb.Table"):
    ...
    @classmethod
    def grant_list_streams(cls, principal: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        return jsii.sinvoke(cls, "grantListStreams", [principal])

    @jsii.member(jsii_name="addGlobalSecondaryIndex")
    def add_global_secondary_index(self, *, partition_key: "Attribute", read_capacity: typing.Optional[jsii.Number]=None, sort_key: typing.Optional["Attribute"]=None, write_capacity: typing.Optional[jsii.Number]=None) -> None:
        props: GlobalSecondaryIndexProps = {"partitionKey": partition_key}
    ...
    def add_local_secondary_index(self, *, sort_key: "Attribute") -> None:
        props: LocalSecondaryIndexProps = {"sortKey": sort_key}
    ...
    def grant(self, principal: typing.Optional[aws_cdk.aws_iam.IPrincipal], *actions: str) -> None:
        return jsii.invoke(self, "grant", [principal, actions])

    @jsii.member(jsii_name="grantFullAccess")
    def grant_full_access(self, principal: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        return jsii.invoke(self, "grantFullAccess", [principal])

    @jsii.member(jsii_name="grantReadData")
    def grant_read_data(self, principal: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        return jsii.invoke(self, "grantReadData", [principal])

    @jsii.member(jsii_name="grantReadWriteData")
    def grant_read_write_data(self, principal: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        return jsii.invoke(self, "grantReadWriteData", [principal])

    @jsii.member(jsii_name="grantStream")
    def grant_stream(self, principal: typing.Optional[aws_cdk.aws_iam.IPrincipal], *actions: str) -> None:
        return jsii.invoke(self, "grantStream", [principal, actions])

    @jsii.member(jsii_name="grantStreamRead")
    def grant_stream_read(self, principal: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        return jsii.invoke(self, "grantStreamRead", [principal])

    @jsii.member(jsii_name="grantWriteData")
    def grant_write_data(self, principal: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        return jsii.invoke(self, "grantWriteData", [principal])
