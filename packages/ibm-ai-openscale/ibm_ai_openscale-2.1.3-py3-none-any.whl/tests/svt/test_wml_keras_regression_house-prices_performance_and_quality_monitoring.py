...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_17_feedback_logging(self):
        ...
        for index, row in feedback_data.iterrows():
            ...
            feedback_data = [[tokenized_messages[0], self.scaler.transform(row['price']).tolist()[0]]]
            self.subscription.feedback_logging.store(feedback_data=feedback_data, feedback_format=FeedbackFormat.WML, fields=['scoring_input', 'target'])
