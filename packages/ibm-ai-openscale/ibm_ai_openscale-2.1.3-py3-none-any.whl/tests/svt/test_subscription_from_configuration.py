...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_04_subscribe_sagemaker_asset_from_configuration(self):
        with open('assets/sagemaker_native_multiclass_breast-cancer_all_monitors_sub_configuration_v1.json', 'r') as fp:
    ...
    def test_17_get_transaction_id(self):
        python_table_content = self.subscription.payload_logging.get_table_content(format='python')
    ...
    def test_18_run_explainability(self):
    ...
    def test_26_stats_on_quality_monitoring_table(self):
        self.subscription.quality_monitoring.print_table_schema()
        self.subscription.quality_monitoring.show_table()
        self.subscription.quality_monitoring.show_table(limit=None)
        self.subscription.quality_monitoring.describe_table()
