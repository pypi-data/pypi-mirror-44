...
class TrainingStats():
    ...
    def __get_boundaries(self, majority, minority, data_type, bucket_size, feature_min, feature_max):
        values = {}
        boundaries = []
        ...
        for feature in feature_attributs[:]:
            ...
            if data_type is not None:
                ...
                if is_numeric and len(key_values) < bucket_size:
                    ...
                    boundaries = self.__get_boundaries(majority, minority, data_type, bucket_size, feature_min, feature_max)
