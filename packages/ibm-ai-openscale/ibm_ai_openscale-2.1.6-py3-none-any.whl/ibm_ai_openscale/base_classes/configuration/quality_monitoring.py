...
class QualityMonitoring:
    ...
    def get_metrics(self, deployment_uid=None, format='samples'):
        """
        ...
        return self._custom_metrics_viewer.get_metrics(deployment_uid=deployment_uid, format=format)
    ...
    def get_table_content(self, format='pandas', limit=None):
        ...
        """
        return self._custom_metrics_viewer.get_table_content(format=format, limit=limit)
