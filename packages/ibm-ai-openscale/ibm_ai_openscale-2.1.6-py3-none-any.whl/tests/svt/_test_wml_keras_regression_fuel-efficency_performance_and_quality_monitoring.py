...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    model_path = os.path.join(os.getcwd(), 'artifacts', 'fuel-efficency', 'fuel-efficency.h5.tgz')
    ...
    def test_05_prepare_deployment(self):
        model_name = "AIOS Keras Fuel Efficency model"
        deployment_name = "AIOS Keras Fuel Efficency deployment"
    ...
    def test_13_score(self):
        ...
        scoring_payload = {'values': [[-0.86934805, -1.0094591,  -0.78405236, -1.0253028,  -0.3797592,  -0.51639657, 0.77467638, -0.46514837, -0.49522541]]}
    ...
    def test_16_feedback_logging(self):
        feedback_payload = [-0.86934805, -1.0094591,  -0.78405236, -1.0253028,  -0.3797592,  -0.51639657, 0.77467638, -0.46514837, -0.49522541]

        feedback_payload = str(feedback_payload)
        feedback_payload += ";[28]"
