...
def parse_version():
    with open(pathlib.Path(__file__).parents[2] / 'prybar.py') as f:
...
latex_documents = [
    (master_doc, 'prybar.tex', 'prybar Documentation',
     'Hal Blackburn', 'manual'),
]
...
man_pages = [
    (master_doc, 'prybar', 'prybar Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'prybar', 'prybar Documentation',
     author, 'prybar', 'One line description of project.',
     'Miscellaneous'),
]
