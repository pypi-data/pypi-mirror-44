...
from altuscli import credentials, DEFAULT_PROFILE_NAME
from altuscli import xform_name
from altuscli.altusrequest import prepare_request_dict
from altuscli.auth import Ed25519v1Auth
from altuscli.auth import RSAv1Auth
from altuscli.configloader import load_config, raw_config_parse
from altuscli.endpoint import DEFAULT_TIMEOUT
from altuscli.exceptions import ClientError, ConfigNotFound, ProfileNotFound
from altuscli.exceptions import OperationNotPageableError
from altuscli.model import ServiceModel
from altuscli.paginate import Paginator
    ...
    def _make_api_call(self, operation_name, api_params):
        ...
        if http.status_code >= 300:
            raise ClientError(
                ...
                http.status_code,
                http.headers.get(ALTUS_REQUEST_ID_HEADER, 'Unknown'))
        else:
...
class Context(object):
    ...
    CONTEXT_VARIABLES = {
        ...
        'profile': (None, ['ALTUS_DEFAULT_PROFILE', 'ALTUS_PROFILE'], None, None),
        'config_file': (None, 'ALTUS_CONFIG_FILE', '~/.altus/config', None),
        'ca_bundle': ('ca_bundle', 'ALTUS_CA_BUNDLE', None, None),
        ...
        'credentials_file': (None, 'ALTUS_SHARED_CREDENTIALS_FILE',
                             '~/.altus/credentials', None),
    }
