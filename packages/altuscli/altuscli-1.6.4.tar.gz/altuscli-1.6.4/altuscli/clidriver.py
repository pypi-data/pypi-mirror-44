...
from altuscli import VERSION
from altuscli import xform_name
from altuscli.argparser import ArgTableArgParser
from altuscli.argparser import MainArgParser
from altuscli.argparser import ServiceArgParser
from altuscli.argprocess import unpack_argument
from altuscli.arguments import BooleanArgument
from altuscli.arguments import CLIArgument
from altuscli.arguments import CustomArgument
from altuscli.arguments import ListArgument
from altuscli.arguments import UnknownArgumentError
from altuscli.clicommand import CLICommand
from altuscli.client import ClientCreator
from altuscli.compat import copy_kwargs
from altuscli.compat import OrderedDict
from altuscli.compat import six
from altuscli.endpoint import EndpointCreator
from altuscli.endpoint import EndpointResolver
from altuscli.extensions.arguments import OverrideRequiredArgsArgument
from altuscli.extensions.cliinputjson import add_cli_input_json
from altuscli.extensions.configure.configure import ConfigureCommand
from altuscli.extensions.generatecliskeleton import add_generate_skeleton
from altuscli.extensions.paginate import add_pagination_params
from altuscli.extensions.paginate import check_should_enable_pagination
from altuscli.formatter import get_formatter
from altuscli.help import OperationHelpCommand
from altuscli.help import ProviderHelpCommand
from altuscli.help import ServiceHelpCommand
from altuscli.loader import Loader
...
from altuscli.retryhandler import create_retry_handler
from altuscli.translate import build_retry_config


LOG = logging.getLogger('altuscli.clidriver')
...
class ServiceCommand(CLICommand):
    ...
    def _create_command_table(self):
        ...
        try:
            __import__('altuscli.extensions.%s.register' % self._name,
                       fromlist=['register']).register(command_table)
        except ImportError as err:
            py3_err = "No module named 'altuscli.extensions.%s'" % self._name
