...
from altuscli.extensions.configure import configure
from altuscli.extensions.configure import ConfigValue
from altuscli.extensions.configure import CREDENTIAL_FILE_COMMENT
from altuscli.extensions.configure import NOT_SET
import mock
from tests import unittest

from . import FakeContext
...
class TestConfigureCommand(unittest.TestCase):
    ...
    def test_configure_command_sends_values_to_writer(self):
        ...
        self.assert_credentials_file_updated_with(
            {ALTUS_ACCESS_KEY_ID_KEY_NAME: 'new_value',
             ALTUS_PRIVATE_KEY_KEY_NAME: 'new_value'},
...
class TestInteractivePrompter(unittest.TestCase):
    ...
    def setUp(self):
        self.input_patch = mock.patch('altuscli.compat.raw_input')
    ...
    def test_access_key_is_masked(self):
        ...
        response = prompter.get_value(
            current_value='myaccesskey', config_name=ALTUS_ACCESS_KEY_ID_KEY_NAME,
    ...
    def test_access_key_not_masked_when_none(self):
        ...
        prompter = configure.InteractivePrompter()
        response = prompter.get_value(
            current_value=None, config_name=ALTUS_ACCESS_KEY_ID_KEY_NAME,
            prompt_text='Access key')
        # First we should return the value from raw_input.
        self.assertEqual(response, 'foo')
        prompt_text = self.stdout.getvalue()
    ...
    def test_private_key_is_masked(self):
        ...
        prompter.get_value(
            ...
            config_name=ALTUS_PRIVATE_KEY_KEY_NAME,
...
class TestConfigValueMasking(unittest.TestCase):
    ...
    def test_config_value_is_masked(self):
        config_value = ConfigValue(
            'fake_access_key', 'config_file', ALTUS_ACCESS_KEY_ID_KEY_NAME)
