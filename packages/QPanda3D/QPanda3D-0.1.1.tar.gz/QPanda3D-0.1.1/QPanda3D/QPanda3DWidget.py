...
class QPanda3DWidget(QWidget):
    ...
    def paintEvent(self,  event):
        if self.panda3DWorld.screenTexture.mightHaveRamImage():
            ...
            #self.paintSurface.setBackground(QBrush(QColor(0,0,0,1)))
            self.paintSurface.fillRect(0,0,self.panda3DWorld.screenTexture.getXSize(),self.panda3DWorld.screenTexture.getYSize(),Qt.black)
