...
class ComponentTF(object):
    ...
    def addComp(self, name, comp, is_complete=False):
        ...
        if is_complete:
            ...
            def customizedComp(**kwargs):
                message = []
                for m, msg in enumerate(comp.message):
                    if isinstance(msg, str):
                        message.append(kwargs.get(msg[1:], msg))
                    else:
                        message.append(msg)
    ...
    def conv_2d(self, **kwargs):
        message = kwargs.get('input', '.input')
    ...
    def batch_norm(self, **kwargs):
        message = kwargs.get('input', '.input')
        return Pod(partial(self._batch_norm, **kwargs), 'input', kwargs['name'], [message])
    ...
    def sigm_xentropy(self, **kwargs):
        message = []
        message.append(kwargs.get('input', '.input'))
        message.append(kwargs.get('label', '.label'))
        return Pod(partial(self._sigm_xentropy, **kwargs), 'input', kwargs['name'], message)
    ...
    def sftm_xentropy(self, **kwargs):
        ...
        message.append(kwargs.get('input', '.input'))
        message.append(kwargs.get('label', '.label'))
        return Pod(partial(self._sftm_xentropy, **kwargs), 'input', kwargs['name'], message)
    ...
    def mse(self, **kwargs):
        ...
        message.append(kwargs.get('input', '.input'))
        message.append(kwargs.get('label', '.label'))
        return Pod(partial(self._mse, **kwargs), 'input', kwargs['name'], message)
    ...
    def mae(self, **kwargs):
        ...
        message.append(kwargs.get('input', '.input'))
        message.append(kwargs.get('label', '.label'))
        return Pod(partial(self._mae, **kwargs), 'input', kwargs['name'], message)
    ...
    def momentum(self, **kwargs):
        message = kwargs.get('input', '.input')
        return Pod(partial(self._momentum, **kwargs), 'input', kwargs['name'], [message])
    ...
    def nesterov(self, **kwargs):
        message = kwargs.get('input', '.input')
        return Pod(partial(self._nesterov, **kwargs), 'input', kwargs['name'], [message])
    ...
    def adam(self, **kwargs):
        message = kwargs.get('input', '.input')
        return Pod(partial(self._adam, **kwargs), 'input', kwargs['name'], [message])
    ...
    def accuracy_cls(self, **kwargs):
        ...
        message.append(kwargs.get('input', '.input'))
        message.append(kwargs.get('label', '.label'))
        return Pod(partial(self._accuracy_cls, **kwargs), 'input', kwargs['name'], message)
