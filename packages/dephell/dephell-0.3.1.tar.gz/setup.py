...
setup(
    ...
    packages=[
        'dephell', 'dephell.commands', 'dephell.config', 'dephell.controllers',
        'dephell.converters', 'dephell.links', 'dephell.models',
    ...
    install_requires=[
        ...
        'dephell-discover', 'dephell-licenses', 'dephell-markers',
        'dephell-pythons', 'dephell-shells', 'dephell-specifier',
        'editorconfig', 'jinja2', 'm2r', 'packaging', 'pip', 'requests',
        'tomlkit', 'tqdm'
    ],
    extras_require={
