...
class OnshapeXBlock(StudioEditableXBlockMixin, XBlock):
    ...
    def studio_view(self, context):
        ...
        frag.add_javascript_url("https://cdnjs.cloudflare.com/ajax/libs/react/15.4.2/react.js")
        frag.add_javascript_url("https://cdnjs.cloudflare.com/ajax/libs/react/15.4.2/react-dom.js")
        frag.add_javascript_url("https://cdnjs.cloudflare.com/ajax/libs/babel-standalone/6.21.1/babel.min.js")
        frag.add_javascript_url("https://unpkg.com/react-jsonschema-form/dist/react-jsonschema-form.js")
