...
class omxware:
    ...
    def genome(self, accession_number, fromCache=True, output='top'):
...
#######################################################################################################################
    ...
    def gene(self, GENE_UID_KEY, fromCache=True, output='top'):
        '''
...
#######################################################################################################################
    ...
    def protein(self, PROTEIN_UID_KEY, fromCache=True, output='top'):
        '''
