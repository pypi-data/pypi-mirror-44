...
class ScheduleJobUtil:
  ...
  def schedule_job(self, local_kubernetes_cluster=True):
    ...
    Args:
      local_kubernetes_cluster: Whether Kubernetes cluster is a local Kubernetes cluster. If False,
          the cluster should be a Google Cloud Kubernetes cluster.
    ...
    # Unmount Google Cloud Storage after running the image.
    pre_stop_command = [
        "/bin/sh", "-c",
        """
