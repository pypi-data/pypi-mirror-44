...
def g_constrain_similarity(graph1, graphs2, node1_problem, nodes2_problem, sequential_dictionary, window, threshold=0.0):
    '''
    ...
    for j in range(len(graphs2)):
        current = g_constrain_analysis(node1_problem, graph1, graphs2[j], sequential_dictionary, window)
...
def g_constrain_analysis(node_problem1, graph1, graph2, sequential_dictionary, window):
    '''
    ...
    constrain = ponderation_stimation(node_problem1, nodes_with_equivalences, graph1, window) #/float(len(nodes1))
