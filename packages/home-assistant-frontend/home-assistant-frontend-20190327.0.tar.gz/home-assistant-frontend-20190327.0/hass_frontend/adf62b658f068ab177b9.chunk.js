/*! For license information please see adf62b658f068ab177b9.chunk.js.LICENSE */
(window.webpackJsonp=window.webpackJsonp||[]).push([[7],{103:function(e,r,t){"use strict";t.d(r,"a",function(){return a});t(2);const a={properties:{value:{type:Number,value:0,notify:!0,reflectToAttribute:!0},min:{type:Number,value:0,notify:!0},max:{type:Number,value:100,notify:!0},step:{type:Number,value:1,notify:!0},ratio:{type:Number,value:0,readOnly:!0,notify:!0}},observers:["_update(value, min, max, step)"],_calcRatio:function(e){return(this._clampValue(e)-this.min)/(this.max-this.min)},_clampValue:function(e){return Math.min(this.max,Math.max(this.min,this._calcStep(e)))},_calcStep:function(e){if(e=parseFloat(e),!this.step)return e;var r=Math.round((e-this.min)/this.step);return this.step<1?r/(1/this.step)+this.min:r*this.step+this.min},_validateValue:function(){var e=this._clampValue(this.value);return this.value=this.oldValue=isNaN(e)?this.oldValue:e,this.value!==e},_update:function(){this._validateValue(),this._setRatio(100*this._calcRatio(this.value))}}},143:function(e,r,t){"use strict";t(2),t(41);var a=t(114),i=t(55),n=t(4),o=t(3),s=t(59);const l=o.a`<style>
  :host {
...
//# sourceMappingURL=adf62b658f068ab177b9.chunk.js.map