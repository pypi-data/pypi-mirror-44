...
class Dataflow:
    ...
    def to_spark_dataframe(self) -> 'pyspark.sql.DataFrame':
        """
        Creates a Spark :class:`pyspark.sql.DataFrame` that can execute the transformation pipeline defined by this
        Dataflow.
    ...
    def verify_has_data(self):
        ...
        profile = self.take(1).get_profile()
    ...
    def transform_partition(self,
        ...
        .. remarks::
            ...
            partition and the index argument is a unique identifier of the partition. Note that df does not usually
            contain all of the data in the dataflow, but a partition of the data as it is being processed in the
