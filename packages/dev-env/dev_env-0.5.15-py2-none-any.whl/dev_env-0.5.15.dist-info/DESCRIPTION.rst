...
-  take a look at the `shell and python scripts <bin>`__ to assess
   ``dev-env`` capability
-  `here's <https://github.com/simonsdave/dev-env/tree/release-0.5.15/docs/using.md>`__
...
-  if you'd like to help contribute to ``dev-env`` see
   `this <https://github.com/simonsdave/dev-env/tree/release-0.5.15/docs/contributing.md>`__
...
.. |CircleCI| image:: https://circleci.com/gh/simonsdave/dev-env.svg?style=svg
