...
class Client(object):
    API_ENDPOINT = 'https://way2enjoy.com/modules/compress-png/way2enjoy-cli2.php'

    RETRY_COUNT = 1
    RETRY_DELAY = 500

    USER_AGENT = 'way2enjoypy/{0} Python/{1} ({2})'.format(way2enjoypy.__version__, platform.python_version(), platform.python_implementation())
    ...
    def request(self, method, url, body=None):
        ...
        for retries in range(self.RETRY_COUNT, -1, -1):
            ...
            if count:
                way2enjoypy.compression_count = int(count)
