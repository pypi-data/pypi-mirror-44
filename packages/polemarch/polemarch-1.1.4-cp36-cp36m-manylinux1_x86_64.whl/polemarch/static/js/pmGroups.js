...
tabSignal.connect("guiList.renderLine.group",function(obj){if(obj.dataLine.line.children)
...
tabSignal.connect("guiList.renderPage.group",function(obj){if(obj.data.children)
