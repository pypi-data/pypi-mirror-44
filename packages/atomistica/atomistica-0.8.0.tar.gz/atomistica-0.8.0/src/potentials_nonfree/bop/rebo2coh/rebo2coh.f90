...
!    classtype:rebo2coh_t classname:Rebo2coh interface:potentials
! @endmeta
...
#define BOP_NAME       rebo2coh
#define BOP_NAME_STR   "rebo2coh"
#define BOP_STR        "Rebo2coh"
#define BOP_KERNEL     rebo2coh_kernel
#define BOP_TYPE       rebo2coh_t

#define REGISTER_FUNC        rebo2coh_register
#define INIT_FUNC            rebo2coh_init
#define INIT_DEFAULT_FUNC    rebo2coh_init_default
#define DEL_FUNC             rebo2coh_del
#define BIND_TO_FUNC         rebo2coh_bind_to
#define COMPUTE_FUNC         rebo2coh_energy_and_forces
