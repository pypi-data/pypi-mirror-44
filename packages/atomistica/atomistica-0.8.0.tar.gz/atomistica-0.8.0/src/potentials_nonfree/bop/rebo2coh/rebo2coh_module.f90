...
!! ======================================================================
  ...
  subroutine rebo2coh_init_default_database(this)
    ...
    if (.not. this%zero_tables) then
       ...
       call rebo2coh_default_Pcc_table(this%in_Pcc, this%in_dPccdi, &
            this%in_dPccdj)
       call rebo2coh_default_Pcc_o_table(this%in_Pcc_o, this%in_dPcc_odi, &
            this%in_dPcc_odj)
       call rebo2coh_default_Pch_table(this%in_Pch, this%in_dPchdi, &
            this%in_dPchdj)
       call rebo2coh_default_Pch_o_table(this%in_Pch_o, this%in_dPch_odi, &
            this%in_dPch_odj)
  ...
  subroutine INIT_FUNC(this)
    ...
    if (this%zero_tables) then
        ...
        this%in_Pcc_o = 0.0_DP
        this%in_dPcc_odi = 0.0_DP
        this%in_dPcc_odj = 0.0_DP

        this%in_Pch = 0.0_DP
        this%in_dPchdi = 0.0_DP
        this%in_dPchdj = 0.0_DP

        this%in_Pch_o = 0.0_DP
        this%in_dPch_odi = 0.0_DP
        this%in_dPch_odj = 0.0_DP
  ...
  subroutine INIT_DEFAULT_FUNC(this, Fcc, dFdi, dFdj, dFdk, Fch, Fhh, Foc, &
       Foh, Foo, Pcc, Pcc_o, Pch, Pch_o, Phh, Poc, Pco, Poh, Pho, Poo, Tcc, dTccdi, dTccdj, dTccdk, ierror)
    implicit none
    ...
    real(DP), optional, intent(in)    :: Pcc(0:5, 0:5)
    real(DP), optional, intent(in)    :: Pcc_o(0:5, 0:5)
    real(DP), optional, intent(in)    :: Pch(0:5, 0:5)
    real(DP), optional, intent(in)    :: Pch_o(0:5, 0:5)
    real(DP), optional, intent(in)    :: Phh(0:5, 0:5)
    real(DP), optional, intent(in)    :: Poc(0:5, 0:5)
    real(DP), optional, intent(in)    :: Pco(0:5, 0:5)
    real(DP), optional, intent(in)    :: Poh(0:5, 0:5)
    real(DP), optional, intent(in)    :: Pho(0:5, 0:5)
    real(DP), optional, intent(in)    :: Poo(0:5, 0:5)
  ...
  subroutine BIND_TO_FUNC(this, p, nl, ierror)
    ...
    call rebo2coh_db_init_with_parameters( &
         ...
         this%in_Pcc,   this%in_dPccdi,   this%in_dPccdj,   &
         this%in_Pcc_o, this%in_dPcc_odi, this%in_dPcc_odj, &
         this%in_Pch,   this%in_dPchdi,   this%in_dPchdj,   &
         this%in_Pch_o, this%in_dPch_odi, this%in_dPch_odj, &
         this%in_Phh,   this%in_dPhhdi,   this%in_dPhhdj,   &
         this%in_Poc,   this%in_dPocdi,   this%in_dPocdj,   &
         this%in_Pco,   this%in_dPcodi,   this%in_dPcodj,   &
         this%in_Poh,   this%in_dPohdi,   this%in_dPohdj,   &
         this%in_Pho,   this%in_dPhodi,   this%in_dPhodj,   &
         this%in_Poo,   this%in_dPoodi,   this%in_dPoodj,   & 
