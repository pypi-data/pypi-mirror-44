...
!
  ...
  type BOP_TYPE
     ...
     character(MAX_EL_STR)  :: elements = "C,H,O"
     integer                :: els
     ...
     real(DP)             :: HH_B1     = 29.6325931_DP
     real(DP)             :: HH_beta1  = 1.715892169856421_DP
     ...
     real(DP)             :: HH_Q     = 0.3704714870452888_DP
     real(DP)             :: HH_A     = 32.81735574722296_DP
     real(DP)             :: HH_alpha = 3.536298648376465_DP
...
!     DATA IGH/18*3,4*2,3*1/
     ...
     !
     !  Attractive function (O-O)
     !  [ From Table 2 Ni 2004 ]
     !

     real(DP)           :: OO_B1      = 1105.0_DP
     real(DP)           :: OO_beta1   = 1.325_DP
     ...
     real(DP)           :: OO_Q       = 0.4065_DP
     real(DP)           :: OO_A       = 685.2555_DP  ! reference code
     real(DP)           :: OO_alpha   = 1.173_DP
     ...
     !                                            ----------|----------|----------|----------|----------|
!     real(DP)             :: OO_g_theta(4) = (/    -1.0_DP,        -1.0_DP/2,    -1.0_DP/3,    1.0_DP  /)
!     real(DP)             :: OO_g_g(4)     = (/    -0.122736935_DP,   -0.044734259_DP, -0.000223579_DP, 0.980_DP   /)
!     real(DP)             :: OO_g_dg(4)    = (/    0.065720_DP,        0.249121746_DP,  0.308832492_DP, 1.80_DP  /)
!     real(DP)             :: OO_g_d2g(4)   = (/    0.320763152_DP,     0.380715536_DP,  1.125000_DP,    2.6100_DP /)

     real(DP) :: OO_g_a0 = -0.014_DP
     real(DP) :: OO_g_a1 = 0.07_DP
     real(DP) :: OO_g_a2 = -0.478_DP


     !
     ! Attractive function (O-H)
     ! [ values from reference code ]
     !

     real(DP)             :: OH_B1     = 884.5045_DP
     real(DP)             :: OH_beta1  = 1.704_DP

     !
     ! Repulsive function (O-H)
     ! [ values from reference code ]
     !

     real(DP)             :: OH_Q     = 0.12400_DP
     real(DP)             :: OH_A     = 717.14950_DP
     real(DP)             :: OH_alpha = 1.628_DP

     !
     ! Attractive function (O-C)
     ! [ Table 2 from Ni 2004 ]
     !

     real(DP)             :: OC_B1     = 268.04_DP
     real(DP)             :: OC_beta1  = 2.344_DP

     !
     ! Repulsive function (O-C)
     ! [ Table 2 from Ni 2004 ]
     !

     real(DP)             :: OC_Q     = 9.132_DP
     real(DP)             :: OC_A     = 81.058_DP
     real(DP)             :: OC_alpha = 3.554_DP
     ...
     real(DP)             :: OO_in_r1 = 1.55_DP
     real(DP)             :: OO_in_r2 = 1.80_DP  ! reference code - no chance to get this value from the literature ...

     real(DP)             :: OH_in_r1 = 1.20_DP
     real(DP)             :: OH_in_r2 = 1.70_DP

     real(DP)             :: OC_in_r1 = 1.60_DP
     real(DP)             :: OC_in_r2 = 1.90_DP
     ...
     real(DP)             :: OO_out_r1 = 1.80_DP
     real(DP)             :: OO_out_r2 = 2.45_DP

     real(DP)             :: OH_out_r1 = 1.70_DP
     real(DP)             :: OH_out_r2 = 2.20_DP

     real(DP)             :: OC_out_r1 = 1.90_DP
     real(DP)             :: OC_out_r2 = 2.80_DP
     ...
     real(DP)             :: OO_bo_r1 = 1.80_DP
     real(DP)             :: OO_bo_r2 = 2.45_DP

     real(DP)             :: OH_bo_r1 = 1.70_DP
     real(DP)             :: OH_bo_r2 = 2.20_DP

     real(DP)             :: OC_bo_r1 = 1.90_DP
     real(DP)             :: OC_bo_r2 = 2.80_DP
     ...
     real(DP)             :: OO_nc_r1 = 1.80_DP
     real(DP)             :: OO_nc_r2 = 2.45_DP

     real(DP)             :: OH_nc_r1 = 1.70_DP
     real(DP)             :: OH_nc_r2 = 2.20_DP

     real(DP)             :: OC_nc_r1 = 1.90_DP
     real(DP)             :: OC_nc_r2 = 2.80_DP
     ...
     type(table2d_t)  :: Pcc
     type(table2d_t)  :: Pcc_o
     type(table2d_t)  :: Pch
     type(table2d_t)  :: Pch_o
     type(table2d_t)  :: Phh
     type(table2d_t)  :: Poc
     type(table2d_t)  :: Pco
     type(table2d_t)  :: Poh
     ...
     !
     ! Switching region between Pch and Pch_o
     ! for C-H bonds with surrounding O atoms
     !

     real(DP) :: n_o_min = 0.01_DP
     real(DP) :: n_o_max = 0.21_DP
...
#define N_NI_NJ_NCONJ 4, 4, 9
     ...
     real(DP)  :: in_Pcc_o(R_NHC_NO) = 0.0_DP
     real(DP)  :: in_dPcc_odi(R_NHC_NO) = 0.0_DP
     real(DP)  :: in_dPcc_odj(R_NHC_NO) = 0.0_DP

     real(DP)  :: in_Pch(R_NHC_NO) = 0.0_DP
     real(DP)  :: in_dPchdi(R_NHC_NO) = 0.0_DP
     real(DP)  :: in_dPchdj(R_NHC_NO) = 0.0_DP

     real(DP)  :: in_Pch_o(R_NHC_NO) = 0.0_DP
     real(DP)  :: in_dPch_odi(R_NHC_NO) = 0.0_DP
     real(DP)  :: in_dPch_odj(R_NHC_NO) = 0.0_DP
