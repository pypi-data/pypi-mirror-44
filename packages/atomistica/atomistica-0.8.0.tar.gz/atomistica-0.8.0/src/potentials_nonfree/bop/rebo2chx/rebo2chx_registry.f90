...
!!===============================================================
    ...
    call ptrdict_register_real_property(m, c_loc(this%cc_bo_r1), &
         CSTR("CC_bo_r1"), CSTR("r1 for C-C interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%cc_bo_r2), &
         CSTR("CC_bo_r2"),  CSTR("r2 for C-C interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%ch_bo_r1), &
         CSTR("CH_bo_r1"), CSTR("r1 for C-H interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%ch_bo_r2), &
         CSTR("CH_bo_r2"),  CSTR("r2 for C-H interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%hh_bo_r1), &
         CSTR("HH_bo_r1"), CSTR("r1 for H-H interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%hh_bo_r2), &
         CSTR("HH_bo_r2"),  CSTR("r2 for H-H interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%oo_bo_r1), &
         CSTR("OO_bo_r1"), CSTR("r1 for O-O interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%oo_bo_r2), &
         CSTR("OO_bo_r2"),  CSTR("r2 for O-O interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%oh_bo_r1), &
         CSTR("OH_bo_r1"), CSTR("r1 for O-H interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%oh_bo_r2), &
         CSTR("OH_bo_r2"),  CSTR("r2 for O-H interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%oc_bo_r1), &
         CSTR("OC_bo_r1"), CSTR("r1 for O-C interaction (bij and dihedral)."))
    call ptrdict_register_real_property(m, c_loc(this%oc_bo_r2), &
         CSTR("OC_bo_r2"),  CSTR("r2 for O-C interaction (bij and dihedral)."))
    ...
    call ptrdict_register_array3d_property(m, c_loc111(this%in_Foc), 5, 5, 10, &
         CSTR("Foc"), CSTR("Foc-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFocdi), 5, 5, 10, &
         CSTR("dFocdi"), CSTR("dFocdi"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFocdj), 5, 5, 10, &
         CSTR("dFocdj"), CSTR("dFocdj"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFocdk), 5, 5, 10, &
         CSTR("dFocdk"), CSTR("dFocdk"))

    call ptrdict_register_array3d_property(m, c_loc111(this%in_Foh), 5, 5, 10, &
         CSTR("Foh"), CSTR("Foh-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFohdi), 5, 5, 10, &
         CSTR("dFohdi"), CSTR("dFohdi"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFohdj), 5, 5, 10, &
         CSTR("dFohdj"), CSTR("dFohdj"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFohdk), 5, 5, 10, &
         CSTR("dFohdk"), CSTR("dFohdk"))

    call ptrdict_register_array3d_property(m, c_loc111(this%in_Foo), 5, 5, 10, &
         CSTR("Foo"), CSTR("Foo-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFoodi), 5, 5, 10, &
         CSTR("dFoodi"), CSTR("dFoodi"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFoodj), 5, 5, 10, &
         CSTR("dFoodj"), CSTR("dFoodj"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dFoodk), 5, 5, 10, &
         CSTR("dFoodk"), CSTR("dFoodk"))
    ...
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPchdi), 6, 6, 6, &
         CSTR("dPchdi"), CSTR("dPchdi-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPchdj), 6, 6, 6, &
         CSTR("dPchdj"), CSTR("dPchdj-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPchdk), 6, 6, 6, &
         CSTR("dPchdk"), CSTR("dPchdk-table"))

    call ptrdict_register_array3d_property(m, c_loc111(this%in_Phh), 6, 6, 6, &
         CSTR("Phh"), CSTR("Phh-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPhhdi), 6, 6, 6, &
         CSTR("dPhhdi"), CSTR("dPhhdi-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPhhdj), 6, 6, 6, &
         CSTR("dPhhdj"), CSTR("dPhhdj-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPhhdk), 6, 6, 6, &
         CSTR("dPhhdk"), CSTR("dPhhdk-table"))

    call ptrdict_register_array3d_property(m, c_loc111(this%in_Poc), 6, 6, 6, &
         CSTR("Poc"), CSTR("Poc-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPocdi), 6, 6, 6, &
         CSTR("dPocdi"), CSTR("dPocdi-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPocdj), 6, 6, 6, &
         CSTR("dPocdj"), CSTR("dPocdj-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPocdk), 6, 6, 6, &
         CSTR("dPocdk"), CSTR("dPocdk-table"))

    call ptrdict_register_array3d_property(m, c_loc111(this%in_Pco), 6, 6, 6, &
         CSTR("Pco"), CSTR("Pco-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPcodi), 6, 6, 6, &
         CSTR("dPcodi"), CSTR("dPcodi-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPcodj), 6, 6, 6, &
         CSTR("dPcodj"), CSTR("dPcodj-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPcodk), 6, 6, 6, &
         CSTR("dPcodk"), CSTR("dPcodk-table"))

    call ptrdict_register_array3d_property(m, c_loc111(this%in_Poh), 6, 6, 6, &
         CSTR("Poh"), CSTR("Poh-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPohdi), 6, 6, 6, &
         CSTR("dPohdi"), CSTR("dPohdi-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPohdj), 6, 6, 6, &
         CSTR("dPohdj"), CSTR("dPohdj-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPohdk), 6, 6, 6, &
         CSTR("dPohdk"), CSTR("dPohdk-table"))

    call ptrdict_register_array3d_property(m, c_loc111(this%in_Pho), 6, 6, 6, &
         CSTR("Pho"), CSTR("Pho-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPhodi), 6, 6, 6, &
         CSTR("dPhodi"), CSTR("dPhodi-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPhodj), 6, 6, 6, &
         CSTR("dPhodj"), CSTR("dPhodj-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPhodk), 6, 6, 6, &
         CSTR("dPhodk"), CSTR("dPhodk-table"))

    call ptrdict_register_array3d_property(m, c_loc111(this%in_Poo), 6, 6, 6, &
         CSTR("Poo"), CSTR("Poo-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPoodi), 6, 6, 6, &
         CSTR("dPoodi"), CSTR("dPoodi-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPoodj), 6, 6, 6, &
         CSTR("dPoodj"), CSTR("dPoodj-table"))
    call ptrdict_register_array3d_property(m, c_loc111(this%in_dPoodk), 6, 6, 6, &
         CSTR("dPoodk"), CSTR("dPoodk-table"))
