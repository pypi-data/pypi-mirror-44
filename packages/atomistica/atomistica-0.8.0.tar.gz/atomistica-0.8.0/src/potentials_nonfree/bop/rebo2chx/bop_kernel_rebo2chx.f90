...
!    integer,   intent(in)    :: a2ptr(maxnat+1)
    ...
    real(DP)  :: pij,pji,dpdnci,dpdnhi,dpdnoi,dpdncj,dpdnhj,dpdnoj
                ...
                ar_within_cutoff: if (rlij < this%cut_out_h(ijpot)) then
                   ...
                   ik_loop: do ik = istart, ifinsh
                      ...
                      ik_neq_ij: if (ik /= ij) then
                         ...
                         ktypk_eq_C: if (ktypk == rebo2_C_) then
                            ...
                            call fconj_C(this, xik, fxik(ikc), dfxikx)
...
#ifdef NUM_NEIGHBORS
                            call g(this, ktypi, ktypj, ktypk, costh, nti, g_costh, dg_dcosth, dg_dn)
#else
                   ...
                   if (ktypi == rebo2_C_) then
                      if (ktypj == rebo2_C_) then
                         call eval(this%Pcc, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij, dpdnhi, dpdnci, dpdnoi)
                      endif
                   endif

                   if (ktypi == rebo2_C_) then
                      if (ktypj == rebo2_H_) then
                         call eval(this%Pch, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij, dpdnhi, dpdnci, dpdnoi)
                      endif
                   endif

                   if (ktypi == rebo2_C_) then
                      if (ktypj == rebo2_O_) then
                         call eval(this%Pco, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij, dpdnhi, dpdnci, dpdnoi)
                      endif
                   endif

                   if (ktypi == rebo2_O_) then
                      if (ktypj == rebo2_C_) then
                         call eval(this%Poc, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij, dpdnhi, dpdnci, dpdnoi)
                      endif
                   endif

                   if (ktypi == rebo2_O_) then
                      if (ktypj == rebo2_H_) then
                         call eval(this%Poh, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij, dpdnhi, dpdnci, dpdnoi)
                      endif
                   endif

                   if (ktypi == rebo2_O_) then
                      if (ktypj == rebo2_O_) then
                         call eval(this%Poo, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij, dpdnhi, dpdnci, dpdnoi)
                      endif
                   endif

                   if (ktypi == rebo2_H_) then
                      if (ktypj == rebo2_O_) then
                         call eval(this%Pho, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij, dpdnhi, dpdnci, dpdnoi)
                      endif
                   endif

                   if (ktypi == rebo2_H_) then
                      if (ktypj == rebo2_H_) then
                         call eval(this%Phh, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij, dpdnhi, dpdnci, dpdnoi)
                      endif
                   endif
...
!                   write (*, '(A,2I3,4F15.7)')  "(ij) P "//rebo2_el_strs(ktypi)//" "//rebo2_el_strs(ktypj)//":", i, j, ni(rebo2_H_), ni(rebo2_C_), ni(rebo2_O_), pij
                   ...
                   jl_loop: do jl = this%neb_seed(j), this%neb_last(j)
                      ...
                      l_neq_i: if (l /= i .or. ldc /= 0) then
                         ...
                         ktypl_eq_C: if (ktypl == rebo2_C_) then
                            ...
                            call fconj_C(this, xjl, fxjl(jlc), dfxjlx)
...
#ifdef NUM_NEIGHBORS
                            call g(this, ktypj, ktypi, ktypl, costh, ntj, g_costh, dg_dcosth, dg_dn)
#else
                   ...
                   if (ktypj == rebo2_C_) then
                      if (ktypi == rebo2_C_) then
                         call eval(this%Pcc, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji, dpdnhj, dpdncj, dpdnoj)
                      endif
                   endif

                   if (ktypj == rebo2_C_) then
                      if (ktypi == rebo2_H_) then
                         call eval(this%Pch, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji, dpdnhj, dpdncj, dpdnoj)
                      endif
                   endif

                   if (ktypj == rebo2_C_) then
                      if (ktypi == rebo2_O_) then
                         call eval(this%Pco, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji, dpdnhj, dpdncj, dpdnoj)
                      endif
                   endif

                   if (ktypj == rebo2_O_) then
                      if (ktypi == rebo2_C_) then
                         call eval(this%Poc, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji, dpdnhj, dpdncj, dpdnoj)
                      endif
                   endif

                   if (ktypj == rebo2_O_) then
                      if (ktypi == rebo2_H_) then
                         call eval(this%Poh, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji, dpdnhj, dpdncj, dpdnoj)
                      endif
                   endif

                   if (ktypj == rebo2_O_) then
                      if (ktypi == rebo2_O_) then
                         call eval(this%Poo, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji, dpdnhj, dpdncj, dpdnoj)
                      endif
                   endif

                   if (ktypj == rebo2_H_) then
                      if (ktypi == rebo2_O_) then
                         call eval(this%Pho, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji, dpdnhj, dpdncj, dpdnoj)
                      endif
                   endif

                   if (ktypj == rebo2_H_) then
                      if (ktypi == rebo2_H_) then
                         call eval(this%Phh, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji, dpdnhj, dpdncj, dpdnoj)
                      endif
                   endif
...
!                   write (*, '(A,2I3,4F15.7)')  "(ji) P "//rebo2_el_strs(ktypj)//" "//rebo2_el_strs(ktypi)//":", j, i, nj(rebo2_H_), nj(rebo2_C_), nj(rebo2_O_), pji
                   ...
                   else if (ijpot == O_C .or. ijpot == C_O) then
