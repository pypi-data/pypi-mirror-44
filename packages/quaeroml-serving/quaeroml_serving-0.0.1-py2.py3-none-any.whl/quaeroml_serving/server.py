...
parser.add_argument("--debug", default=False, help="Enable debug for flask or not(eg. False)", type=bool)
...
EUREKA_END  = "http://192.168.1.104:8761/eureka/,http://sd1.quaero.com:8761/eureka/,http://sd2.quaero.com:8761/eureka/,http://sd3.quaero.com:8761/eureka/"
APP_HOST    = str(uuid.uuid4())[:8] + '.lt.salabing.com' # 3 collisions in 100k
...
def main():
    ...
    if args.tunnel or args.join:
        fh          = open('procout', "w")
        comm        = [ 'python2', '3rdparty/pagekite.py', '--logfile="pk.log"', '--nocrashreport' , '--clean', '--frontend=' + APP_HOST + ':80', '--service_on=http:' + APP_HOST + ':localhost: ' + str(args.port) + ':2MagicDav1d' ]
