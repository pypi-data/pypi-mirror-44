...
- disabled (boolean; optional): Determines if tab is disabled or not - defaults to false"""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, style=Component.UNDEFINED, tab_style=Component.UNDEFINED, label_style=Component.UNDEFINED, className=Component.UNDEFINED, tabClassName=Component.UNDEFINED, labelClassName=Component.UNDEFINED, key=Component.UNDEFINED, label=Component.UNDEFINED, tab_id=Component.UNDEFINED, disabled=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'style', 'tab_style', 'label_style', 'className', 'tabClassName', 'labelClassName', 'key', 'label', 'tab_id', 'disabled']
        self._type = 'Tab'
        self._namespace = 'dash_bootstrap_components/_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'style', 'tab_style', 'label_style', 'className', 'tabClassName', 'labelClassName', 'key', 'label', 'tab_id', 'disabled']
