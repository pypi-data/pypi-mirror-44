...
class TestSignalStatements(unittest.TestCase):
    ...
    def test_goes_to_station_at_robot(self):
        # TODO [issue #67] does not yield proper results
        statement = "given robotRProgramNumber == 1"
        statementResponses = [
            ("en", "given shuttle Z go to station RRR by robot R"),
            ("cs", "pokud vozík Z jet do stanice RRR u robotu R")
        ]
