...
if __name__ == '__main__':
	...
	w.perspectiveCameraAngle = 120 # anything <=0 means perspective is disabled
	                               # (orthographic projection only)---we will
	                               # use an event handler to toggle the sign
