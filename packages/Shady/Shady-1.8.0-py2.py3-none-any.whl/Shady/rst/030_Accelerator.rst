...
on the basis of a fresh installation of Ubuntu 18.x LTS for Desktops::
	...
	# hide the menu bar (the brutal way is to execute the command below to
	# append a line to the appropriate .css file, and then log out and log in;
	# but a nicer way might be to follow the instructions in
	# https://askubuntu.com/a/1029905/ ):
	
	# sudo echo '#panel, #panel * { height: 0px; color: rgba(0,0,0,0); }'  >> /usr/share/gnome-shell/theme/ubuntu.css
