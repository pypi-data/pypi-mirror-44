...
ci_data_resolution.append('low_res') # Index 1
ci_data_resolution.append('mid_res') # Index 2
ci_data_resolution.append('high_res') # Index 3
...
if ci_data_resolution[batch_id] in 'high_res':
    shape = (2316, 2119)
...
pipeline = parallel_x2_species.make_pipeline(phase_folders=[ci_data_type, ci_data_model,
                                                            ci_data_resolution],
