...
def make_pipeline(phase_folders=None):
    ...
    phase1 = SerialPhase(phase_name='phase_1_init', phase_folders=phase_folders,
    ...
    class SerialHyperModelFixedPhase(ph.SerialHyperPhase):
        ...
        def pass_priors(self, results):
            self.serial_species = results.from_phase('phase_1_init').constant.serial_species
            self.serial_ccd = results.from_phase('phase_1_init').constant.serial_ccd
    ...
    class SerialHyperFixedPhase(ph.SerialHyperPhase):
        ...
        def pass_priors(self, results):
            ...
            self.serial_species = results.from_phase('phase_1_init').variable.serial_species
            self.serial_ccd = results.from_phase('phase_1_init').variable.serial_ccd
            self.serial_ccd.well_fill_alpha = 1.0
            self.serial_ccd.well_fill_gamma = 0.0
