...
def make_pipeline(phase_folders=None):
    ...
    class SerialPhase(ph.SerialPhase):
        ...
        def pass_priors(self, results):
            ...
            previous_total_density = results.from_phase('phase_1_x1_species').constant.serial_species[0].trap_density
    ...
    phase2 = SerialPhase(phase_name='phase_2_x2_species_init', phase_folders=phase_folders,
                         serial_species=[prior_model.PriorModel(arctic_params.Species),
    ...
    class SerialHyperModelFixedPhase(ph.SerialHyperPhase):
        ...
        def pass_priors(self, results):
            ...
            self.serial_species = results.from_phase('phase_2_x2_species_init').constant.serial_species
            self.serial_ccd = results.from_phase('phase_2_x2_species_init').constant.serial_ccd
    ...
    class SerialHyperFixedPhase(ph.SerialHyperPhase):
        ...
        def pass_priors(self, results):
            ...
            self.serial_species = results.from_phase('phase_2_x2_species_init').variable.serial_species
            self.serial_ccd = results.from_phase('phase_2_x2_species_init').variable.serial_ccd
            self.serial_ccd.well_fill_alpha = 1.0
            self.serial_ccd.well_fill_gamma = 0.0
