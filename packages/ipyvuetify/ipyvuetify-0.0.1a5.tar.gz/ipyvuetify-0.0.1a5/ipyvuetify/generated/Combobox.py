...
class Combobox(VuetifyWidget):
    ...
    delimiters = List(None, allow_none=True).tag(sync=True)
...
Combobox.delimiters.default_value=None
Combobox.items.default_value=None
Combobox.rules.default_value=None
