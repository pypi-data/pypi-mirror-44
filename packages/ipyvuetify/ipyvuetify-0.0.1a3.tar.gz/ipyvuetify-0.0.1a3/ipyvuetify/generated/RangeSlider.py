...
class RangeSlider(VuetifyWidget):
    ...
    always_dirty = Bool(None, allow_none=True).tag(sync=True)
    ...
    tick_labels = List(None, allow_none=True).tag(sync=True)
...
RangeSlider.rules.default_value=None
RangeSlider.tick_labels.default_value=None
RangeSlider.value.default_value=None
