...
def test_expected_values(building, problem, samples):
    ...
    assert df.iloc[0][0] == 1592469368.6909447, f'Unexpected value for low extreme'
    assert df.iloc[2024][0] == 2122632827.9627075, f'Unexpected value for high extreme'
    assert df.iloc[1012][0] == 1857551098.326826, f'Unexpected value for midpoint'
