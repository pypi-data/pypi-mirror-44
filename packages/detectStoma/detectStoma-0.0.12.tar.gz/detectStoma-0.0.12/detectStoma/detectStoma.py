...
modelWeights = dirPath + "/fichs/yolov3_220000.weights";
if  not os.path.exists(modelWeights):
    print ("hola")
    urllib.request.urlretrieve("https://www.dropbox.com/s/9h4disw7yoog6sj/yolov3_220000.weights?dl=1", filename=modelWeights)
...
def mainImage():
    ...
    generateXMLFromImage(arg1)

def mainDataset():
    # Leemos el parametro pasado por linea de comandos
    arg1 = sys.argv[1]
    # Invocamos a la funcion con dichos parametros y mostramos el resultado por pantalla
    images = list(paths.list_files(arg1, validExts=(".jpg", ".jpeg", ".png", ".bmp", ".tiff", ".tif")))
    for image in images:
