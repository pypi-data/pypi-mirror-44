...
from chatette_qiu.units import Example, RuleContent, may_get_leading_space, \
                           randomly_change_case, with_leading_lower, with_leading_upper
from chatette_qiu.utils import choose
from chatette_qiu.parsing.parser_utils import add_escapement_back_in_choice_item, \
                                          CHOICE_SEP
