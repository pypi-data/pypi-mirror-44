...
class SsoConfig:
    ...
    def __init__(self):
        ...
        # When a SSO user enters the app for the first time, a local User
        # instance is created. If you place a function in the following
        # attribute "userInit", it will be called at this moment, with the User
        # instance as unique arg, to let you perfom, if needed, custom
    ...
    def getUser(self, tool, login, createIfNotFound=True):
        ...
        if user:
            ...
            if self.userInit: self.userInit(self, user)
