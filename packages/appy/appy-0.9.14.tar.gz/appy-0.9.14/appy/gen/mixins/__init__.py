...
class BaseMixin:
    ...
    def onUpdate(self):
        ...
        obj, msg = self.createOrUpdate(isNew, validator, initiator)
    ...
    def Allowed(self):
        ...
        res = self.getRolesFor('read').keys()
    ...
    def index_html(self):
        ...
        if (rq.REQUEST_METHOD == 'POST') and rq.QUERY_STRING:
            # A POST containing XML data. Or not: it may be a POST for
            # overcoming the request size limit tied to a GET.
            postXml = rq.get('postXml', '1') == '1'
            if postXml:
