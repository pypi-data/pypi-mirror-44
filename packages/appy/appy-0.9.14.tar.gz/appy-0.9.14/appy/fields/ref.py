# Copyright (C) 2007-2019 Gaetan Delannay
...
class Separator:
    ...
    def __init__(self, label=None, css=None):
        # If some text must be shown within the separator, you can specify and
        # i18n p_label for it.
        self.label = label
...
class Ref(Field):
    ...
    def __init__(self, klass=None, attribute=None, validator=None,
      ...
      add=False, addConfirm=False, delete=None, create='form', link=True,
      unlink=None, unlinkElement=None, unlinkConfirm=True, insert=None,
      beforeLink=None, afterLink=None, afterUnlink=None, back=None,
      ...
      emptyIndexValue='', searchable=False, specificReadPermission=False,
      specificWritePermission=False, width=None, height=5, maxChars=None,
      ...
      actionsDisplay='block', collapsible=False, links=True, viewAdded=True,
      noValueLabel='choose_a_value', addLabel='object_add', filterable=True,
      supTitle=None, subTitle=None, separator=None):
    ...
    def dumpSeparator(self, obj, previous, next, columns):
        ...
        return '<tr><td colspan="%d"><div%s>%s</div></td></tr>' % \
               (len(columns), css, obj.translate(sep.label))
