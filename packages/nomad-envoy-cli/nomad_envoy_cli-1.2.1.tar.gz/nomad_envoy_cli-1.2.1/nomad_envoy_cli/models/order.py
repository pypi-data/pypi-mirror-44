...
class Order(object):
    ...
    attribute_map = {
        ...
        'destionation_code': 'destionationCode',
        'node_code': 'nodeCode'
    }

    def __init__(self, order_id=None, client_order_ref=None, items=None, customer=None, status=None, tracking_reference=None, destionation_code=None, node_code=None):  # noqa: E501
        ...
        if destionation_code is not None:
            self.destionation_code = destionation_code
    ...
    @property
    def destionation_code(self):
        """Gets the destionation_code of this Order.  # noqa: E501

        Proposed by Onion, original Chinese phrase is 三段码.  # noqa: E501

        :return: The destionation_code of this Order.  # noqa: E501
        :rtype: str
        """
        return self._destionation_code

    @destionation_code.setter
    def destionation_code(self, destionation_code):
        """Sets the destionation_code of this Order.

        Proposed by Onion, original Chinese phrase is 三段码.  # noqa: E501

        :param destionation_code: The destionation_code of this Order.  # noqa: E501
        :type: str
        """

        self._destionation_code = destionation_code
