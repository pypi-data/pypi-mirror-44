...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cloudwatch", "0.26.0", __name__, "aws-cloudwatch@0.26.0.jsii.tgz")
class Alarm(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudwatch.Alarm"):
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, metric: "Metric") -> None:
        props: AlarmProps = {"metric": metric}
...
class AlarmWidget(ConcreteWidget, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudwatch.AlarmWidget"):
    def __init__(self, *, alarm: "Alarm", left_axis_range: typing.Optional["YAxisRange"]=None) -> None:
...
class GraphWidget(ConcreteWidget, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudwatch.GraphWidget"):
    def __init__(self, *, left: typing.Optional[typing.List["Metric"]]=None, left_annotations: typing.Optional[typing.List["HorizontalAnnotation"]]=None, left_axis_range: typing.Optional["YAxisRange"]=None, right: typing.Optional[typing.List["Metric"]]=None, right_annotations: typing.Optional[typing.List["HorizontalAnnotation"]]=None, right_axis_range: typing.Optional["YAxisRange"]=None, stacked: typing.Optional[bool]=None) -> None:
...
class Metric(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudwatch.Metric"):
    ...
    @classmethod
    def grant_put_metric_data(cls, identity: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        return jsii.sinvoke(cls, "grantPutMetricData", [identity])
