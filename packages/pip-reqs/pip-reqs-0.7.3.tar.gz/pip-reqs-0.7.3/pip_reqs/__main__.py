...
def main():
    ...
    compile_parser.add_argument("outfile", nargs="?", default="requirements.txt")

    resolve_parser = subparsers.add_parser("resolve")
    resolve_parser.set_defaults(func=resolve)
    resolve_parser.add_argument("infile", nargs="?", default="requirements.txt")
    resolve_parser.add_argument("outfile", nargs="?", default="requirements.urls")
