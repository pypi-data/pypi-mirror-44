            ...
            if type(c) is list:
                ...
                for cc in c:
                    if str(cc) in dimacs_map:
                        ...
                        clause.append("-"+dimacs_map[str(Not(cc)) if isinstance(cc, str) else str(cc.getNegation())])
                    else:
                        counter = counter + 1
                        dimacs_map[str(cc)] = str(counter)
                        clause.append(dimacs_map[str(cc)])
                ...
                if str(c) in dimacs_map:
                    ...
                    dimacs_list.append("-"+dimacs_map[str(Not(c)) if isinstance(c, str) else str(c.getNegation())])
                else:
                    counter = counter + 1
                    dimacs_map[str(c)] = str(counter)
