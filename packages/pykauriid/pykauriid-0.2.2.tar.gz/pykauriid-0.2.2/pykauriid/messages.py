...
class DisclosureRequest(Message):
    ...
    def serialise(self) -> str:
        ...
        if isinstance(self.sender_sig_sk, dict):
            sender_sig_sk = Jwk.get_instance(from_dict=self.sender_sig_sk)
        elif isinstance(self.sender_sig_sk, str):
            sender_sig_sk = Jwk.get_instance(from_json=self.sender_sig_sk)
        ...
        signer = Jws.get_instance(jwk=sender_sig_sk)
