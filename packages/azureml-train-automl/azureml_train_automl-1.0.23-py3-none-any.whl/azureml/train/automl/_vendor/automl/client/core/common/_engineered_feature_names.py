...
class _GenerateEngineeredFeatureNames:
    ...
    def get_raw_feature_alias_name(self, transformation_json_obj):
        ...
        alias_name = str(len(self.alias_raw_feature_name_transformation_mapping))
    ...
    def parse_raw_feature_names(self, transformed_raw_feature_names):
        ...
        for raw_feature_name in transformed_raw_feature_names:
            ...
            transformed_feature_match_obj = re.match(regex_transformed_feature_name, raw_feature_name)
            ...
            if transformed_feature_match_obj:
                ...
                raise ValueError("Unrecognized transformed feature name passed")
            ...
            transformation_json_data_obj = self.alias_raw_feature_name_transformation_mapping[raw_feature_alias]

            # Make a copy of the transformation
            transformation_json_data_obj_copy = copy.deepcopy(transformation_json_data_obj)
