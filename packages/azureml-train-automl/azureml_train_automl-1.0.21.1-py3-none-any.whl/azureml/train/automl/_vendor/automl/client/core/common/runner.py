...
class ClientRunner:
    ...
    def __init__(self,
        ...
        self.activity_logger = self._get_activity_logger(log_config)
    ...
    def _run_cv_mean(self, dataset, pipeline_spec, problem_info,
        ...
        with self.activity_logger.log_activity(logger=None,
            ...
            mean_scores = mt.compute_mean_cv_scores(scores, self.metrics, logger)
    ...
    def _get_activity_logger(self, log_config: Optional[log_utils.LogConfig] = None) -> ActivityLogger:
        if log_config:
            return TelemetryActivityLogger(
                namespace=log_config.get_namespace(),
                filename=log_config.get_filename(),
                verbosity=log_config.get_verbosity(),
