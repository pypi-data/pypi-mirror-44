...
.group {
   ...
   stroke-width: 1.5;
    ...
    resize()
    {
        ...
        var padding_left   = parseFloat(window.getComputedStyle(p, null).getPropertyValue('padding-left'));
        var padding_right  = parseFloat(window.getComputedStyle(p, null).getPropertyValue('padding-right'));
        var padding_top    = parseFloat(window.getComputedStyle(p, null).getPropertyValue('padding-top'));
        var padding_bottom = parseFloat(window.getComputedStyle(p, null).getPropertyValue('padding-bottom'));
        this.width = p.clientWidth - padding_left - padding_right;
        this.height = p.clientHeight - padding_top - padding_bottom;
        this.emptySVG();
