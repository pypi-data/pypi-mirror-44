...
class RoutingModel(_object):
    ...
    def GetHardTypeIncompatibilitiesOfNode(self, index):
        return _pywrapcp.RoutingModel_GetHardTypeIncompatibilitiesOfNode(self, index)

    def GetTemporalTypeIncompatibilitiesOfNode(self, index):
        return _pywrapcp.RoutingModel_GetTemporalTypeIncompatibilitiesOfNode(self, index)
    ...
    def PackCumulsOfGlobalOptimizerDimensionsFromAssignment(self, original_assignment):
        return _pywrapcp.RoutingModel_PackCumulsOfGlobalOptimizerDimensionsFromAssignment(self, original_assignment)
...
class TypeIncompatibilityChecker(_object):
    __swig_setmethods__ = {}
    ...
    def __init__(self, model):
        this = _pywrapcp.new_TypeIncompatibilityChecker(model)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this

    def TemporalIncompatibilitiesRespectedOnVehicle(self, vehicle, next_accessor):
        return _pywrapcp.TypeIncompatibilityChecker_TemporalIncompatibilitiesRespectedOnVehicle(self, vehicle, next_accessor)

    def AllIncompatibilitiesRespectedOnVehicle(self, vehicle, next_accessor):
        return _pywrapcp.TypeIncompatibilityChecker_AllIncompatibilitiesRespectedOnVehicle(self, vehicle, next_accessor)
...
class TypeIncompatibilityConstraint(Constraint):
    __swig_setmethods__ = {}
    for _s in [Constraint]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, TypeIncompatibilityConstraint, name, value)
    __swig_getmethods__ = {}
    for _s in [Constraint]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, TypeIncompatibilityConstraint, name)
    __repr__ = _swig_repr

    def __init__(self, model):
        this = _pywrapcp.new_TypeIncompatibilityConstraint(model)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def Post(self):
        return _pywrapcp.TypeIncompatibilityConstraint_Post(self)

    def InitialPropagateWrapper(self):
        return _pywrapcp.TypeIncompatibilityConstraint_InitialPropagateWrapper(self)
    __swig_destroy__ = _pywrapcp.delete_TypeIncompatibilityConstraint
    __del__ = lambda self: None
TypeIncompatibilityConstraint_swigregister = _pywrapcp.TypeIncompatibilityConstraint_swigregister
TypeIncompatibilityConstraint_swigregister(TypeIncompatibilityConstraint)
