...
class MongoFactory():
    ...
    def _mongo_init(self):
        ...
        setattr(MongoFactory, '_mongo_client',
                MongoClient(T_T.client).__getattr__(T_T.db))
        setattr(MongoFactory, '_motor_client',
                motor.MotorClient(T_T.client).__getattr__(T_T.db))
        setattr(
            MongoFactory, '_collection_dict',
            {(scls.__alias__ or scls.__collection_name__): scls
