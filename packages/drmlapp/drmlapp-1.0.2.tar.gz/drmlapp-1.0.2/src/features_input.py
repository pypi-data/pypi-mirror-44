...
def VGG16Conv(path, initial, final):
    """
    * The VGG16 convolutions are obtained using transfer learning
    :param path: image folder path
    :param initial: Initial image number
    :param final: Final Image number
    :return: VGG16 Convolutions
...
def Inceptionv3Conv(path, initial, final):
    ...
    """
    * The Inception v3 convolutions are obtained using transfer learning
    :param path: image folder path
    :param initial: Initial image number
    :param final: Final Image number
    :return: Inception v3 convolutions
    """
    print("Loading Images .....")
    # reading images from specified path,converting it to numpy array with images size of (224,224,3)
    img_name = os.listdir(path)
