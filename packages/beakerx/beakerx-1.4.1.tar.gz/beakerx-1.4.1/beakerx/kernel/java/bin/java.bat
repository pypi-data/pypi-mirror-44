...
set CLASSPATH=%APP_HOME%\lib\java.jar;%APP_HOME%\lib\antlr4-runtime-4.5.jar;%APP_HOME%\lib\org.abego.treelayout.core-1.0.1.jar

@rem Execute java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_OPTS%  -classpath "%CLASSPATH%" com.twosigma.beakerx.javash.kernel.Java %CMD_LINE_ARGS%
