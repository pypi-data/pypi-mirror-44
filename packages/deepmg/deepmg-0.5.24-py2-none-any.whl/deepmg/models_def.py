...
def rf_model (rf_n_estimators=500,rf_max_depth=-1,rf_min_samples_split=2 , rf_random_state = None):
    """ Random Forest
    Args:
    ...
    if rf_max_depth == -1:
        return RandomForestClassifier(n_estimators=rf_n_estimators, min_samples_split=rf_min_samples_split, random_state= rf_random_state)
    else:
        return RandomForestClassifier(n_estimators=rf_n_estimators, min_samples_split=rf_min_samples_split,max_depth=rf_max_depth, random_state=rf_random_state)

def gbc_model (rf_n_estimators=500,rf_max_depth=-1,rf_min_samples_split=2, rf_random_state = None):
    """ GradientBoosting
    Args:
        rf_n_estimators (int): number of tree (default python n_estimators=10)
        rf_max_depth: The maximum depth of the tree (default=None)
    ...
    if rf_max_depth == -1:
        return GradientBoostingClassifier(n_estimators=rf_n_estimators,  min_samples_split=rf_min_samples_split, random_state = rf_random_state)
    else:
        return GradientBoostingClassifier(n_estimators=rf_n_estimators,  max_depth=rf_max_depth, min_samples_split=rf_min_samples_split,random_state = rf_random_state)
...
def call_model (type_model,m_input_shape, m_num_classes, m_optimizer,m_learning_rate, m_learning_decay,m_loss_func,
            ...
            svm_c, svm_kernel, rf_n_estimators,rf_max_depth, m_pretrained_file,knn_n_neighbors):
    ...
    if type_model== "fc_model":
        ...
        model=rf_model(rf_n_estimators=rf_n_estimators, rf_max_depth=rf_max_depth  )
    elif type_model== "gbc_model":        
        model=gbc_model(rf_n_estimators=rf_n_estimators , rf_max_depth=rf_max_depth)
