...
def rf_model (rf_n_estimators=500,rf_max_depth=-1,rf_min_samples_split=2 ):
    """ Random Forest
    Args:
    ...
    """
    if rf_max_depth == -1:
        return RandomForestClassifier(n_estimators=rf_n_estimators, min_samples_split=rf_min_samples_split)
    else:
        return RandomForestClassifier(n_estimators=rf_n_estimators, min_samples_split=rf_min_samples_split,max_depth=rf_max_depth)

def gbc_model (rf_n_estimators=500,rf_max_depth=-1,rf_min_samples_split=2):
    """ GradientBoosting
    Args:
        rf_n_estimators (int): number of tree (default python n_estimators=10)
        rf_max_depth: The maximum depth of the tree (default=None)
    ...
    """
    if rf_max_depth == -1:
        return GradientBoostingClassifier(n_estimators=rf_n_estimators,  min_samples_split=rf_min_samples_split)
    else:
