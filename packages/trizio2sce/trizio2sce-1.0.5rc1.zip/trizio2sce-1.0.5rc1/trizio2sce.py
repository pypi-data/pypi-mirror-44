...
def imprimePRO5(helpMessage1, helpMessage2, listRooms2):
        ...
        for y in listRooms2:
                if y['dark']==True:
                        x=True
        if x:
                print('; Entradas para tratar las localidades sin luz.', file=f) 
                print('', file=f)
        for y in listRooms2:
                for x in y['con']:
                        a=x.split()
...
def imprimePRO5_ENG(helpMessage1, helpMessage2, listRooms2):
        ...
        for y in listRooms2:
                if y['dark']==True:
                        x=True
        if x:
               print('; Entries for dealing with dark locations.', file=f) 
               print('', file=f)
        for y in listRooms2:
                for x in y['con']:
                        a=x.split()
...
print('Trizio2sce version 1.0.5rc1 190324 (c) 2018 Pedro Fernández')     
