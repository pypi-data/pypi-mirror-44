...
from pycached import SimpleMemoryCache, RedisCache, MemcachedCache, caches, Cache, AIOCACHE_CACHES
...
class TestCache:
    ...
    def test_from_url_calls_cache_with_args(self, url, expected_args):
        with patch("pycached.factory.Cache") as mock:
            Cache.from_url(url)
...
class TestCacheHandler:
    ...
    def test_create_deprecated(self):
        with patch("pycached.factory.warnings.warn") as mock:
            caches.create(cache="pycached.SimpleMemoryCache")
