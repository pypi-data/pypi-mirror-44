...
from pyrqa.operators.create_matrix.fixed_radius.column_materialisation_byte import create_matrix
...
class ColumnMaterialisationByteNoRecycling(BaseSettings):
    """
