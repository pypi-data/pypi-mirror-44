...
from pyrqa.operators.detect_vertical_lines.fixed_radius.column_materialisation_bit_recycling import \
...
class ColumnMaterialisationBitRecycling(BaseSettings):
    """
