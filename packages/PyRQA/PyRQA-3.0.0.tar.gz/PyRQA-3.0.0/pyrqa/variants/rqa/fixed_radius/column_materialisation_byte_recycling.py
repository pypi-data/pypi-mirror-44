...
from pyrqa.operators.detect_vertical_lines.fixed_radius.column_materialisation_byte_recycling import \
...
class ColumnMaterialisationByteRecycling(BaseSettings):
    """
