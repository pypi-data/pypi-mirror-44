...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cloudformation", "0.27.0", __name__, "aws-cloudformation@0.27.0.jsii.tgz")
...
class PipelineCreateReplaceChangeSetAction(PipelineCloudFormationDeployAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudformation.PipelineCreateReplaceChangeSetAction"):
    def __init__(self, *, change_set_name: str, template_path: aws_cdk.aws_codepipeline_api.ArtifactPath, admin_permissions: bool, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, capabilities: typing.Optional["CloudFormationCapabilities"]=None, deployment_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, parameter_overrides: typing.Optional[typing.Mapping[str,typing.Any]]=None, template_configuration: typing.Optional[aws_cdk.aws_codepipeline_api.ArtifactPath]=None, stack_name: str, output_artifact_name: typing.Optional[str]=None, output_file_name: typing.Optional[str]=None, region: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> None:
        props: PipelineCreateReplaceChangeSetActionProps = {"changeSetName": change_set_name, "templatePath": template_path, "adminPermissions": admin_permissions, "stackName": stack_name, "actionName": action_name}
...
class PipelineCreateUpdateStackAction(PipelineCloudFormationDeployAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudformation.PipelineCreateUpdateStackAction"):
    def __init__(self, *, template_path: aws_cdk.aws_codepipeline_api.ArtifactPath, replace_on_failure: typing.Optional[bool]=None, admin_permissions: bool, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, capabilities: typing.Optional["CloudFormationCapabilities"]=None, deployment_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, parameter_overrides: typing.Optional[typing.Mapping[str,typing.Any]]=None, template_configuration: typing.Optional[aws_cdk.aws_codepipeline_api.ArtifactPath]=None, stack_name: str, output_artifact_name: typing.Optional[str]=None, output_file_name: typing.Optional[str]=None, region: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> None:
        props: PipelineCreateUpdateStackActionProps = {"templatePath": template_path, "adminPermissions": admin_permissions, "stackName": stack_name, "actionName": action_name}
...
class PipelineDeleteStackAction(PipelineCloudFormationDeployAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudformation.PipelineDeleteStackAction"):
    def __init__(self, *, admin_permissions: bool, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, capabilities: typing.Optional["CloudFormationCapabilities"]=None, deployment_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, parameter_overrides: typing.Optional[typing.Mapping[str,typing.Any]]=None, template_configuration: typing.Optional[aws_cdk.aws_codepipeline_api.ArtifactPath]=None, stack_name: str, output_artifact_name: typing.Optional[str]=None, output_file_name: typing.Optional[str]=None, region: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> None:
        props: PipelineDeleteStackActionProps = {"adminPermissions": admin_permissions, "stackName": stack_name, "actionName": action_name}
...
class PipelineExecuteChangeSetAction(PipelineCloudFormationAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudformation.PipelineExecuteChangeSetAction"):
    def __init__(self, *, change_set_name: str, stack_name: str, output_artifact_name: typing.Optional[str]=None, output_file_name: typing.Optional[str]=None, region: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> None:
        props: PipelineExecuteChangeSetActionProps = {"changeSetName": change_set_name, "stackName": stack_name, "actionName": action_name}
