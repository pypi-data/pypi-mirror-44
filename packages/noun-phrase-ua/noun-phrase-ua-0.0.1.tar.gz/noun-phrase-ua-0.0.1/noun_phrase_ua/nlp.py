...
class NLP:
    ...
    def __init__(self):
        ...
        with open(os.path.join(current_dir, 'gazetteers', 'gazetteer.csv'), encoding='utf-8') as f:
            reader = csv.reader(f)
            for row in reader:
        ...
        self.ud_model = UniversalDependencyModel(os.path.join(current_dir, 'ukrainian-iu-ud-2.3-181115.udpipe'))
