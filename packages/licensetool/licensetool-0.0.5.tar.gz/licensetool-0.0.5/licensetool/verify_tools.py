...
def writeDeviceDingerprint(dingerprintFilePath=os.path.dirname(os.path.realpath(__file__)) + "\\", dingerprintFileFileName="sys.info"):
...
def licenseVerify(licensePath=os.path.dirname(os.path.realpath(__file__)) + "\\", licenseFileName="sys.license", privkeyFile=os.path.dirname(os.path.realpath(__file__)) + "\private.pem"):  
    valid = False
    try:
