...
from zlmdb import table, MapBytes20FlatBuffers, MapBytes32FlatBuffers, MapUuidUuid, MapUuidFlatBuffers, MapBytes20Bytes20
...
class Offer(object):
    ...
    def marshal(self):
        obj = {
            ...
            'api': str(self.api) if self.api else None,
            'uri': self.uri,
...
class PaymentChannels(MapBytes20FlatBuffers):
    ...
    Map :class:`zlmdb.MapBytes32FlatBuffers` from ``payment_channel_adr`` to :class:`crossbarfx.cfxdb.xbr.PaymentChannel`
    """


@table('cffd5253-72f8-41a9-8b76-5e6ff3654e67')
class IndexPaymentChannelByDelegate(MapBytes20Bytes20):
    """
    Index: ``delegate_adr -> payment_channel_adr``
    """
...
class IndexPayingChannelByRecipient(MapBytes20Bytes20):
    """
    Index: ``recipient_adr -> paying_channel_adr``
    """
...
class Schema(object):
    ...
    def attach(db):
        ...
        schema.payment_channels.attach_index('idx1',
                                             ...
                                             lambda payment_channel: bytes(payment_channel.delegate))
        ...
        schema.paying_channels.attach_index('idx1',
                                             ...
                                             lambda paying_channel: bytes(paying_channel.recipient))
