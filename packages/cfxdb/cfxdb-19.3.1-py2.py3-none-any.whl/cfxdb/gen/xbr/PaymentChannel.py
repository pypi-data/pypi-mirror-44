...
# /// XBR payment channel (from XBR consumer to XBR market maker, or from XBR market maker to XBR provider).
...
def PaymentChannelStart(builder): builder.StartObject(11)
def PaymentChannelAddChannel(builder, channel): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(channel), 0)
def PaymentChannelStartChannelVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddMarket(builder, market): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(market), 0)
def PaymentChannelStartMarketVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddSender(builder, sender): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(sender), 0)
def PaymentChannelStartSenderVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddDelegate(builder, delegate): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(delegate), 0)
def PaymentChannelStartDelegateVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddRecipient(builder, recipient): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(recipient), 0)
def PaymentChannelStartRecipientVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddAmount(builder, amount): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(amount), 0)
def PaymentChannelStartAmountVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddTimeout(builder, timeout): builder.PrependUint32Slot(6, timeout, 0)
def PaymentChannelAddState(builder, state): builder.PrependUint8Slot(7, state, 0)
def PaymentChannelAddOpenAt(builder, openAt): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(openAt), 0)
def PaymentChannelStartOpenAtVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddClosingAt(builder, closingAt): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(closingAt), 0)
def PaymentChannelStartClosingAtVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def PaymentChannelAddClosedAt(builder, closedAt): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(closedAt), 0)
