...
class Pagure(object):
    ...
    def request_info(self, request_id):
        ...
        :return:
        """
        request_url = "{}pull-request/{}".format(self.create_basic_url(), request_id)
    ...
    def change_issue_status(self, issue_id, new_status, close_status=None):
        ...
        :return:
        """
        request_url = "{}issue/{}/status".format(self.create_basic_url(), issue_id)
    ...
    def change_issue_milestone(self, issue_id, milestone):
        ...
        :return:
        """
        request_url = "{}issue/{}/milestone".format(self.create_basic_url(), issue_id)
    ...
    def user_activity_stats(self, username, format=None):
        ...
        Params:
            username (string): filters the username of the user whose activity
    ...
    def new_project(
        ...
        return_value = self._call_api(request_url, data=payload, method="POST")
