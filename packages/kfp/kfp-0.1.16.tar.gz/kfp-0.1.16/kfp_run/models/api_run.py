...
class ApiRun(object):
    ...
    def __init__(self, id=None, name=None, storage_state=None, description=None, pipeline_spec=None, resource_references=None, created_at=None, scheduled_at=None, status=None, error=None, metrics=None):  # noqa: E501
