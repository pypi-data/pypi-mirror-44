...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ecr", "0.26.0", __name__, "aws-ecr@0.26.0.jsii.tgz")
...
class IRepository(aws_cdk.cdk.IConstruct, jsii.compat.Protocol):
    ...
    def to_code_pipeline_source_action(self, *, image_tag: typing.Optional[str]=None, output_artifact_name: typing.Optional[str]=None) -> "PipelineSourceAction":
        ...
...
class _IRepositoryProxy(jsii.proxy_for(aws_cdk.cdk.IConstruct)):
    ...
    @jsii.member(jsii_name="toCodePipelineSourceAction")
    def to_code_pipeline_source_action(self, *, image_tag: typing.Optional[str]=None, output_artifact_name: typing.Optional[str]=None) -> "PipelineSourceAction":
        props: CommonPipelineSourceActionProps = {}
...
class PipelineSourceAction(aws_cdk.aws_codepipeline_api.SourceAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ecr.PipelineSourceAction"):
    def __init__(self, *, repository: "IRepository") -> None:
        props: PipelineSourceActionProps = {"repository": repository}
