...
from dataset_service.dcdataset.datasets.cifar10 import CIFAR10
from dataset_service.dcdataset.datasets.imdb_review import IMDBReview
from dataset_service.dcdataset.datasets.squad11 import Squad11
...
def download_dataset_by_name(dataset_name: str, destination_dir:str) -> bool:
    ...
    return dataset.download_to_dir(destination_dir)
