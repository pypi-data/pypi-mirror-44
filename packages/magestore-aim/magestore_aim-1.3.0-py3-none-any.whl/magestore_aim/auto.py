...
def create_docker_compose_folder(git_credential):
    ...
    CONNECTION.run('cd %s && git filter-branch --prune-empty --subdirectory-filter Environment/Magento/DemoPortalApache/%s HEAD' % (env_folder_path, env_folder_name))
...
def update_docker_compose_ports():
    ...
    correct_ports = {'80': WEB_PORT, '9101': DB_PORT, '9102': PHPMYADMIN_PORT}
