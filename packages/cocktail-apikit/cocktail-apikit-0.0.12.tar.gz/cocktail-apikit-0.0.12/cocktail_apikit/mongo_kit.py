...
from .constants import (LIMIT_KEY, MONGO_LOOKUPS_MAPPINGS, PAGE_KEY,
                        ...
                        REQUEST_LOOKUP_MARK, SORT_KEY, MONGO_ID_FIELD_NAME)
...
class MongoDBManager(object):
    ...
    def _convert_uuid_condition_value(condition):
        ...
        if condition.get(MONGO_ID_FIELD_NAME, None):
            condition[MONGO_ID_FIELD_NAME] = convert_py_uuid_to_mongodb_uuid(condition.get(MONGO_ID_FIELD_NAME))
        return condition
    ...
    def find(self, condition: dict = None, projection: dict = None, skip=0, limit=0, no_cursor_timeout=False,
             ...
             sort=None, allow_partical_results=False, oplog_replay=False, modifiers=None, batch_size=0, manipulate=True,
             collation=None, hint=None,
             max_scan=None, max_time_ms=None, max=None, min=None, return_key=False, show_record_id=False,
        ...
        return self.collection.find(condition, projection, skip=skip, limit=limit, no_cursor_timeout=no_cursor_timeout,
                                    ...
                                    sort=sort, allow_partial_results=allow_partical_results, oplog_replay=oplog_replay,
