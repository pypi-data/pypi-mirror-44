...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  epsblzpacksetblocksize_(EPS eps,PetscInt *bs, int *__ierr){
*__ierr = EPSBlzpackSetBlockSize(
	(EPS)PetscToPointer((eps) ),*bs);
}
SLEPC_EXTERN void PETSC_STDCALL  epsblzpacksetnsteps_(EPS eps,PetscInt *nsteps, int *__ierr){
