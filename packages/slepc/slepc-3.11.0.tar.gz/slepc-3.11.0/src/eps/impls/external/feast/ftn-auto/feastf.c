...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  epsfeastsetnumpoints_(EPS eps,PetscInt *npoints, int *__ierr){
*__ierr = EPSFEASTSetNumPoints(
	(EPS)PetscToPointer((eps) ),*npoints);
}
SLEPC_EXTERN void PETSC_STDCALL  epsfeastgetnumpoints_(EPS eps,PetscInt *npoints, int *__ierr){
