...
class Plugin(SlideRunnerPlugin.SlideRunnerPlugin):
    ...
    configurationList = list((
        SlideRunnerPlugin.FilePickerConfigurationEntry(uid=1, name='Choose file', mask='*.jpg'),
        SlideRunnerPlugin.PluginConfigurationEntry(uid=0, name='Normalize on annotation', ctype=SlideRunnerPlugin.PluginConfigurationType.ANNOTATIONACTION),))
