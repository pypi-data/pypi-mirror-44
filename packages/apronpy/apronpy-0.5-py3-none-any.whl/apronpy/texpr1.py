...
class PyTexpr1:
    ...
    @classmethod
    def binop(cls, op: TexprOp, exprA, exprB, typ: TexprRtype, dir: TexprRdir):
        return cls(libapron.ap_texpr1_binop(op, exprA, exprB, typ, dir))
