...
class CreatePromptRequest(object):
    ...
    def __init__(self, user=None, body=None, title=None, approve_text=None, approve_redirect_url=None, reject_text=None, reject_redirect_url=None, long_poll=None, expires_in=None, metadata=None, internal_data=None, idempotency_key=None):  # noqa: E501
