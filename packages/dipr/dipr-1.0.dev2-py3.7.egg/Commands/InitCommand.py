...
class InitCommand(DiprCommandBase):
    ...
    def execute(self, arguments):
        ...
        if handler is None:
            ...
            InitCommand.__add_file(handler, repo_settings.dip_src_file_path)
            InitCommand.__add_file(handler, repo_settings.dip_dep_file_path)
            InitCommand.__add_file(handler, repo_settings.dip_sub_file_path)
