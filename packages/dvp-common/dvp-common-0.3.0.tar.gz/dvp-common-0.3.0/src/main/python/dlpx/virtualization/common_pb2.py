...
# source: dlpx/virtualization/common.proto
...
_STAGEDSOURCE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='connection', full_name='com.delphix.virtualization.common.StagedSource.connection', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STAGEDSOURCE.fields_by_name['connection'].message_type = _REMOTECONNECTION
...
RemoteConnection = _reflection.GeneratedProtocolMessageType('RemoteConnection', (_message.Message,), dict(
  ...
  __module__ = 'dlpx.virtualization.common_pb2'
