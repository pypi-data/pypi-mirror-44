...
if __name__ == "__main__":
  websql = WebSQL('yulibin', '7db476181ddd0647179f0fcac791f8e6e1b24c49')
  result = websql.query('tangex_cupid', 'tangex_cupid', sql = 'SELECT * FROM customer limit 1')
  print(result)