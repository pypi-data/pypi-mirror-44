...
data_type = 'subhalo_challenge_lp_noise_5'
...
from workspace_jam.pipelines import pipeline_subhalo_light_profile_no_lens_light_cen

pipeline = pipeline_subhalo_light_profile_no_lens_light_cen.make_pipeline(phase_folders=[data_type + '_irregular_noise_5_cen',
