...
data_type = 'subhalo_challenge_lp_noise'
...
pipeline = pipeline_subhalo_light_profile_no_lens_light_src_4x4.make_pipeline(phase_folders=[data_type + '_irregular_noise_src_4x4',
