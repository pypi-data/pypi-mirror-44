...
def make_pipeline(phase_folders=None):
    ...
    pipeline_name = 'pipeline_subhalo_light_profile_no_lens_light_pl_bin_2'
    ...
    phase1 = LensSourcePhase(phase_name='phase_1_source', phase_folders=phase_folders,
                             ...
                             bin_up_factor=2, interp_pixel_scale=0.05,
    ...
    class GridPhase(autofit_ph.as_grid_search(ph.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass.slope = results.from_phase('phase_1_source').constant.lens.mass.slope
