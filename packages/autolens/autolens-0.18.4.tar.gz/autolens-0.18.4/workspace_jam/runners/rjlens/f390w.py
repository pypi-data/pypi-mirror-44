...
from workspace_jam.pipelines.lens_x1_light_included.initializers import lens_sersic_sie_source_sersic_from_init
from workspace_jam.pipelines.lens_x1_light_included.initializers import lens_sersic_sie_source_inversion_from_pl

pipeline_sss = lens_sersic_sie_source_sersic_from_init.make_pipeline(
    phase_folders=[data_type, data_name], positions_threshold=0.8)
pipeline_ssi = lens_sersic_sie_source_inversion_from_pl.make_pipeline(phase_folders=[data_type, data_name])

pipeline = pipeline_sss + pipeline_ssi
