...
from workspace_jam.pipelines.with_lens_light.subhalo import sensitivty_and_search_lens_sersic_sie_source_sersic_from_init
pipeline_parametric = lens_sersic_sie_source_sersic_from_init.make_pipeline(phase_folders=[data_type, data_name])
pipeline_subhalo = sensitivty_and_search_lens_sersic_sie_source_sersic_from_init.make_pipeline(phase_folders=[data_type, data_name])
