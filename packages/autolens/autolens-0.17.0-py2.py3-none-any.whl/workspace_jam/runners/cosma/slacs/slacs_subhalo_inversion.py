...
from workspace_jam.pipelines.with_lens_light.initializers import lens_sersic_sie_source_sersic_from_init
from workspace_jam.pipelines.with_lens_light.initializers import lens_sersic_sie_source_inversion_from_pl
from workspace_jam.pipelines.with_lens_light.subhalo import sensitivty_and_search_lens_sersic_sie_source_inversion_from_init
pipeline_parametric = lens_sersic_sie_source_sersic_from_init.make_pipeline(phase_folders=[data_type, data_name])
pipeline_inversion = lens_sersic_sie_source_inversion_from_pl.make_pipeline(phase_folders=[data_type, data_name])
pipeline_subhalo = sensitivty_and_search_lens_sersic_sie_source_inversion_from_init.make_pipeline(phase_folders=[data_type, data_name])

pipeline = pipeline_parametric + pipeline_inversion + pipeline_subhalo