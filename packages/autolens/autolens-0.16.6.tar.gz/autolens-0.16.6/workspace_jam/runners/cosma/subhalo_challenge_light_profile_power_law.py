...
from workspace_jam.pipelines.no_lens_light.initializers import lens_power_law_source_sersic_from_init

pipeline = lens_power_law_source_sersic_from_init.make_pipeline(phase_folders=[data_type, data_level, data_name])
