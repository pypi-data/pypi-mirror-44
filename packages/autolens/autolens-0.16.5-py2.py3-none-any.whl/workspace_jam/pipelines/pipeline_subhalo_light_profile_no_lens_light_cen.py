...
def make_pipeline(phase_folders=None):
    ...
    class GridPhase(autofit_ph.as_grid_search(ph.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass.centre_0 = results.from_phase('phase_1_source').variable.lens.mass.centre_0
            self.lens_galaxies.lens.mass.centre_1 = results.from_phase('phase_1_source').variable.lens.mass.centre_1
