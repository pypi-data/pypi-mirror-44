...
def make_pipeline(phase_folders=None):
    ...
    pipeline_name = 'pipeline_subhalo_light_profile_no_lens_light_small'
    ...
    class LensSourcePhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.subhalo.mass.centre_0 = 0.285
            self.lens_galaxies.subhalo.mass.centre_1 = 1.112
