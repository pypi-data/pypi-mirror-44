...
from workspace_jam.pipelines import pipeline_subhalo_light_profile_no_lens_light_pl_bin_2

pipeline = pipeline_subhalo_light_profile_no_lens_light_pl_bin_2.make_pipeline(phase_folders=[data_type + '_irregular_noise',
