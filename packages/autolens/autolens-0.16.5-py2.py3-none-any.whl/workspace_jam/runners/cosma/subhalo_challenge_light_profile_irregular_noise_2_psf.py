...
data_type = 'subhalo_challenge_lp_noise_2_psf'
...
from workspace_jam.pipelines import pipeline_subhalo_light_profile_no_lens_light_sub_2

pipeline = pipeline_subhalo_light_profile_no_lens_light_sub_2.make_pipeline(phase_folders=[data_type + '_irregular_noise_2_psf',
