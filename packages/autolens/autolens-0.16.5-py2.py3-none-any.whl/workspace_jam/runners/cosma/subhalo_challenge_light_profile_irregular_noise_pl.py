...
from workspace_jam.pipelines import pipeline_subhalo_light_profile_no_lens_light_pl

pipeline = pipeline_subhalo_light_profile_no_lens_light_pl.make_pipeline(phase_folders=[data_type + '_irregular_noise',
