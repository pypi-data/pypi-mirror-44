...
data_type = 'subhalo_challenge_lp_noise_2'
...
pipeline = pipeline_subhalo_light_profile_no_lens_light_2.make_pipeline(phase_folders=[data_type + '_irregular_noise_2',
