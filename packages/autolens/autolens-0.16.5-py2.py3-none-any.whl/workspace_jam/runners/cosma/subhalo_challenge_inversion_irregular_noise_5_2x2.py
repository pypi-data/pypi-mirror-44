...
from workspace_jam.pipelines import pipeline_subhalo_inversion_no_lens_light_2x2

pipeline = pipeline_subhalo_inversion_no_lens_light_2x2.make_pipeline(phase_folders=[data_type + '_2x2', data_level, data_name])
