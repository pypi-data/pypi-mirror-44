...
data_type = 'subhalo_challenge_lp_noise_5_psf'
...
pipeline = pipeline_subhalo_light_profile_no_lens_light_sub_2.make_pipeline(phase_folders=[data_type + '_irregular_noise_5_psf',
