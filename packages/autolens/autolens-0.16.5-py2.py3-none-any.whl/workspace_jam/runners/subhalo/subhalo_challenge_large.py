...
from workspace_jam.pipelines import pipeline_subhalo_light_profile_no_lens_light_large

pipeline = \
    pipeline_subhalo_light_profile_no_lens_light_large.make_pipeline(phase_folders=[data_type + '_irregular', data_level,
                                                                              data_name])
