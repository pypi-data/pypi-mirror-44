...
all_types = {
    ...
    "MessageForwardedFromUser": "message_forwarded_from_user",
    "MessageForwardedPost": "message_forwarded_post",
    ...
    "DeviceTokenGoogleCloudMessaging": "device_token_google_cloud_messaging",
