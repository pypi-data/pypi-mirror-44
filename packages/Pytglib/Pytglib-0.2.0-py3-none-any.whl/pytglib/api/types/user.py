...
class User(Object):
    ...
    def __init__(self, id, first_name, last_name, username, phone_number, status, profile_photo, outgoing_link, incoming_link, is_verified, restriction_reason, have_access, type, language_code, **kwargs):
    ...
    def read(q: dict, *args) -> "User":
        ...
        return User(id, first_name, last_name, username, phone_number, status, profile_photo, outgoing_link, incoming_link, is_verified, restriction_reason, have_access, type, language_code)
