...
class SupergroupFullInfo(Object):
    ...
    def __init__(self, description, member_count, administrator_count, restricted_count, banned_count, can_get_members, can_set_username, can_set_sticker_set, is_all_history_available, sticker_set_id, invite_link, pinned_message_id, upgraded_from_basic_group_id, upgraded_from_max_message_id, **kwargs):
    ...
    def read(q: dict, *args) -> "SupergroupFullInfo":
        ...
        return SupergroupFullInfo(description, member_count, administrator_count, restricted_count, banned_count, can_get_members, can_set_username, can_set_sticker_set, is_all_history_available, sticker_set_id, invite_link, pinned_message_id, upgraded_from_basic_group_id, upgraded_from_max_message_id)
