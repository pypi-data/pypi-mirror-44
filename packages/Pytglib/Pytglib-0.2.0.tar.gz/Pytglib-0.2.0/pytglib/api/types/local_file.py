...
class LocalFile(Object):
    ...
    Args:
        ...
        downloaded_prefix_size (:obj:`int`):
            If is_downloading_completed is false, then only some prefix of the file is ready to be readdownloaded_prefix_size is the size of that prefix
    ...
    def __init__(self, path, can_be_downloaded, can_be_deleted, is_downloading_active, is_downloading_completed, downloaded_prefix_size, downloaded_size, **kwargs):
    ...
    def read(q: dict, *args) -> "LocalFile":
        ...
        return LocalFile(path, can_be_downloaded, can_be_deleted, is_downloading_active, is_downloading_completed, downloaded_prefix_size, downloaded_size)
