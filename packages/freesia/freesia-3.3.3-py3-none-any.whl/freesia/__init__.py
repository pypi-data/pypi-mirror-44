...
def ErrorBox(parent, title, text, fg = None, buttonfg = None):
    """show an error message"""
    message = QtWidgets.QMessageBox(parent)
    ss = ""
    if fg is not None:
        ss += "QLabel{color: " + fg + ";}\n"
    if buttonfg is not None:
        ss += "QPushButton{color: " + buttonfg + ";}\n"
    if ss != "":
...
def WarningBox(parent, title, text, fg = None, buttonfg = None):
...
def InfoBox(parent, title, text, fg = None, buttonfg = None):
