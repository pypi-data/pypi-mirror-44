...
class respondent():
        ...
        def __init__(self, topic, node_name = "default", debug = False):
            ...
            print("RESP: New Respondent")
            print("RESP: Waiting for NEP master ...")
            success, port, ip  = nep.masterRegister(node_name, topic, master_ip = '127.0.0.1', master_port = 7000, socket = "respondent")
            print("RESP: Socket ready")
            self.debug = debug
