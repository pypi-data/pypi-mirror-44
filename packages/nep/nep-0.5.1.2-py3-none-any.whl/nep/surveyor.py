...
class surveyor():
        ...
        def __init__(self, topic, timeout = 1000, node_name = "default", debug = False):
            ...
            print("SURVEY: New Surveyor")
            print("SURVEY: Waiting for NEP master ...")
            success, port, ip  = nep.masterRegister(node_name, topic, master_ip = '127.0.0.1', master_port = 7000, socket = "surveyor")
            print("SURVEY: Socket ready")
            self.debug = debug
