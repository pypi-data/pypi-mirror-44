...
class Connection:
	...
	def __init__(self, connect_json, header):
		...
		institution_json = requests.get(self.API_URL + "/institutions/" + connect_json['institution']['id'], headers=self.__HEADER)
		
		self.logo_big = institution_json['data']['logo']['links']['full']

		self.logo_small = institution_json['data']['logo']['links']['square']
