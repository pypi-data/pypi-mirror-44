...
class PipelineEndpoint(object):
    """
    A PipelineEndpoint represents a pipeline task that can be triggered from a unique endpoint URL.

    The underlying pipeline can be updated with new versions while keeping the endpoint URL the same.
    Pipeline endpoints are uniquely named within a workspace.
    ...
    :param pipeline_version_list: The list of :class:`azureml.pipeline.core.PipelineIdVersion`
    ...
    def pipeline_version_list(self):
        ...
        :return: The list of :class:`azureml.pipeline.core.PipelineIdVersion`
        :rtype: list
        """
    ...
    def publish(workspace, name, description, pipeline,
        ...
        :type pipeline: class:`azureml.pipeline.core.graph.PublishedPipeline` or
    ...
    def get_pipeline(self, version=None):
        ...
        :rtype: class:`azureml.pipeline.core.PublishedPipeline`
        """
        if version is None:
        ...
        raise ValueError('pipeline for version %s not found in pipelineEndpoint %s' % (version, self.id))
    ...
    def get_all_versions(self, _workflow_provider=None, _service_endpoint=None):
        ...
        :param _service_endpoint: The service endpoint.
        :type _service_endpoint: str
        :return: a list of dictionary of :class:`azureml.pipeline.core.PublishedPipeline` and version
        :rtype: list
        """
        published_pipeline_provider = self._published_pipeline_provider
    ...
    def get_all_pipelines(self, _workflow_provider=None, _service_endpoint=None):
        """
        ...
        :param _service_endpoint: The service endpoint.
        :type _service_endpoint: str
        :return: a list of dictionary of :class:`azureml.pipeline.core.PublishedPipeline`
        :rtype: list
        """
        published_pipeline_provider = self._published_pipeline_provider
        pipeline_id_list = self._pipeline_version_list
    ...
    def reactivate(self, name):
        ...
        :type name: str
        :return: PipelineEndpoint object
        :rtype: class:`azureml.pipeline.core.PipelineEndpoint`
        """
        status = 'Active'
        new_pipeline_endpoint = self._pipeline_endpoint_provider.update_pipeline_endpoint(self.id, name=name,
                                                                                          status=status)
    ...
    def add(self, pipeline):
        ...
        :param pipeline: published pipeline to add in PipelineEndpoint
        :type pipeline: class:`azureml.pipeline.core.graph.PublishedPipeline`
        """
        pipeline_id = pipeline.id
    ...
    def set_default_version(self, version):
        ...
        if set_flag is True:
            ...
            raise ValueError('Cannot set version %s, do not exists in pipeline endpoint %s. Please, use add()'
    ...
    def set_default(self, pipeline):
        ...
        :param pipeline: The publish pipeline to set as default
        :type pipeline: class:`azureml.pipeline.core.graph.PublishedPipeline`
        """
        set_flag = False
        version = None
        ...
        if set_flag is True:
            ...
            raise ValueError('Cannot set pipeline, pipeline id %s do not exists in pipeline endpoint %s.'
