...
# List of Less functions obtained from:
# http://lesscss.org/functions/
_less_functions = ('color','image-size','image-width','image-height','convert','data-uri','default','unit','get-unit','svg-gradient','escape','e','%','replace','length','extract', 'floor','percentage','round','sqrt','abs','sin','asin','cos','acos','tan','atan','pi','pow','mod','min','max','isnumber','isstring','iscolor','iskeyword','isurl','ispixel','isem','ispercentage','isunit','isruleset','rgb','rgba','argb','hsl','hsla','hsv','hsva','hue','saturation','lightness','hsvhue','hsvsaturation','hsvvalue','red','green','blue','alpha','luma','luminance','saturate','desaturate','lighten','darken','fadein','fadeout','fade','spin','mix','tint','shade','greyscale','contrast','multiply','screen','overlay','softlight','hardlight','difference','exclusion','average','negation');
...
class LessCssLexer(CssLexer):
    ...
    tokens = {
        'root': [
            (r'(@)([\w-]+)(\s*)(:)', bygroups(Punctuation, Keyword,Text,Punctuation),'value-start'),
            (r'\{', Punctuation,'nested'),
            inherit,
        ],
        'content': [
            (r'([@.])([\w-]+)(\s*)(\:)', bygroups(Punctuation, Keyword, Text, Punctuation), 'value-start'),
            (r'([@.])([\w-]+)(\s*)([@.])([\w-]+)', bygroups(Punctuation, Keyword, Text, Punctuation, Keyword), 'nested'),
            (r'\{', Punctuation,'nested'),
        ...
        'nested': [
            (r'//[^\n]*', Comment.Single),
            (r'/\*(?:.|\n)*?\*/', Comment),
            (r'([@.])([\w-]+)(\s*)(\:)', bygroups(Punctuation, Name.Tag, Text, Punctuation), 'value-start'),
            (r'(\.)([\w-]+)', bygroups(Punctuation, Name.Tag)),
        ...
        'value-start': [
            ...
            (r'('+r'|'.join(_less_functions)+r')', bygroups(Name.Tag)),
            inherit,
        ]
    }
