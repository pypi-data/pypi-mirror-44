...
import os
import glob
# Caracterização Massiva - Ap. Regular & Promocao - versao 2.0 - last update: 25/02/2019
...
# ---------------------------------------------------------------------------------------
    ...
    # Log Error
    queryError = pd.merge(BASE[['ItmId','Descricao']],
                OGRDS[['ItmId','ITEM DESCRIPTIONS','Item Code']],
                on='ItmId', how='left',indicator=True)
    logError = queryError.loc[queryError['Item Code'].isnull()]
    ...
    return print(f' > Processo concluído!\n \033[0;31m> Itens não Encontrados: \n{logError['ItmId']}\033[m ')
#---------------------------------------------------------------------------------------------------------------------------------------------
...
def validaCampoPROMO(dataset,coluna,arg1,arg2,arg3):
    ...
    return  print(dataset.shape,'\n','\033[0;31mCorretos: \033[m',correto ,' ','\033[0;31mIncorretos: \033[m',incorreto) 
#---------------------------------------------------------------------------------------------------------------------------------------------
