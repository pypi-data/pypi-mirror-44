...
# ---------------------------------------------------------------------------------------
    ...
    return print(f' ALTERADO(s) AP. REGULAR: \033[0;31m{contaAp}\033[m ALTERADO(s) PROMO: \033[0;31m{contaPromo}\033[m > Processo concluído!  \n > \033[0;31mNúmero total de registro(s) \033[m{len(final)}\n > \033[0;31mItens não Encontrados:\033[m \033[0;31mAp. Regular: \033[m {len(logErrorAp)}  \033[0;31mPromocao: \033[m {len(logErrorPromo)}')
#---------------------------------------------------------------------------------------------------------------------------------------------
