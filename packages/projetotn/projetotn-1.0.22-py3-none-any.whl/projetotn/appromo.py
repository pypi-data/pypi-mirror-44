...
# ---------------------------------------------------------------------------------------
    ...
    return print(f' > Processo concluído!\n \033[0;31m> Número de registro: \033[m{len(final)}\n \033[0;31m> Itens não Encontrados:\033[m \n \033[0;31mAp. Regular: \033[m {len(logErrorAp)}  \033[0;31mPromocao: \033[m {len(logErrorPromo)}')
#---------------------------------------------------------------------------------------------------------------------------------------------
