...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codecommit", "0.26.0", __name__, "aws-codecommit@0.26.0.jsii.tgz")
...
class IRepository(aws_cdk.cdk.IConstruct, jsii.compat.Protocol):
    ...
    def to_code_pipeline_source_action(self, *, branch: typing.Optional[str]=None, output_artifact_name: typing.Optional[str]=None, poll_for_source_changes: typing.Optional[bool]=None) -> "PipelineSourceAction":
        ...
