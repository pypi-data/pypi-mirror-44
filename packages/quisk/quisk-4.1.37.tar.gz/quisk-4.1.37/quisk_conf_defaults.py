...
# This is the 3 dB bandwidth of the DC removal filter used for SoftRock and other hardware that
# reads the samples from a soundcard. Choose a bandwidth that suppresses DC and low frequency
# noise. Enter zero to disable the filter.
# Changes are immediate (no need to restart).
#dc_remove_bw =  20
#dc_remove_bw =  50
dc_remove_bw = 100
