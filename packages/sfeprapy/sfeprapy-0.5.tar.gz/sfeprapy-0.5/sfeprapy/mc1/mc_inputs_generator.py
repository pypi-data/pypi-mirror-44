...
def mc_inputs_generator(
    ...
    if n_simulations > 2:
        ...
        lhs_mat = latin_hypercube_sampling(num_samples=n_simulations, num_arguments=6)
        ...
        qfd_lhs = gumbel_r_trunc_ppf(fire_qfd_lbound, fire_qfd_ubound, n_simulations, qfd_loc, qfd_scale) * comb_lhs
        ...
        opening_fraction_mean_conv, opening_fraction_std_conv = lognorm_parameters_true_to_inv(room_opening_fraction_mean,
                                                                                               room_opening_fraction_std)
        glaz_lhs = 1 - lognorm_trunc_ppf(room_opening_fraction_lbound, room_opening_fraction_ubound, n_simulations,
