...
class AtcClassificationUtils:
    ...
    def __init__(self, **kwargs):
        #
        self.__AtcDirPath = kwargs.get("AtcDirPath", '.')
        useCache = kwargs.get("useCache", True)
        self.__version = kwargs.get('AtcVersion', '2018')
        #
        self.__mU = MarshalUtil(workPath=self.__AtcDirPath)

        self.__nD, self.__pD, self.__pdbD = self.__reload(urlTarget, self.__AtcDirPath, useCache=useCache, version=self.__version)
        #

    def getAtcVersion(self, pdbId, authAsymId):
    ...
    def __extractDescription(self, desL):
        ...
        http://purl.bioontology.org/ontology/UATC/V09AA,"Technetium 99m compounds, central nervous system diagnostic radiopharmaceuticals",Technetium (99mTc) compounds,,false,C3541402,http://purl.bioontology.org/ontology/STY/T130|http://purl.bioontology.org/ontology/STY/T109,http://purl.bioontology.org/ontology/UATC/V09A,4,Y,http://purl.bioontology.org/ontology/STY/T130|http://purl.bioontology.org/ontology/STY/T109
        h
