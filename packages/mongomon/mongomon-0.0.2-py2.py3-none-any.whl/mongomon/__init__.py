...
#       - advanced grouping (N+1 detection), need a request context store + request context integration (cleanups) --- take from newrelic
#         analyzers should be pluggable and configurable
