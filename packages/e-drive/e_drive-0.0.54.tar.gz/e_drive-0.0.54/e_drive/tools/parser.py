...
class Parser():
    ...
    def help(self):
        ...
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "RawCardRange 10 0.2" + Style.RESET_ALL)
        ...
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light hold 100 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light flicker 100 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light flickerdouble 100 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light dimming 3 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light sunrise 5 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light sunset 5 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light rainbow 8 50 50 10" + Style.RESET_ALL)
        print(Fore.GREEN + "   > " + Fore.WHITE + "python -m e_drive " + Fore.YELLOW + "light rainbow2 8 50 50 10" + Style.RESET_ALL)
