    ...
    def run(self):
        ...
        if (self.count > 0) and (self.arguments != None):
            ...
            # >python -m e_drive light flicker 100 50 50 10
                ...
                print (Fore.WHITE + "Light: " + Fore.YELLOW + "{0}, ({1}, {2}, {3})".format(int(self.arguments[1]), int(self.arguments[2]), int(self.arguments[3]), int(self.arguments[4])) + Style.RESET_ALL)
                self.light(self.arguments[0], int(self.arguments[1]), int(self.arguments[2]), int(self.arguments[3]), int(self.arguments[4]))
                return
