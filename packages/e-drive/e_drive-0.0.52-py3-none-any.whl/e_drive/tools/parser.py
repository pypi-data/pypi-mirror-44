...
class Parser():
    ...
    def help(self):
        ...
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "request State 10 0.2" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "request Motion 10 0.2" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "request RawLineTracer 10 0.2" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "request RawCard 10 0.2" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "RawCardRange 10 0.2" + Style.RESET_ALL)

        print("")
        print(Fore.CYAN + "  - Buzzer" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "buzzer 400 2000" + Style.RESET_ALL)

        print("")
        print(Fore.CYAN + "  - Light" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "light hold 100 50 50 10" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "light flicker 100 50 50 10" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "light flickerdouble 100 50 50 10" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "light dimming 3 50 50 10" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "light sunrise 5 50 50 10" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "light sunset 5 50 50 10" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "light rainbow 8 50 50 10" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "light rainbow2 8 50 50 10" + Style.RESET_ALL)

        print("")
        print(Fore.CYAN + "  - Bluetooth" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "connect" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "disconnect" + Style.RESET_ALL)

        print("")
        print(Fore.CYAN + "  - GUI" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "card" + Style.RESET_ALL)
        print(Fore.WHITE + "   > python -m e_drive " + Fore.YELLOW + "cards" + Style.RESET_ALL)
