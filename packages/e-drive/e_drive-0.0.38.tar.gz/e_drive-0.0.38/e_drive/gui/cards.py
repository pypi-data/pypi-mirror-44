...
class CardReaderAndList(App):
    ...
    def eventRawCardList(self, rawCardList):
        ...
        for i in range(0, 40):
            ...
            with self.widgetCardListBottom[i].canvas:
                ...
                Rectangle(pos=(self.widgetCardListTop[i].x, self.widgetCardListBottom[i].y), size=(self.widgetCardListTop[i].width, self.widgetCardListBottom[i].height))
    ...
    def build(self):
        ...
        l2Top = BoxLayout(size_hint=(1, None), height=30)
        l3TopCardListArray = []
        for i in range(0, 40):
