...
class SkyhookDB:
    ...
    def get_location(self, ip_address):
        ...
        try:
            ...
            self.__db_data = SkyhookContextAcceleratorIp.get(ip_address)
            ...
            logger.error(
                "Service is unavailable. ServiceError: %s ", str(exception))
    ...
    def add_to_map(self):
        ...
        """
        try:
            logger.debug("Calling addmarker method for %s DB", SkyhookContextAcceleratorIp.__name__)
