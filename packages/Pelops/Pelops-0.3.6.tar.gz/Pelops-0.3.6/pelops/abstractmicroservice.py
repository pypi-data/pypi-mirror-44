...
class AbstractMicroservice:
    ...
    def __init__(self, config, config_class_root_node_name,
        ...
        self._asyncstart_thread = threading.Thread(target=self.start, name=__name__+".asyncstart")
        self._asyncstop_thread = threading.Thread(target=self.stop, name=__name__+".asyncstop")
    ...
    def _cmd_monitoring_agent_state(self, args):
        ...
        text = "gid: {}\n".format(self._monitoring_agent.get_gid())
