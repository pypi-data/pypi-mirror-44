...
def main(host, user, password, root, move_to, verbose):
    ...
    dl_mail_attachments(host, user, password, root, move_to)


def dl_mail_attachments(host, user, password, root, move_to):
    root = Path(root)
