...
def run(appname,filename,pygameusage,console,icon):
    ...
    if pygameusage==True:
        ...
        print()
        print('build_exe_options={"build_exe":{"packages":imodules,"excludes":emodules}}')
...
def about():
    print("About cxgen 1.0")
    print()
    print("Created by Armaan Aggarwal on April 10, 2019")

print("cxgen 1.0 successfully imported")
print("To see the manual of cxgen 1.0, use the command 'cxgen.manual()'")
