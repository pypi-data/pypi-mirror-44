...
def __main__():
    ...
    if args.intersection:
        ...
        soln = None
        try:
            soln = PWEQuery.intersection(expected_pws, dfs, r_id, args.cols, args.pws, True)
        ...
        soln = None
        try:
            soln = PWEQuery.union(expected_pws, dfs, r_id, args.cols, args.pws, True)
        except Exception as e:
            print("Query failed. Please check the provided arguments to make sure they are valid.")
            print("Error: ", str(e))
            exit(1)
        ...
        soln = None
        try:
            soln = PWEQuery.freq(expected_pws, dfs, r_id, args.cols, args.vals, args.pws, True)
        except Exception as e:
            print("Query failed. Please check the provided arguments to make sure they are valid.")
            print("Error: ", str(e))
            exit(1)
        ...
        try:
            for i in pws_to_consider:
                soln.append(PWEQuery.num_tuples(dfs, r_id, i, True))
        except Exception as e:
            print("Query failed. Please check the provided arguments to make sure they are valid.")
            print("Error: ", str(e))
            exit(1)
        ...
        if args.difference == 'one-way':
            try:
                soln = PWEQuery.difference(dfs, r_id, args.pws[0], args.pws[1], args.cols, True)
            except Exception as e:
                print("Query failed. Please check the provided arguments to make sure they are valid.")
                print("Error: ", str(e))
                exit(1)
            ...
            try:
                soln = PWEQuery.difference_both_ways(dfs, r_id, args.pws[0], args.pws[1], args.cols, True)
            except Exception as e:
                print("Query failed. Please check the provided arguments to make sure they are valid.")
                print("Error: ", str(e))
                exit(1)
        ...
        soln = None
        try:
            soln = PWEQuery.redundant_column(expected_pws, dfs, r_id, args.cols, args.pws, True)
        except Exception as e:
            print("Query failed. Please check the provided arguments to make sure they are valid.")
            print("Error: ", str(e))
            exit(1)
