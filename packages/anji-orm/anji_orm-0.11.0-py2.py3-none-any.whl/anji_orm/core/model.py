...
class Model(metaclass=ModelMetaclass):  # pylint: disable=too-many-public-methods
    ...
    def send(self) -> None:
        self.pre_save.dispatch(self, callback_args=(self,))
        orm_register.shared.executor.send_model(self)
        self.post_save.dispatch(self, callback_args=(self,))

    async def async_send(self) -> None:
        await self.pre_async_save.dispatch(self, callback_args=(self,))
        await orm_register.shared.executor.send_model(self)
        await self.post_async_save.dispatch(self, callback_args=(self,))

    def delete(self) -> None:
        self.pre_delete.dispatch(self, callback_args=(self,))
        orm_register.shared.executor.delete_model(self)
        self.post_delete.dispatch(self, callback_args=(self,))

    async def async_delete(self) -> None:
        await self.pre_async_delete.dispatch(self, callback_args=(self,))
        await orm_register.shared.executor.delete_model(self)
        await self.post_async_delete.dispatch(self, callback_args=(self,))
