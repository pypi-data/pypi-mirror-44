...
PIPELINES_BY_PRIMITIVE = {
    ...
    'd3m.primitives.sri.graph.CommunityDetectionParser': [
    ...
    'd3m.primitives.sri.graph.VertexNominationParser': [
        EdgeListToGraphVertexNominationPipeline,
        GraphToEdgeListVertexNominationPipeline,
    ...
    'd3m.primitives.sri.psl.GeneralRelational': [
    ],
    'd3m.primitives.sri.psl.GeneralRelationalDataset': [
    ...
    'd3m.primitives.sri.psl.RelationalTimeseries': [
