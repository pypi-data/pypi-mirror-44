...
class EarningsRecord(object):
    ...
    def time_of_day_dict(self):
        ...
        value = getattr(self, time_of_day)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def broadcast_url_dict(self):
        ...
        value = getattr(self, broadcast_url)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def transcript_url_dict(self):
        ...
        value = getattr(self, transcript_url)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def transcript_quarter_dict(self):
        ...
        value = getattr(self, transcript_quarter)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def transcript_fiscal_year_dict(self):
        ...
        value = getattr(self, transcript_fiscal_year)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def conference_call_date_dict(self):
        ...
        value = getattr(self, conference_call_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def conference_call_time_dict(self):
        ...
        value = getattr(self, conference_call_time)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def conference_call_phone_number_dict(self):
        ...
        value = getattr(self, conference_call_phone_number)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def conference_call_passcode_dict(self):
        ...
        value = getattr(self, conference_call_passcode)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_confirmation_date_dict(self):
        ...
        value = getattr(self, last_confirmation_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def board_of_directors_meeting_date_dict(self):
        ...
        value = getattr(self, board_of_directors_meeting_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def board_of_directors_meeting_type_dict(self):
        ...
        value = getattr(self, board_of_directors_meeting_type)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def company_website_dict(self):
        ...
        value = getattr(self, company_website)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def next_earnings_date_dict(self):
        ...
        value = getattr(self, next_earnings_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def next_earnings_quarter_dict(self):
        ...
        value = getattr(self, next_earnings_quarter)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def next_earnings_fiscal_year_dict(self):
        ...
        value = getattr(self, next_earnings_fiscal_year)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
