...
class StockExchange(object):
    ...
    def country_code_dict(self):
        ...
        value = getattr(self, country_code)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def first_stock_price_date_dict(self):
        ...
        value = getattr(self, first_stock_price_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_stock_price_date_dict(self):
        ...
        value = getattr(self, last_stock_price_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
