...
class Municipality(object):
    ...
    def government_name_dict(self):
        ...
        value = getattr(self, government_name)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def government_type_dict(self):
        ...
        value = getattr(self, government_type)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def primary_contact_type_dict(self):
        ...
        value = getattr(self, primary_contact_type)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def population_as_of_year_dict(self):
        ...
        value = getattr(self, population_as_of_year)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def enrollment_as_of_year_dict(self):
        ...
        value = getattr(self, enrollment_as_of_year)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
