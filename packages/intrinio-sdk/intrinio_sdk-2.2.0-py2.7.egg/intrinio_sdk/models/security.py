...
class Security(object):
    ...
    def share_class_dict(self):
        ...
        value = getattr(self, share_class)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def round_lot_size_dict(self):
        ...
        value = getattr(self, round_lot_size)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def exchange_ticker_dict(self):
        ...
        value = getattr(self, exchange_ticker)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def composite_ticker_dict(self):
        ...
        value = getattr(self, composite_ticker)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def alternate_tickers_dict(self):
        ...
        value = getattr(self, alternate_tickers)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def composite_figi_dict(self):
        ...
        value = getattr(self, composite_figi)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def share_class_figi_dict(self):
        ...
        value = getattr(self, share_class_figi)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def figi_uniqueid_dict(self):
        ...
        value = getattr(self, figi_uniqueid)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def primary_listing_dict(self):
        ...
        value = getattr(self, primary_listing)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def primary_security_dict(self):
        ...
        value = getattr(self, primary_security)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def first_stock_price_dict(self):
        ...
        value = getattr(self, first_stock_price)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_stock_price_dict(self):
        ...
        value = getattr(self, last_stock_price)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_stock_price_adjustment_dict(self):
        ...
        value = getattr(self, last_stock_price_adjustment)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_corporate_action_dict(self):
        ...
        value = getattr(self, last_corporate_action)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def previous_tickers_dict(self):
        ...
        value = getattr(self, previous_tickers)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def listing_exchange_mic_dict(self):
        ...
        value = getattr(self, listing_exchange_mic)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
