...
class Fundamental(object):
    ...
    def __init__(self, id=None, statement_code=None, fiscal_year=None, fiscal_period=None, type=None, start_date=None, end_date=None, filing_date=None, company=None):  # noqa: E501
    ...
    def statement_code_dict(self):
        ...
        value = getattr(self, statement_code)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def fiscal_period_dict(self):
        ...
        value = getattr(self, fiscal_period)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
