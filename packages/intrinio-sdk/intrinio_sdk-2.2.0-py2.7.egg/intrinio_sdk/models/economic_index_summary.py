...
class EconomicIndexSummary(object):
    ...
    def __init__(self, id=None, symbol=None, name=None, continent=None, country=None, update_frequency=None, last_updated=None, observation_start=None, observation_end=None, seasonal_adjustment=None, units=None):  # noqa: E501
        """EconomicIndexSummary - a model defined in Swagger"""  # noqa: E501
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EconomicIndexSummary.

        The Intrinio ID for the Index  # noqa: E501

        :param id: The id of this EconomicIndexSummary.  # noqa: E501
        :type: str
        """
    ...
    def symbol(self, symbol):
        """Sets the symbol of this EconomicIndexSummary.

        The symbol used to identify the Index  # noqa: E501

        :param symbol: The symbol of this EconomicIndexSummary.  # noqa: E501
        :type: str
        """
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this EconomicIndexSummary.

        The name of the Index  # noqa: E501

        :param name: The name of this EconomicIndexSummary.  # noqa: E501
        :type: str
        """
    ...
    def continent(self, continent):
        """Sets the continent of this EconomicIndexSummary.

        The continent of the country of focus for the Index  # noqa: E501

        :param continent: The continent of this EconomicIndexSummary.  # noqa: E501
        :type: str
        """
    ...
    def country(self, country):
        """Sets the country of this EconomicIndexSummary.

        The country of focus for the Index  # noqa: E501

        :param country: The country of this EconomicIndexSummary.  # noqa: E501
        :type: str
        """
    ...
    def update_frequency_dict(self):
        ...
        value = getattr(self, update_frequency)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def update_frequency(self, update_frequency):
        """Sets the update_frequency of this EconomicIndexSummary.

        How often the Index is updated  # noqa: E501

        :param update_frequency: The update_frequency of this EconomicIndexSummary.  # noqa: E501
        :type: str
        """
    ...
    def last_updated(self, last_updated):
        """Sets the last_updated of this EconomicIndexSummary.

        When the Index was updated last  # noqa: E501

        :param last_updated: The last_updated of this EconomicIndexSummary.  # noqa: E501
        :type: datetime
        """
    ...
    def observation_start_dict(self):
        ...
        value = getattr(self, observation_start)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def observation_start(self, observation_start):
        """Sets the observation_start of this EconomicIndexSummary.

        The earliest date for which data is available  # noqa: E501

        :param observation_start: The observation_start of this EconomicIndexSummary.  # noqa: E501
        :type: date
        """
    ...
    def observation_end_dict(self):
        ...
        value = getattr(self, observation_end)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def observation_end(self, observation_end):
        """Sets the observation_end of this EconomicIndexSummary.

        The latest date for which data is available  # noqa: E501

        :param observation_end: The observation_end of this EconomicIndexSummary.  # noqa: E501
        :type: date
        """
    ...
    def seasonal_adjustment_dict(self):
        ...
        value = getattr(self, seasonal_adjustment)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def seasonal_adjustment(self, seasonal_adjustment):
        """Sets the seasonal_adjustment of this EconomicIndexSummary.

        Whether the data is adjusted to account for seasonality  # noqa: E501

        :param seasonal_adjustment: The seasonal_adjustment of this EconomicIndexSummary.  # noqa: E501
        :type: str
        """
    ...
    def units(self, units):
        """Sets the units of this EconomicIndexSummary.

        The units of the data  # noqa: E501

        :param units: The units of this EconomicIndexSummary.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EconomicIndexSummary):
            return False
