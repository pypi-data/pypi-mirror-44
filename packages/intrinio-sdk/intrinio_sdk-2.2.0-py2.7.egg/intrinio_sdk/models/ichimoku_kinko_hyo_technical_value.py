...
class IchimokuKinkoHyoTechnicalValue(object):
    ...
    def chikou_span_dict(self):
        ...
        value = getattr(self, chikou_span)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def senkou_span_a_dict(self):
        ...
        value = getattr(self, senkou_span_a)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def senkou_span_b_dict(self):
        ...
        value = getattr(self, senkou_span_b)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
