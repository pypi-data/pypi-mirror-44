...
class OptionPrice(object):
    ...
    def open_interest_dict(self):
        ...
        value = getattr(self, open_interest)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def open_interest_change_dict(self):
        ...
        value = getattr(self, open_interest_change)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def next_day_open_interest_dict(self):
        ...
        value = getattr(self, next_day_open_interest)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def implied_volatility_dict(self):
        ...
        value = getattr(self, implied_volatility)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def implied_volatility_change_dict(self):
        ...
        value = getattr(self, implied_volatility_change)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
