...
class CompanyFiling(object):
    ...
    def __init__(self, id=None, filing_date=None, accepted_date=None, period_end_date=None, report_type=None, sec_unique_id=None, filing_url=None, report_url=None, instance_url=None, company=None):  # noqa: E501
        """CompanyFiling - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this CompanyFiling.  # noqa: E501

        The Intrinio ID of the Filing  # noqa: E501

        :return: The id of this CompanyFiling.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CompanyFiling.

        The Intrinio ID of the Filing  # noqa: E501

        :param id: The id of this CompanyFiling.  # noqa: E501
        :type: str
        """
    ...
    def filing_date(self):
        """Gets the filing_date of this CompanyFiling.  # noqa: E501

        The date when the filing was submitted to the SEC by the company  # noqa: E501

        :return: The filing_date of this CompanyFiling.  # noqa: E501
        :rtype: date
        """
    ...
    def filing_date_dict(self):
        ...
        value = getattr(self, filing_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def filing_date(self, filing_date):
        """Sets the filing_date of this CompanyFiling.

        The date when the filing was submitted to the SEC by the company  # noqa: E501

        :param filing_date: The filing_date of this CompanyFiling.  # noqa: E501
        :type: date
        """
    ...
    def accepted_date(self):
        """Gets the accepted_date of this CompanyFiling.  # noqa: E501
    ...
    def accepted_date_dict(self):
        ...
        value = getattr(self, accepted_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def accepted_date(self, accepted_date):
        """Sets the accepted_date of this CompanyFiling.
    ...
    def period_end_date(self):
        """Gets the period_end_date of this CompanyFiling.  # noqa: E501

        The ending date of the fiscal period for the filing  # noqa: E501

        :return: The period_end_date of this CompanyFiling.  # noqa: E501
        :rtype: date
        """
    ...
    def period_end_date_dict(self):
        ...
        value = getattr(self, period_end_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def period_end_date(self, period_end_date):
        """Sets the period_end_date of this CompanyFiling.

        The ending date of the fiscal period for the filing  # noqa: E501

        :param period_end_date: The period_end_date of this CompanyFiling.  # noqa: E501
        :type: date
        """
    ...
    def report_type(self):
        """Gets the report_type of this CompanyFiling.  # noqa: E501

        The filing report type  # noqa: E501

        :return: The report_type of this CompanyFiling.  # noqa: E501
        :rtype: str
        """
    ...
    def report_type_dict(self):
        ...
        value = getattr(self, report_type)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def report_type(self, report_type):
        """Sets the report_type of this CompanyFiling.

        The filing report type  # noqa: E501

        :param report_type: The report_type of this CompanyFiling.  # noqa: E501
        :type: str
        """
    ...
    def sec_unique_id(self):
        """Gets the sec_unique_id of this CompanyFiling.  # noqa: E501

        A unique identifier for the filing provided by the SEC  # noqa: E501

        :return: The sec_unique_id of this CompanyFiling.  # noqa: E501
        :rtype: str
        """
    ...
    def sec_unique_id_dict(self):
        ...
        value = getattr(self, sec_unique_id)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def sec_unique_id(self, sec_unique_id):
        """Sets the sec_unique_id of this CompanyFiling.

        A unique identifier for the filing provided by the SEC  # noqa: E501

        :param sec_unique_id: The sec_unique_id of this CompanyFiling.  # noqa: E501
        :type: str
        """
    ...
    @property
    def filing_url(self):
        """Gets the filing_url of this CompanyFiling.  # noqa: E501

        The URL to the filing page on the SEC site  # noqa: E501

        :return: The filing_url of this CompanyFiling.  # noqa: E501
        :rtype: str
        """
    ...
    def filing_url(self, filing_url):
        """Sets the filing_url of this CompanyFiling.

        The URL to the filing page on the SEC site  # noqa: E501

        :param filing_url: The filing_url of this CompanyFiling.  # noqa: E501
        :type: str
        """
    ...
    @property
    def report_url(self):
        """Gets the report_url of this CompanyFiling.  # noqa: E501

        The URL to the actual report on the SEC site  # noqa: E501

        :return: The report_url of this CompanyFiling.  # noqa: E501
        :rtype: str
        """
    ...
    def report_url(self, report_url):
        """Sets the report_url of this CompanyFiling.

        The URL to the actual report on the SEC site  # noqa: E501

        :param report_url: The report_url of this CompanyFiling.  # noqa: E501
        :type: str
        """
    ...
    def instance_url(self):
        """Gets the instance_url of this CompanyFiling.  # noqa: E501

        The URL for the XBRL filing for the report  # noqa: E501

        :return: The instance_url of this CompanyFiling.  # noqa: E501
        :rtype: str
        """
    ...
    def instance_url_dict(self):
        ...
        value = getattr(self, instance_url)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def instance_url(self, instance_url):
        """Sets the instance_url of this CompanyFiling.

        The URL for the XBRL filing for the report  # noqa: E501

        :param instance_url: The instance_url of this CompanyFiling.  # noqa: E501
        :type: str
        """
    ...
    @property
    def company(self):
        """Gets the company of this CompanyFiling.  # noqa: E501


        :return: The company of this CompanyFiling.  # noqa: E501
    ...
    def company(self, company):
        """Sets the company of this CompanyFiling.


        :param company: The company of this CompanyFiling.  # noqa: E501
        :type: CompanySummary
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompanyFiling):
            return False
