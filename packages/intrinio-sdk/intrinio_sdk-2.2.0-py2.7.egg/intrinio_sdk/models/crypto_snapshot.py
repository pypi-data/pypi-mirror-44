...
class CryptoSnapshot(object):
    ...
    def change_percent_dict(self):
        ...
        value = getattr(self, change_percent)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_trade_side_dict(self):
        ...
        value = getattr(self, last_trade_side)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_trade_time_dict(self):
        ...
        value = getattr(self, last_trade_time)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_trade_price_dict(self):
        ...
        value = getattr(self, last_trade_price)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_trade_size_dict(self):
        ...
        value = getattr(self, last_trade_size)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
