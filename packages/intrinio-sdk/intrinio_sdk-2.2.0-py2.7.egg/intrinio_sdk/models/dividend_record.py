...
class DividendRecord(object):
    ...
    def ex_dividend_dict(self):
        ...
        value = getattr(self, ex_dividend)
    ...
    def announcement_date_dict(self):
        ...
        value = getattr(self, announcement_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def record_date_dict(self):
        ...
        value = getattr(self, record_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def forward_yield_dict(self):
        ...
        value = getattr(self, forward_yield)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def forward_rate_dict(self):
        ...
        value = getattr(self, forward_rate)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
