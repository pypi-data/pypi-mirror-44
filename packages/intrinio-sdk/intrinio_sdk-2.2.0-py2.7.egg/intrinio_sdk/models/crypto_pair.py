...
class CryptoPair(object):
    ...
    def __init__(self, name=None, code=None, first_price_date=None, last_price_date=None, book_depth_available=None, history_available=None, snapshot_available=None, trades_available=None):  # noqa: E501
        """CryptoPair - a model defined in Swagger"""  # noqa: E501
    ...
    def name(self):
        ...
        The Crypto Currency Pair name.  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CryptoPair.

        The Crypto Currency Pair name.  # noqa: E501

        :param name: The name of this CryptoPair.  # noqa: E501
        :type: str
        """
    ...
    def code(self):
        ...
        The Crypto Currency Pair code.  # noqa: E501
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this CryptoPair.

        The Crypto Currency Pair code.  # noqa: E501

        :param code: The code of this CryptoPair.  # noqa: E501
        :type: str
        """
    ...
    def first_price_date_dict(self):
        ...
        value = getattr(self, first_price_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def first_price_date(self, first_price_date):
        """Sets the first_price_date of this CryptoPair.

        The earliest date that daily historical pricing is available for.  # noqa: E501

        :param first_price_date: The first_price_date of this CryptoPair.  # noqa: E501
        :type: str
        """
    ...
    def last_price_date_dict(self):
        ...
        value = getattr(self, last_price_date)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def last_price_date(self, last_price_date):
        """Sets the last_price_date of this CryptoPair.

        The most recent date that daily historical pricing is available for.  # noqa: E501

        :param last_price_date: The last_price_date of this CryptoPair.  # noqa: E501
        :type: str
        """
    ...
    def book_depth_available(self):
        ...
        A boolean, representing whether this pair has book depth data available or not.  # noqa: E501
    ...
    def book_depth_available_dict(self):
        ...
        value = getattr(self, book_depth_available)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def book_depth_available(self, book_depth_available):
        """Sets the book_depth_available of this CryptoPair.

        A boolean, representing whether this pair has book depth data available or not.  # noqa: E501

        :param book_depth_available: The book_depth_available of this CryptoPair.  # noqa: E501
        :type: bool
        """
    ...
    def history_available(self):
        ...
        A boolean, representing whether this pair has historical price data available or not.  # noqa: E501
    ...
    def history_available_dict(self):
        ...
        value = getattr(self, history_available)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def history_available(self, history_available):
        """Sets the history_available of this CryptoPair.

        A boolean, representing whether this pair has historical price data available or not.  # noqa: E501

        :param history_available: The history_available of this CryptoPair.  # noqa: E501
        :type: bool
        """
    ...
    def snapshot_available(self):
        ...
        A boolean, representing whether this pair has snapshot data available or not.  # noqa: E501
    ...
    def snapshot_available_dict(self):
        ...
        value = getattr(self, snapshot_available)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def snapshot_available(self, snapshot_available):
        """Sets the snapshot_available of this CryptoPair.

        A boolean, representing whether this pair has snapshot data available or not.  # noqa: E501

        :param snapshot_available: The snapshot_available of this CryptoPair.  # noqa: E501
        :type: bool
        """
    ...
    def trades_available(self):
        ...
        A boolean, representing whether this pair has trade data available or not.  # noqa: E501
    ...
    def trades_available_dict(self):
        ...
        value = getattr(self, trades_available)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def trades_available(self, trades_available):
        """Sets the trades_available of this CryptoPair.

        A boolean, representing whether this pair has trade data available or not.  # noqa: E501

        :param trades_available: The trades_available of this CryptoPair.  # noqa: E501
        :type: bool
        """
