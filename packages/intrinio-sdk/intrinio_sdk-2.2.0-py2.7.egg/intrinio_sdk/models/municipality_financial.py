...
class MunicipalityFinancial(object):
    ...
    def fiscal_year_dict(self):
        ...
        value = getattr(self, fiscal_year)
    ...
    def current_assets_dict(self):
        ...
        value = getattr(self, current_assets)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def non_current_assets_dict(self):
        ...
        value = getattr(self, non_current_assets)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def deferred_outflows_dict(self):
        ...
        value = getattr(self, deferred_outflows)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_assets_dict(self):
        ...
        value = getattr(self, total_assets)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_assets_plus_deferred_outflows_dict(self):
        ...
        value = getattr(self, total_assets_plus_deferred_outflows)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def current_liabilities_dict(self):
        ...
        value = getattr(self, current_liabilities)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def current_portion_of_long_term_debt_dict(self):
        ...
        value = getattr(self, current_portion_of_long_term_debt)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def net_pension_liability_dict(self):
        ...
        value = getattr(self, net_pension_liability)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def net_opeb_liability_dict(self):
        ...
        value = getattr(self, net_opeb_liability)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def all_other_long_term_debt_dict(self):
        ...
        value = getattr(self, all_other_long_term_debt)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_liabilities_dict(self):
        ...
        value = getattr(self, total_liabilities)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def deferred_inflows_dict(self):
        ...
        value = getattr(self, deferred_inflows)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_liabilities_plus_deferred_inflows_dict(self):
        ...
        value = getattr(self, total_liabilities_plus_deferred_inflows)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_net_position_dict(self):
        ...
        value = getattr(self, total_net_position)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_unrestricted_net_position_dict(self):
        ...
        value = getattr(self, total_unrestricted_net_position)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_expenses_dict(self):
        ...
        value = getattr(self, total_expenses)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def charges_for_services_dict(self):
        ...
        value = getattr(self, charges_for_services)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def operating_grants_and_contributions_dict(self):
        ...
        value = getattr(self, operating_grants_and_contributions)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def capital_grants_and_contributions_dict(self):
        ...
        value = getattr(self, capital_grants_and_contributions)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def general_revenues_dict(self):
        ...
        value = getattr(self, general_revenues)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def other_revenues_dict(self):
        ...
        value = getattr(self, other_revenues)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_revenues_dict(self):
        ...
        value = getattr(self, total_revenues)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def change_in_net_assets_dict(self):
        ...
        value = getattr(self, change_in_net_assets)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def non_spendable_general_fund_balance_dict(self):
        ...
        value = getattr(self, non_spendable_general_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def restricted_general_fund_balance_dict(self):
        ...
        value = getattr(self, restricted_general_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def committed_general_fund_balance_dict(self):
        ...
        value = getattr(self, committed_general_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def unassigned_general_fund_balance_dict(self):
        ...
        value = getattr(self, unassigned_general_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def assigned_general_fund_balance_dict(self):
        ...
        value = getattr(self, assigned_general_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_general_fund_balance_dict(self):
        ...
        value = getattr(self, total_general_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def non_spendable_governmental_fund_balance_dict(self):
        ...
        value = getattr(self, non_spendable_governmental_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def restricted_governmental_fund_balance_dict(self):
        ...
        value = getattr(self, restricted_governmental_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def committed_governmental_fund_balance_dict(self):
        ...
        value = getattr(self, committed_governmental_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def unassigned_governmental_fund_balance_dict(self):
        ...
        value = getattr(self, unassigned_governmental_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def assigned_governmental_fund_balance_dict(self):
        ...
        value = getattr(self, assigned_governmental_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def total_governmental_fund_balance_dict(self):
        ...
        value = getattr(self, total_governmental_fund_balance)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def general_fund_revenues_dict(self):
        ...
        value = getattr(self, general_fund_revenues)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def general_fund_expenditures_dict(self):
        ...
        value = getattr(self, general_fund_expenditures)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def general_fund_revenues_over_under_expenditure_dict(self):
        ...
        value = getattr(self, general_fund_revenues_over_under_expenditure)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def governmental_fund_revenues_dict(self):
        ...
        value = getattr(self, governmental_fund_revenues)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def governmental_fund_expenditures_dict(self):
        ...
        value = getattr(self, governmental_fund_expenditures)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
    ...
    def governmental_fund_revenues_over_under_expenditure_dict(self):
        ...
        value = getattr(self, governmental_fund_revenues_over_under_expenditure)
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
