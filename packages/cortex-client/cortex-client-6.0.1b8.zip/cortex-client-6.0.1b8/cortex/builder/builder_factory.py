...
from .profile_builder import ProfileSchemaBuilder, ProfileBuilder
...
class BuilderFactory:
    ...
    def profile_schema(self, schemaName: str) -> ProfileSchemaBuilder:
        """
        Creates a pipeline with the given name.
        ...
        return ProfileSchemaBuilder(schemaName, profile_client)

    def profile(self, profileId:str, schemaId:str):
        """
        Creates a pipeline with the given name.
        ...
        """
        profile_client = ProfilesClient(self.client._url, 3, self.client._token.token)
        return ProfileBuilder(profileId, schemaId, profile_client)
