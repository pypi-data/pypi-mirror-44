...
from .attributes import ProfileAttributeType, ProfileAttributeTypes
...
class Profile(_Profile):
    ...
    """
    attributes = describableAttrib(
        type=ProfileAttributeType,  # type: ignore
        factory=list,
...
class HistoricProfile(_Profile):
    ...
    """
    attributes = describableAttrib(
        type=HistoricProfileAttribute,  # type: ignore
        factory=list,
