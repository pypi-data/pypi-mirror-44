...
class Widget(QDialog):
  ...
  def set_text(self ):
      self.setWindowTitle(u"Message")
      self.btn_prev.setText( u"上一页")
      self.label_curpage.setText( u"aaa" )
      self.label_pagetotal.setText( u"bbb" )
      self.btn_next.setText( u"下一页" )
      self.btn_send.setText( u"发送" )
  ...
  def on_send(self):
    ...
    print(iamlosing_api("message.send",params))
