...
`This <https://github.com/simonsdave/cloudfeaster/tree/release-0.9.16/docs/story.md>`__
...
-  see
   `these <https://github.com/simonsdave/cloudfeaster/tree/release-0.9.16/docs/contributing.md>`__
   instructions describe how to setup your development environment and
   start contributing to Cloudfeaster
-  `this <https://github.com/simonsdave/cloudfeaster/tree/release-0.9.16/docs/spider_authors.md>`__
...
.. |CircleCI| image:: https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.16.svg?style=svg
   :target: https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.16
