...
#
# Generated Sun Apr  7 22:13:06 2019 by generateDS.py version 2.30.11.
...
#
# Command line:
#   /var/lib/jenkins/jobs/new-init/workspace/opennebula-5.8.1/src/oca/python/bin/generateDS -q -f -o "pyone/bindings/supbind.py" -s "pyone/bindings/__init__.py" --super="supbind" --external-encoding="utf-8" --silence ../../../share/doc/xsd/index.xsd
#
...
class TEMPLATETypeSub(TemplatedType, supermod.TEMPLATEType):
    def __init__(self, VCENTER_DC_NAME=None, VCENTER_DC_REF=None, VCENTER_DS_NAME=None, VCENTER_DS_REF=None, VCENTER_HOST=None, VCENTER_INSTANCE_ID=None, VCENTER_PASSWORD=None, VCENTER_USER=None, anytypeobjs_=None, **kwargs_):
        super(TEMPLATETypeSub, self).__init__(VCENTER_DC_NAME, VCENTER_DC_REF, VCENTER_DS_NAME, VCENTER_DS_REF, VCENTER_HOST, VCENTER_INSTANCE_ID, VCENTER_PASSWORD, VCENTER_USER, anytypeobjs_,  **kwargs_)
