...
def getContactingLabels(lab, labels, areas=False, boundingBoxes=None, centresOfMass=None):  print("spam.label.getContactingLabels(): This function has been renamed to contactingLabels, please update your code"); return
...
def _getLabelledContacts( lab, maximumCoordinationNumber=20 ):  print("spam.label._getLabelledContacts(): This function has been renamed to _labelledContacts, please update your code"); return
...
def getLabelledContacts( lab, maximumCoordinationNumber=20 ): print("spam.label.getLabelledContacts(): This function has been renamed to labelledContacts, please update your code"); return
...
def getContactOrientations(volBin,volLab,watershed="VTK",markerShrink=True): print("spam.label.getContactOrientations(): This function has been renamed to contactOrientations, please update your code"); return
def contactOrientations(volBin,volLab,watershed="VTK",markerShrink=True):
    """
    ...
    if watershed == "VTK":
        ...
        contactVTK = _contactPairs(volLab)
...
def _getContactPairs(lab): print("spam.label._getContactPairs(): This function has been renamed to _contactPairs, please update your code"); return
...
def getContactOrientationsAssembly(volLab,volGrey,contactList,watershed="VTK",boundingBoxes=None,NumberOfThreads=1): print("spam.label.getContactOrientationsAssembly(): This function has been renamed to contactOrientationsAssembly, please update your code"); return
def contactOrientationsAssembly(volLab,volGrey,contactList,watershed="VTK",boundingBoxes=None,NumberOfThreads=1):
    """
