...
def mergeRegularGridAndDiscrete(
    ...
    for n, gridPoint in enumerate(regGrid['fieldCoords'].astype(int)): 
        labelA = labelledA[gridPoint[0], gridPoint[1], gridPoint[2]] 
        labelB = labelledB[gridPoint[0], gridPoint[1], gridPoint[2]] 
        ...
        if ( labelA == 0 and labelB == 0 ) or ( not alwaysLabel and regGrid['SubPixReturnStat'][n] == 2):
            ...
            if labelA != 0:
                output[n,4:7] = spam.DIC.decomposePhi( discreteA['PhiField'][labelA], PhiCentre=discreteA['fieldCoords'][labelA], PhiPoint=gridPoint )['t'] 
                ...
                output[n,4:7] = spam.DIC.decomposePhi( discreteB['PhiField'][labelB], PhiCentre=discreteB['fieldCoords'][labelB], PhiPoint=gridPoint )['t'] 
