...
def go( im1, im2,
    ...
    if Finit is None:
        ...
        F = Finit
        im1def = transformationOperator.applyTransformationOperatorPython( im1, F, interpolationOrder=interpolationOrder )
    ...
    while iterationNumber <= maxIterations and deltaFnorm > minFchange:
        ...
        im1def = transformationOperator.applyTransformationOperator( im1, F, interpolationOrder=interpolationOrder )
    ...
    return { 'transformation': transformationOperator.FtoTransformation( F ),
             'F': F,
