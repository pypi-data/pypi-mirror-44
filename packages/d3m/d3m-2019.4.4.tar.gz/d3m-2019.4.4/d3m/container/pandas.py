...
class DataFrame(pandas.DataFrame):
    ...
    def to_csv(self, path_or_buf: typing.Union[typing.TextIO, str] = None, sep: str = ',', na_rep: str = '',
        ...
        return pandas.DataFrame.to_csv(self, path_or_buf=path_or_buf, sep=sep, na_rep=na_rep, float_format=float_format, columns=columns, header=header, index=index, **kwargs)
    ...
    def select_columns(self: D, columns: typing.Sequence[metadata_base.SimpleSelectorSegment], *, allow_empty_columns: bool = False) -> D:
        ...
        outputs = self.iloc[:, list(columns)]
        outputs.metadata = self.metadata.select_columns(columns, allow_empty_columns=allow_empty_columns)
