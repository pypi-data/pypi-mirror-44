...
def _debug_str(cfg):
    cfg_str_parts = ['Config Parsed: Config('.format(),
        ...
        "version_pattern='{pycalver}'", "pep440_version='{0}'".format(cfg.
        pep440_version), 'commit={0}'.format(cfg.commit), 'tag={0}'.format(
        cfg.tag), 'push={0}'.format(cfg.push), 'file_patterns={']
