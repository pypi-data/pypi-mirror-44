...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codebuild", "0.27.0", __name__, "aws-codebuild@0.27.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CommonCodeBuildActionProps")
class CommonCodeBuildActionProps(jsii.compat.TypedDict, total=False):
    additionalInputArtifacts: typing.List[aws_cdk.aws_codepipeline_api.Artifact]
    additionalOutputArtifactNames: typing.List[str]

class _CommonPipelineBuildActionProps(CommonCodeBuildActionProps, aws_cdk.aws_codepipeline_api.CommonActionProps, jsii.compat.TypedDict, total=False):
    outputArtifactName: str

@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CommonPipelineBuildActionProps")
class CommonPipelineBuildActionProps(_CommonPipelineBuildActionProps):
    inputArtifact: aws_cdk.aws_codepipeline_api.Artifact

class _CommonPipelineTestActionProps(CommonCodeBuildActionProps, aws_cdk.aws_codepipeline_api.CommonActionProps, jsii.compat.TypedDict, total=False):
    outputArtifactName: str

@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.CommonPipelineTestActionProps")
class CommonPipelineTestActionProps(_CommonPipelineTestActionProps):
    inputArtifact: aws_cdk.aws_codepipeline_api.Artifact
...
class GitHubEnterpriseSource(GitBuildSource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.GitHubEnterpriseSource"):
    def __init__(self, *, https_clone_url: str, oauth_token: aws_cdk.cdk.Secret, ignore_ssl_errors: typing.Optional[bool]=None, clone_depth: typing.Optional[jsii.Number]=None, identifier: typing.Optional[str]=None) -> None:
...
class GitHubSource(GitBuildSource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.GitHubSource"):
    def __init__(self, *, oauth_token: aws_cdk.cdk.Secret, owner: str, repo: str, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None, clone_depth: typing.Optional[jsii.Number]=None, identifier: typing.Optional[str]=None) -> None:
...
class IProject(aws_cdk.cdk.IConstruct, aws_cdk.aws_events.IEventRuleTarget, jsii.compat.Protocol):
    @staticmethod
    def __jsii_proxy_class__():
    ...
    def to_code_pipeline_build_action(self, *, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, additional_output_artifact_names: typing.Optional[typing.List[str]]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> "PipelineBuildAction":
        ...

    @jsii.member(jsii_name="toCodePipelineTestAction")
    def to_code_pipeline_test_action(self, *, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, additional_output_artifact_names: typing.Optional[typing.List[str]]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> "PipelineTestAction":
        ...


class _IProjectProxy(jsii.proxy_for(aws_cdk.cdk.IConstruct), jsii.proxy_for(aws_cdk.aws_events.IEventRuleTarget)):
    ...
    @jsii.member(jsii_name="toCodePipelineBuildAction")
    def to_code_pipeline_build_action(self, *, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, additional_output_artifact_names: typing.Optional[typing.List[str]]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> "PipelineBuildAction":
        props: CommonPipelineBuildActionProps = {"inputArtifact": input_artifact, "actionName": action_name}
    ...
    @jsii.member(jsii_name="toCodePipelineTestAction")
    def to_code_pipeline_test_action(self, *, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, additional_output_artifact_names: typing.Optional[typing.List[str]]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> "PipelineTestAction":
        props: CommonPipelineTestActionProps = {"inputArtifact": input_artifact, "actionName": action_name}
...
class PipelineBuildAction(aws_cdk.aws_codepipeline_api.BuildAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.PipelineBuildAction"):
    def __init__(self, *, project: "IProject", input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, additional_output_artifact_names: typing.Optional[typing.List[str]]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> None:
        props: PipelineBuildActionProps = {"project": project, "inputArtifact": input_artifact, "actionName": action_name}
        ...
        jsii.create(PipelineBuildAction, self, [props])

    @jsii.member(jsii_name="additionalOutputArtifact")
    def additional_output_artifact(self, name: str) -> aws_cdk.aws_codepipeline_api.Artifact:
        return jsii.invoke(self, "additionalOutputArtifact", [name])

    @jsii.member(jsii_name="additionalOutputArtifacts")
    def additional_output_artifacts(self) -> typing.List[aws_cdk.aws_codepipeline_api.Artifact]:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.PipelineBuildActionProps")
class PipelineBuildActionProps(CommonPipelineBuildActionProps, jsii.compat.TypedDict):
    project: "IProject"
...
class PipelineTestAction(aws_cdk.aws_codepipeline_api.TestAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.PipelineTestAction"):
    def __init__(self, *, project: "IProject", input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None, additional_input_artifacts: typing.Optional[typing.List[aws_cdk.aws_codepipeline_api.Artifact]]=None, additional_output_artifact_names: typing.Optional[typing.List[str]]=None, action_name: str, run_order: typing.Optional[jsii.Number]=None) -> None:
        props: PipelineTestActionProps = {"project": project, "inputArtifact": input_artifact, "actionName": action_name}
        ...
        jsii.create(PipelineTestAction, self, [props])
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.PipelineTestActionProps")
class PipelineTestActionProps(CommonPipelineTestActionProps, jsii.compat.TypedDict):
    project: "IProject"
...
class PipelineProject(Project, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.PipelineProject"):
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, badge: typing.Optional[bool]=None, build_script_asset: typing.Optional[aws_cdk.assets.Asset]=None, build_script_asset_entrypoint: typing.Optional[str]=None, build_spec: typing.Any=None, cache_bucket: typing.Optional[aws_cdk.aws_s3.IBucket]=None, cache_dir: typing.Optional[str]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IEncryptionKey]=None, environment: typing.Optional["BuildEnvironment"]=None, environment_variables: typing.Optional[typing.Mapping[str,"BuildEnvironmentVariable"]]=None, project_name: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, timeout: typing.Optional[jsii.Number]=None) -> None:
