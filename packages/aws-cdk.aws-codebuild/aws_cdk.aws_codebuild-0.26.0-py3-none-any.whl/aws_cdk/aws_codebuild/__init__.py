...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codebuild", "0.26.0", __name__, "aws-codebuild@0.26.0.jsii.tgz")
...
class GitBuildSource(BuildSource, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-codebuild.GitBuildSource"):
    ...
    def __init__(self, *, clone_depth: typing.Optional[jsii.Number]=None) -> None:
...
class GitHubEnterpriseSource(GitBuildSource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.GitHubEnterpriseSource"):
    def __init__(self, *, https_clone_url: str, oauth_token: aws_cdk.cdk.Secret, ignore_ssl_errors: typing.Optional[bool]=None) -> None:
...
class GitHubSource(GitBuildSource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.GitHubSource"):
    def __init__(self, *, oauth_token: aws_cdk.cdk.Secret, owner: str, repo: str, report_build_status: typing.Optional[bool]=None, webhook: typing.Optional[bool]=None) -> None:
...
class IProject(aws_cdk.cdk.IConstruct, aws_cdk.aws_events.IEventRuleTarget, jsii.compat.Protocol):
    ...
    def to_code_pipeline_build_action(self, *, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None) -> "PipelineBuildAction":
        ...

    @jsii.member(jsii_name="toCodePipelineTestAction")
    def to_code_pipeline_test_action(self, *, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None) -> "PipelineTestAction":
        ...
...
class _IProjectProxy(jsii.proxy_for(aws_cdk.cdk.IConstruct), jsii.proxy_for(aws_cdk.aws_events.IEventRuleTarget)):
    ...
    @jsii.member(jsii_name="toCodePipelineBuildAction")
    def to_code_pipeline_build_action(self, *, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None) -> "PipelineBuildAction":
        props: CommonPipelineBuildActionProps = {"inputArtifact": input_artifact}
    ...
    @jsii.member(jsii_name="toCodePipelineTestAction")
    def to_code_pipeline_test_action(self, *, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, output_artifact_name: typing.Optional[str]=None) -> "PipelineTestAction":
        props: CommonPipelineTestActionProps = {"inputArtifact": input_artifact}
...
class PipelineBuildAction(aws_cdk.aws_codepipeline_api.BuildAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.PipelineBuildAction"):
    def __init__(self, *, project: "IProject") -> None:
        props: PipelineBuildActionProps = {"project": project}
...
class PipelineTestAction(aws_cdk.aws_codepipeline_api.TestAction, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.PipelineTestAction"):
    def __init__(self, *, project: "IProject") -> None:
        props: PipelineTestActionProps = {"project": project}
...
class Project(ProjectBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.Project"):
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, artifacts: typing.Optional["BuildArtifacts"]=None, secondary_artifacts: typing.Optional[typing.List["BuildArtifacts"]]=None, secondary_sources: typing.Optional[typing.List["BuildSource"]]=None, source: typing.Optional["BuildSource"]=None) -> None:
        props: ProjectProps = {}
...
class S3BucketBuildArtifacts(BuildArtifacts, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.S3BucketBuildArtifacts"):
    def __init__(self, *, bucket: aws_cdk.aws_s3.IBucket, name: str, include_build_id: typing.Optional[bool]=None, package_zip: typing.Optional[bool]=None, path: typing.Optional[str]=None) -> None:
...
class S3BucketSource(BuildSource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.S3BucketSource"):
    def __init__(self, *, bucket: aws_cdk.aws_s3.IBucket, path: str) -> None:
