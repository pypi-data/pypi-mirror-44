...
def _REACT( op_amu,op_mex,ot_amu,ot_mex,oo_amu,oo_mex,oor_amu,oor_mex, TKE=21, ExcT=0, theta=10.0 , silent=0 ):
        ...
        if (ExcT>0.0): print("DEBUG excitation=", ExcT,"MeV")
        ...
        if _DEBUG:print("... DEBUG: {}  {}  {}".format(t,t3a,Q) )
...
#		R2dc=tmpr2dc  #put back translation deg2rad.......................
        ...
        if _DEBUG:print("DEBUG:  {}   {}  {}".format(m3,m4, p3cform) )
        if (m3>0):
                p3cform=(p3c**2)/2/m3
        if _DEBUG:print("DEBUG:  {}   {}  {}".format(m3,m4, p3cform) )
        if (m4>0):
...
#                print("----------------------------------")
                ...
                print("        ttr  ={:15.5f} (Threshold in Lab)".format(ttr/1000) )
                print("        ttrc ={:15.5f} (Threshold in CMS == -Q)".format(ttrc/1000) )
                print("        Q    ={:15.5f} (if Q>0 = exoterm  [MeV])".format(Q/1000) )
...
print("i... module  kinematics  is being loaded")
