...
def mount (app):
    ...
    def signin (was, next_url = None, **form):
        ...
        if not (form.get ("username") and form.get ("password")):
            return was.render ("contrib/django/auth/signin.html", next_url = next_url or was.ab (__mntopt__.get ("redirect", 'index')), form = form)
        ...
        if user is not None:
            ...
            return was.redirect (next_url or was.ab (__mntopt__.get ("redirect", 'index')))
    ...
    def signup (was, next_url = None, **form):
        def show_form (msg = None):
            ...
            return was.render ("contrib/django/auth/signup.html", next_url = next_url or was.ab (__mntopt__.get ("redirect", 'index')), form = form)
        ...
        user.is_active = __mntopt__.get ("auto_activate", True)
        user.save ()
        was.app.emit ('user:added', user, form)
        
        if __mntopt__.get ("auto_activate", True):
    ...
    def activate_account (was, t):
        ...
        if not username:
            ...
            return signin (was, was.ab (__mntopt__.get ("redirect", 'index')), username = username)
    ...
    def reset_password (was, t, **form):
        ...
        return signin (was.ab (__mntopt__.get ("redirect", 'index')), **{"username": username, "password":  form ["password"]})
