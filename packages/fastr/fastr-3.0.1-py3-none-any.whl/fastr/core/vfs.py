...
class VirtualFileSystem:
    ...
    def put_url(self, inpath, outurl):
        ...
        try:
            ...
            # sometimes a race condition causes above os.makedirs to error out because the directory is created by a
            # different process between the if-condition and os.makedirs
            # we want to ignore that specific error condition
