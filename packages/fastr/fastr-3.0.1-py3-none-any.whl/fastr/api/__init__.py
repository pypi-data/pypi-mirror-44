...
class Input(BaseWrapper):
    ...
    def append(self, value: LinkSourceType) -> Link:
        ...
        """
        return self.parent.append(value)
...
class Network(BaseWrapper):
    ...
    def create_node(self,
        ...
        :param nodegroup: The group the node belongs to, this can be
    ...
    def draw(self,
             ...
             expand_macros: Union[bool, int] = 1) -> Optional[str]:
        """
