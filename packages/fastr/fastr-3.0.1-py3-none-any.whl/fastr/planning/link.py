...
class Link(HasDimensions, Updateable, Serializable):
    ...
    def __init__(self,
        ...
        :type target: :py:class:`BaseInput <fastr.planning.inputoutput.BaseOutput>`
    ...
    def cardinality(self, index: Optional[SampleIndex]=None) -> Union[int, sympy.symbol.Symbol]:
        """
