...
from ..core.cardinality import create_cardinality, IntCardinalitySpec,\
                               AsCardinalitySpec, ValueCardinalitySpec, AnyCardinalitySpec
...
class Input(BaseInput):
    ...
    def __getitem__(self, key: Union[int, str]) -> 'SubInput':
        """
    ...
    def remove(self, value: 'SubInput'):
        """
    ...
    def remove(self, value):
        ...
        :param value: the :py:class:`SubInput <fastr.planning.inputoutput.SubInput>`
                      or :py:class:`SubLink <fastr.planning.link.Link>`
                      to removed from this Input
