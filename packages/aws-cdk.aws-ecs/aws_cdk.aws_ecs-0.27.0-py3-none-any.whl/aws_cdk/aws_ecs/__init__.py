...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ecs", "0.27.0", __name__, "aws-ecs@0.27.0.jsii.tgz")
...
class Ec2Service(BaseService, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ecs.Ec2Service"):
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, cluster: "ICluster", task_definition: "TaskDefinition", daemon: typing.Optional[bool]=None, place_on_distinct_instances: typing.Optional[bool]=None, security_group: typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]=None, vpc_subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, desired_count: typing.Optional[jsii.Number]=None, health_check_grace_period_seconds: typing.Optional[jsii.Number]=None, maximum_percent: typing.Optional[jsii.Number]=None, minimum_healthy_percent: typing.Optional[jsii.Number]=None, service_name: typing.Optional[str]=None) -> None:
...
class FargateService(BaseService, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ecs.FargateService"):
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, cluster: "ICluster", task_definition: "TaskDefinition", assign_public_ip: typing.Optional[bool]=None, platform_version: typing.Optional["FargatePlatformVersion"]=None, security_group: typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]=None, vpc_subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, desired_count: typing.Optional[jsii.Number]=None, health_check_grace_period_seconds: typing.Optional[jsii.Number]=None, maximum_percent: typing.Optional[jsii.Number]=None, minimum_healthy_percent: typing.Optional[jsii.Number]=None, service_name: typing.Optional[str]=None) -> None:
