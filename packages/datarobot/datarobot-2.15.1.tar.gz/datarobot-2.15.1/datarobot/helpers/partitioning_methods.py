...
class FeatureSettings(object):
    ...
    """
    def __init__(self, feature_name, known_in_advance=False):
    ...
    @classmethod
    def from_server_data(cls, feature_name, known_in_advance=False):
        return cls(feature_name, known_in_advance=known_in_advance)
