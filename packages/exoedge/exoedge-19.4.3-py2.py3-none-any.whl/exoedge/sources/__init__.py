...
class ExoEdgeClassicSource(object):
    ...
    def start_source(self):
        positionals = positionals = self.channel.\
                          protocol_config.\
                              app_specific_config.get('positionals'), # pylint: disable=E1101
        parameters = self.channel.\
                         protocol_config.\
                             app_specific_config.get('parameters') # pylint: disable=E1101
        LOG.warning(
...
class ExoEdgeSource(StoppableThread):
    ...
    def get_configured_applications(self):
        ...
        """
        if self.config_applications_thread:
