...
branches = []
for index, branch in enumerate(sheetdata['algeriev2_branch_data_critinfo_'][1:]):
  try:
    if branch == []:
...
for payload in branches:
    data = payload 
    headers = {'Authorization':'DirectLogin token="eyJhbGciOiJIUzI1NiJ9.eyIiOiIifQ.C3nh3YC7kjBCVIktf5Ruup3eCtk8TbZFa2ATIWWXqDY'}
