...
The sources for @environment can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/eghuro/atenvironment
.. _tarball: https://github.com/eghuro/atenvironment/tarball/master
