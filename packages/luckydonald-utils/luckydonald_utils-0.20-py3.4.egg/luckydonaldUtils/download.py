...
def download_file(url, used_cached=True, download_folder=None, temp_folder_name="luckydonald-utils", return_mime=False, return_buffer=False, progress_bar=False, **requests_kwargs):
	...
	If None, a static_files_dir will be created inside the /tmp/ static_files_dir equivalent of your system, with the name from `temp_folder_name`.

	:param temp_folder_name:
	Name of the static_files_dir to be created/used in the /tmp/ equivalent of your system.
