...
if py3:
	try:
		...
		raise  # try-except is only needed to satisfy PyCharm; to not mark that as wrong import.
else:
...
class BetterHTTPRequestHandler(SimpleHTTPRequestHandler, object):
	...
	def translate_path(self, path_):
		...
		E.g. "/path/to/www-dir/foo.png" is valid if that static_files_dir exists.
