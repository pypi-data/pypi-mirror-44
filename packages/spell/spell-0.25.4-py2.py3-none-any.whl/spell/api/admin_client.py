...
class AdminClient(base_client.BaseClient):
    ...
    def create_gcp_cluster(self, cluster_name, org_name, storage_uri, bastion_key, service_account_id, vpc_id,
                           subnets, region, project, zone):
        """Create a new gpc cluster for an org
