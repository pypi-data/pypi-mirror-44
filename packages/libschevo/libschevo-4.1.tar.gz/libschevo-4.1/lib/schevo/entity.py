...
class EntityMeta(type):
    ...
    # allow pickle protocol to work properly
    ...
    def __new__(cls, class_name, bases, class_dict):
        ...
        #    #class_dict['__getstate__'] = bases[0].__getstate__ #
    ...
    def setup_fields(cls):
        fget_fields = []
        for field_name, FieldClass in cls._field_spec.items():
...
class Entity(base.Entity, LabelMixin):
    ...
    def __str__(self):
        #return type.__str__(self).encode('utf8')
