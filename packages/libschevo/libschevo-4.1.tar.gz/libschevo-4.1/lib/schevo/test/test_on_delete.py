...
class BaseOnDeleteEntityListRemove(CreatesSchema):
    ...
    def test_sample_data(self):
        bar1 = db.Bar.findone(name='bar 1')
        bar2 = db.Bar.findone(name='bar 2')
        foo1 = db.Foo.findone(name='foo 1')
    ...
    def test_remove_min_zero(self):
        bar3 = db.Bar.findone(name='bar 3')
        fob1 = db.Fob.findone(name='fob 1')
