...
class BaseSchema(CreatesSchema):
    ...
    def test_entity_definition(self):
        d = db.schema
        Person = d.E.Person
        assert list(Person._field_spec.keys()) == [
            'first_name',
            'last_name',
            'maiden_name',
            'alias',
    ...
    def test_subclassing(self):
        d = db.schema
        _Base = d.E._Base
        assert list(_Base._field_spec.keys()) == [
            'name',
            ]
        Derived = d.E.Derived
        assert list(Derived._field_spec.keys()) == [
            'name',
            'age',
            ]
    ...
    def test_field_definition(self):
        d = db.schema
        Animal = d.E['Animal']
        assert list(Animal._field_spec.keys()) == ['name', 'wild']
