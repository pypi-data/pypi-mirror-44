...
from schevo.gtk2.action import (
    get_method_action, get_relationship_actions,
    get_tx_actions, get_tx_selectionmethod_actions,
    get_view_action, get_view_actions)
from schevo.gtk2 import grid
from schevo.gtk2 import icon
from schevo.gtk2.utils import gsignal, type_register

import gobject
import gtk

from schevo.gtk2.grid import OBJECT_COLUMN
...
class EntityGrid(grid.Grid):
    ...
    def _get_columns_for_field_spec(self, field_spec):
        ...
        if '_rev' not in self._hidden:
            ...
            columns.append(column)
        for field_name, FieldClass in list(field_spec.items()):
