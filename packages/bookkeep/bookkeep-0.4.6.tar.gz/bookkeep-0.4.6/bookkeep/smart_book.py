    ...
    **Examples**
    ...
    def _checkbounds(cls, key, value, units, bounds,
        ...
        **Example**
        ...
        lb, ub = bounds
        try:
            within_bounds = (lb <= value).all() and (ub >= value).all()
    ...
    def nested_keys(self):
        ...
        self._nested_keys([self], isinstance)
        
    def _nested_keys(self, prev, inst):
        for key, val in self.items():
            if inst(val, SmartBook):
                if val:
                    if val in prev: yield ...
                    else:
                        prev.append(val)
    ...
    def nested_values(self):
        ...
        self._nested_values([self], isinstance)
    ...
    def nested_items(self):
        ...
        self._nested_items([self], isinstance)
