...
class my_logging():
	'''Une classe pour gérer mes loggings
		...
		Usage :
			...
			log.debug("hello")
	'''
	def __init__(self, console_level = None, name_logfile = None, logfile_level = None, email_level = None, log_name = None, max_file_size = 10000000, details = False):
		'''Création des handler pour console et fichier
			...
			- max_file_size		:	maximum size for the log file (defaut is 10 Mo)
		'''
	...
	def add_file_handler(self, name_logfile, logfile_level):
		...
		self.file_handler = RotatingFileHandler(name_logfile, 'a', self.max_file_size, 1)
