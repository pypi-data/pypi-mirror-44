...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/app-delivery", "0.26.0", __name__, "app-delivery@0.26.0.jsii.tgz")
class PipelineDeployStackAction(aws_cdk.cdk.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/app-delivery.PipelineDeployStackAction"):
    def __init__(self, scope: aws_cdk.cdk.Construct, id: str, *, admin_permissions: bool, input_artifact: aws_cdk.aws_codepipeline_api.Artifact, stack: aws_cdk.cdk.Stack, stage: aws_cdk.aws_codepipeline_api.IStage, capabilities: typing.Optional[aws_cdk.aws_cloudformation.CloudFormationCapabilities]=None, change_set_name: typing.Optional[str]=None, create_change_set_run_order: typing.Optional[jsii.Number]=None, execute_change_set_run_order: typing.Optional[jsii.Number]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None) -> None:
...
class PipelineDeployStackActionProps(_PipelineDeployStackActionProps):
    ...
    stage: aws_cdk.aws_codepipeline_api.IStage
