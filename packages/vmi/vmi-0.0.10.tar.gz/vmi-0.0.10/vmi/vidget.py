...
class Widget(Mouse, QGLWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.menu = QMenu(self.tr('Window'))
        self.menu.addAction(self.tr('Fit content')).triggered.connect(self.resetCamera)
