...
class OfferManagementApi(object):
    ...
    def change_publication_status_using_put(self, command_id, publication_change_command_dto, **kwargs):  # noqa: E501
        ...
        Use this resource to modify multiple offers publication at once. More information about this resource you can find <a href=\"../../sale/#step-8-offer-publication-commands\" target=\"_blank\">here</a>.  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.change_publication_status_using_put_with_http_info(command_id, publication_change_command_dto, **kwargs)  # noqa: E501
            return data
    ...
    def change_publication_status_using_put_with_http_info(self, command_id, publication_change_command_dto, **kwargs):  # noqa: E501
        ...
        if ('command_id' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `command_id` when calling `change_publication_status_using_put`")  # noqa: E501
        # verify the required parameter 'publication_change_command_dto' is set
        if ('publication_change_command_dto' not in local_var_params or
                local_var_params['publication_change_command_dto'] is None):
            raise ValueError("Missing the required parameter `publication_change_command_dto` when calling `change_publication_status_using_put`")  # noqa: E501
    ...
    def create_change_price_command_using_put(self, offer_id, command_id, change_price_without_output, **kwargs):  # noqa: E501
        ...
        Use this resource to change the Buy Now price in a single offer. More information about this resource you can find <a href=\"../../news/2016-08-01-zmiana-ceny/\" target=\"_blank\">here</a>.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str command_id: Universally Unique  Identifier (UUID) you generate to enforce idempotency. UUID specification: http://www.ietf.org/rfc/rfc4122.txt (required)
        :param ChangePriceWithoutOutput change_price_without_output: Command input data. Note that the amount field must be transferred as a string to avoid rounding errors. A currency must be provided as a 3-letter code as defined in ISO 4217. (https://en.wikipedia.org/wiki/ISO_4217#Active_codes) (required)
        :return: ChangePrice
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_change_price_command_using_put_with_http_info(offer_id, command_id, change_price_without_output, **kwargs)  # noqa: E501
            return data
    ...
    def create_change_price_command_using_put_with_http_info(self, offer_id, command_id, change_price_without_output, **kwargs):  # noqa: E501
        ...
        if ('offer_id' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `offer_id` when calling `create_change_price_command_using_put`")  # noqa: E501
        # verify the required parameter 'command_id' is set
        if ('command_id' not in local_var_params or
                local_var_params['command_id'] is None):
            raise ValueError("Missing the required parameter `command_id` when calling `create_change_price_command_using_put`")  # noqa: E501
        # verify the required parameter 'change_price_without_output' is set
        if ('change_price_without_output' not in local_var_params or
                local_var_params['change_price_without_output'] is None):
            raise ValueError("Missing the required parameter `change_price_without_output` when calling `create_change_price_command_using_put`")  # noqa: E501
    ...
    def create_offer_using_post(self, offer, **kwargs):  # noqa: E501
        ...
        Use this resource to create a draft offer. More information about this resource you can find <a href=\"../../sale/#step-6-draft\" target=\"_blank\">here</a>.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def create_offer_using_post_with_http_info(self, offer, **kwargs):  # noqa: E501
        ...
        if ('offer' not in local_var_params or
                local_var_params['offer'] is None):
    ...
    def delete_offer_using_delete(self, offer_id, **kwargs):  # noqa: E501
        ...
        Use this resource to delete a draft offer. More information about this resource you can find <a href=\"../../news/2018-10-09_draft_delete/\" target=\"_blank\">here</a>.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_offer_using_delete_with_http_info(offer_id, **kwargs)  # noqa: E501
            return data
    ...
    def delete_offer_using_delete_with_http_info(self, offer_id, **kwargs):  # noqa: E501
        ...
        if ('offer_id' not in local_var_params or
                local_var_params['offer_id'] is None):
            raise ValueError("Missing the required parameter `offer_id` when calling `delete_offer_using_delete`")  # noqa: E501
    ...
    def get_publication_report_using_get(self, command_id, **kwargs):  # noqa: E501
        ...
        Use this resource to retrieve information about the offer listing statuses. You will receive a summary with a number of correctly listed offers and errors. More information about this resource you can find <a href=\"../../sale/#step-8-offer-publication-commands\" target=\"_blank\">here</a>.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_publication_report_using_get_with_http_info(command_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_publication_report_using_get_with_http_info(self, command_id, **kwargs):  # noqa: E501
        ...
        if ('command_id' not in local_var_params or
                local_var_params['command_id'] is None):
            raise ValueError("Missing the required parameter `command_id` when calling `get_publication_report_using_get`")  # noqa: E501
    ...
    def get_publication_tasks_using_get(self, command_id, **kwargs):  # noqa: E501
        ...
        Use this resource to retrieve information about the offer statuses on the site (Defaults: limit = 100, offset = 0). More information about this resource you can find <a href=\"../../sale/#step-8-offer-publication-commands\" target=\"_blank\">here</a>.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_publication_tasks_using_get_with_http_info(command_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_publication_tasks_using_get_with_http_info(self, command_id, **kwargs):  # noqa: E501
        ...
        if ('command_id' not in local_var_params or
                local_var_params['command_id'] is None):
            raise ValueError("Missing the required parameter `command_id` when calling `get_publication_tasks_using_get`")  # noqa: E501
    ...
    def update_offer_using_put(self, offer_id, offer, **kwargs):  # noqa: E501
        ...
        Use this resource to complete a draft offer or edit ongoing offers. More information about this resource you can find <a href=\"../../sale/#step-7-complete\" target=\"_blank\">here</a>.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_offer_using_put_with_http_info(offer_id, offer, **kwargs)  # noqa: E501
            return data
    ...
    def update_offer_using_put_with_http_info(self, offer_id, offer, **kwargs):  # noqa: E501
        ...
        if ('offer_id' not in local_var_params or
                local_var_params['offer_id'] is None):
            raise ValueError("Missing the required parameter `offer_id` when calling `update_offer_using_put`")  # noqa: E501
        # verify the required parameter 'offer' is set
        if ('offer' not in local_var_params or
                local_var_params['offer'] is None):
