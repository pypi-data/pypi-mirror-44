...
class ListingResponse(object):
    ...
    def __init__(self, items=None, categories=None, filters=None, search_meta=None, sort=None):  # noqa: E501
    ...
    def filters(self):
        ...
        Filters with counters available for given search, which can be used to refine search results.  # noqa: E501
