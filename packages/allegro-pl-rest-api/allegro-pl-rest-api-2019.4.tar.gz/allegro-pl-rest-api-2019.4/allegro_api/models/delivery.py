...
class Delivery(object):
    ...
    def __init__(self, additional_info=None, handling_time=None, shipment_date=None, shipping_rates=None):  # noqa: E501
    ...
    def additional_info(self, additional_info):
        ...
        :type: str
        """
        if additional_info is not None and len(additional_info) > 650:
