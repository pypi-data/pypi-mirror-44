...
class AverageRates(object):
    ...
    def delivery(self):
        ...
        Average value of delivery rate  # noqa: E501
    ...
    def delivery(self, delivery):
        ...
        :type: float
        """
        if delivery is not None and delivery > 5:  # noqa: E501
    ...
    def delivery_cost(self):
        ...
        Average value of delivery cost rate  # noqa: E501
    ...
    def delivery_cost(self, delivery_cost):
        ...
        :type: float
        """
        if delivery_cost is not None and delivery_cost > 5:  # noqa: E501
            raise ValueError("Invalid value for `delivery_cost`, must be a value less than or equal to `5`")  # noqa: E501
        if delivery_cost is not None and delivery_cost < 0:  # noqa: E501
    ...
    def description(self):
        ...
        Average value of description rate  # noqa: E501
    ...
    def description(self, description):
        ...
        :type: float
        """
        if description is not None and description > 5:  # noqa: E501
            raise ValueError("Invalid value for `description`, must be a value less than or equal to `5`")  # noqa: E501
        if description is not None and description < 0:  # noqa: E501
    ...
    def service(self):
        ...
        Average value of service rate  # noqa: E501
    ...
    def service(self, service):
        ...
        :type: float
        """
        if service is not None and service > 5:  # noqa: E501
            raise ValueError("Invalid value for `service`, must be a value less than or equal to `5`")  # noqa: E501
        if service is not None and service < 0:  # noqa: E501
