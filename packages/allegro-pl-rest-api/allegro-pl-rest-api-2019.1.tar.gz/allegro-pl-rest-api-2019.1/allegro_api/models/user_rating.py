...
class UserRating(object):
    ...
    def __init__(self, answer=None, buyer=None, comment=None, created_at=None, excluded_from_average_rates=None, id=None, order=None, rates=None, recommended=None, removal=None):  # noqa: E501
