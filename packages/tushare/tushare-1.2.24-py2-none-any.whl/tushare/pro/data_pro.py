...
def pro_bar(ts_code='', pro_api=None, start_date='', end_date='', freq='D', asset='E', 
           exchange='',
           adj = None,
           ma = [],
           factors = None,
    ...
    api = pro_api if pro_api is not None else get_api()
    for _ in range(retry_count):
        try:
            if asset == 'E':
                ...
                if 'min' in freq:
                    df = api.mins(ts_code=ts_code, start_time=start_date, end_time=end_date, freq=freq)
                    df['trade_date'] = df['trade_time'].map(lambda x: x.replace('-', '')[0:8])
...
#     upass.set_token('your token here')
    pro = get_api()
#     print(pro_bar(ts_code='000001.SZ', pro_api=pro, start_date='20180101', end_date='20181101', factors=['tor', 'vr']))
#     print(pro_bar(ts_code='000001.SH', pro_api=pro, start_date='19990101', end_date='', asset='I', freq='w', ma=[5, 10, 15]))
...
#     print(pro_bar(ts_code='btcusdt', pro_api=pro, exchange='huobi', freq='15MIN', start_date='20180101', end_date='20191123', asset='C', ma=[5, 10]))
#     df = pro_bar(ts_code='300510.SZ', pro_api=pro, adj='', start_date='20180601', end_date='20181205', freq='60min')
#     df = pro_bar(ts_code='300510.SZ', pro_api=pro, adj='qfq', start_date='20100601', end_date='20181205', freq='60min', ma=[5, 10, 20])
...
#     df = pro_bar(pro_api=pro, ts_code='000550.SZ', adj='qfq', start_date='20180120', end_date='20190213')
#     df = pro_bar(pro_api=pro, ts_code='CU1811.SHF', asset='FT', start_date='20180101', end_date='20181011')
#     print(df)
