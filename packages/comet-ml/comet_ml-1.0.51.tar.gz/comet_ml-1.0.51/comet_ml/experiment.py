...
class BaseExperiment(object):
    ...
    def log_asset_data(self, data, file_name=None, overwrite=False):
        ...
        if fp is not None:
            return self.log_asset(
                file_like_object=fp, file_name=file_name, overwrite=overwrite
            )
    ...
    def log_asset_folder(self, folder):
        ...
        for file_name in file_names:
            ...
            if os.path.isfile(file_path):
                asset_url = self.log_asset(file_path=file_path)
    ...
    def log_asset(
        ...
        ## Now we figure out what file_path is:
        copy_to_tmp = True
    ...
    def log_image(
        ...
        try:
            file_path, copy_to_tmp = image_data_to_file_path(
                image_data,
                name,
                image_format,
                image_scale,
        ...
        self._file_upload(
            file_path, "visualization", url_params, copy_to_tmp=copy_to_tmp
        )
