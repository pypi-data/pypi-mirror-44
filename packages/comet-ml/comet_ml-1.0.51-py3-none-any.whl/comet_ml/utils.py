...
def image_data_to_file_path(
    ...
    if hasattr(image_data, "numpy"):  ## pytorch tensor
        ...
        file_path = write_file_like_to_tmp_file(fp)
        copy_to_tmp = False
        ...
        file_path = write_file_like_to_tmp_file(image_data)
        copy_to_tmp = False
        ...
        file_path = write_file_like_to_tmp_file(fp)
        copy_to_tmp = False
    elif isinstance(image_data, str):  ## file name
...
def array_to_image_fp(
    ...
    if image_shape is not None:
        try:
            ...
            LOGGER.info("WARNING: invalid image_shape; ignored")
    ...
    if image_colormap is not None:
        ...
        try:
            ...
            LOGGER.info("WARNING: invalid image_colormap; ignored")
        ## rescale again:
