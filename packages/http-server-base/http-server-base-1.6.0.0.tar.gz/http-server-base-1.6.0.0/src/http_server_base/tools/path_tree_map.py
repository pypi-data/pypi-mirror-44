...
from typing import Any, Dict, Union, TypeVar, Optional, List, Iterable, Tuple, Iterator, TextIO, Mapping
...
class PathTreeMap(UserDict, DataType):
    separator: str
    ...
    def get(self, key: str, default: T = _DEFAULT_ARGUMENT, **kwargs) -> T:
        try:
