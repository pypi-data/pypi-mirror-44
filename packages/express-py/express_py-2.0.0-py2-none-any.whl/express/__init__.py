...
if __name__ == "__main__":
    ...
    work_dir = "/Users/exabyte/exabyte-stack/band-structure-hse-final-mm-nJfrrAtMN3mFMK3mh"
    stdout_file = "{}/bands.out".format(work_dir)
    exp = ExPrESS(parser, **dict({"work_dir": work_dir, "stdout_file": stdout_file}))
    print(json.dumps(exp.property(property_name, **{"remove_non_zero_weight_kpoints": True}), indent=4))
