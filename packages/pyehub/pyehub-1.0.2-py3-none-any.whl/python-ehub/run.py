...
from outputter import pretty_print, output_excel, print_capacities, print_section, print_error, stream_info
...
def main():
    ...
    if settings['carbon']:
        model = CarbonEHubModel(excel=settings['input_file'], max_carbon=settings['max_carbon'])
    else:
