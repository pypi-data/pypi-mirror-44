...
''' 
    Work in progress... See also extract_annotations() in pynml.py

def get_properties_from_annotation(element):

        print element
        print element.annotation
        print dir(element.annotation)
        print element.annotation.anytypeobjs_
        print element.annotation.member_data_items_[0]
        print element.annotation.member_data_items_[0].name
        print dir(element.annotation.member_data_items_[0])
        print element.annotation.hasContent_()
        
        for prop in element.annotation.anytypeobjs_:
            print '-----'
            print prop
