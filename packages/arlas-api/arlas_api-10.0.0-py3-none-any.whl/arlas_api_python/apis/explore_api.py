...
class ExploreApi(object):
    ...
    def geosearch_with_http_info(self, collection, **kwargs):
        ...
        all_params = ['collection', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'pretty', 'flat', 'include', 'exclude', 'size', '_from', 'sort', 'after', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def tiledgeosearch_with_http_info(self, collection, x, y, z, **kwargs):
        ...
        all_params = ['collection', 'x', 'y', 'z', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'pretty', 'flat', 'include', 'exclude', 'size', '_from', 'sort', 'after', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def tiledgeosearch1_with_http_info(self, collection, x, y, z, **kwargs):
        ...
        all_params = ['collection', 'x', 'y', 'z', 'f', 'q', 'pwithin', 'gwithin', 'gintersect', 'notpwithin', 'notgwithin', 'notgintersect', 'dateformat', 'size', '_from', 'sort', 'after', 'sampling', 'coverage', 'max_age_cache']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
