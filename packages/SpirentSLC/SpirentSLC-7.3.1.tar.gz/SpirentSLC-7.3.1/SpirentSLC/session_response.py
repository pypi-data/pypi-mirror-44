...
class SessionActionResponse(object):
    ...
    def steps_report(self):
        def step_report(msg, ns=True):
            ...
            return str.format(step_name, nd.stepId, nd.action.action, msg.duration, nd.action.command, msg.details.body)
        ...
        res = step_report(self.message, False) + traverse_tree(self)
        return res
