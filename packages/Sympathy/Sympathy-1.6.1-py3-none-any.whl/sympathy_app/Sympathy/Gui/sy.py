...
import Gui.application.start
import Gui.settings
from Gui.log import setup_loglevel
from sympathy.platform import arg_parser


APPLICATION_DIR = os.environ['SY_APPLICATION_DIR']
SY_PYTHON_SUPPORT = os.environ['SY_PYTHON_SUPPORT']
...
def execute_sympathy(sympathy_app):
    ...
    if sympathy_app == 'syg':
        return Gui.application.start.start_gui_application(args, sys.argv)
    elif sympathy_app == 'sy':
        return Gui.application.start.start_cli_application(args, sys.argv)
