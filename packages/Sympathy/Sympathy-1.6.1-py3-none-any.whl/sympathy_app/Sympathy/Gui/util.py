...
def create_session_folder():
    ...
    os.environ['SY_TEMP'] = nativepath(temp_folder)
    try:
...
def create_install_folder():
    install_folder = os.environ['SY_APPLICATION_DIR']
...
def library_conflicts(libraries,
    ...
    packages = [sympathy.utils.library_info.library_package(lib)
    ...
    for lib in old_libraries:
        package = sympathy.utils.library_info.library_package(lib)
