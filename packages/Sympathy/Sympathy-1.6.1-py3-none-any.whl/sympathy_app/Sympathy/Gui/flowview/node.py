...
class NodeView(BaseNodeView):
    ...
    def _init_context_menu(self):
        ...
        if ports_menu and input_defs:
            ...
            self._input_menu_add = input_menu.addMenu('Create')
            self._input_menu_rem = input_menu.addMenu('Remove')
            ...
            for i, def_ in enumerate(input_defs):
                ...
                action = QtWidgets.QAction(def_['description'], self)
        ...
        if ports_menu and output_defs:
            ...
            self._output_menu_add = output_menu.addMenu('Create')
            self._output_menu_rem = output_menu.addMenu('Remove')
    ...
    def _edit_node_requested(self):
        ...
        if True:  # settings.instance()['Gui/system_editor']:
