...
class ErrorView(QtWidgets.QTreeWidget):
    ...
    def _get_item(self, parent, messages):
        ...
        label = QtWidgets.QTextEdit(parent=self)
        ...
        item = QtWidgets.QTreeWidgetItem(parent, [messages[0], ''])
    ...
    def add_node_output_message(self, full_uuid, output):
        ...
        for key, (brief, details) in levels.items():
            parent = QtWidgets.QTreeWidgetItem(None, [name, brief])
