...
project = u'Sympathy'
copyright = u'2013-%s, <a href="http://www.sysess.org/">SysESS</a>. All Rights Reserved' % time.strftime('%Y')
...
:Author: `System Engineering Software Society (SysESS) <http://www.sysess.org/>`_
        ...
        with open(uri_to_path(node_filename)) as node_file:
            try:
                ...
                if type_ == 'flow':
                    ...
                    if parameters and '*Configuration*:\n' not in doc:
