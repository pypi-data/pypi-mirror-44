...
class Service(object):
    def __init__(self, name, node_role, alarmed=None, alarmed_at=None,
        ...
        self.alarmed_at = alarmed_at if alarmed_at else None
        self.restarted = restarted if restarted else False
        self.restarted_at = restarted_at if restarted_at else None
        self.is_necessary = is_necessary if is_necessary else None
        self.status = status if status else ServiceStatus.INITIALIZING
