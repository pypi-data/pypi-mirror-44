...
class MetadataManager(Manager):
    ...
    def __init__(self,
        ...
        super(MetadataManager, self).__init__(name=name,
                                              hostname=hostname,
        ...
        self.messages = dict()
        self.messages['building'] = BuildingMessages(self.logger,
                                                     protocol_version)
        self.messages['application'] = ApplicationConfigurationMessages(self.logger,
                                                                        protocol_version)
        self.messages['area'] = AreaMessages(self.logger,
                                             protocol_version)
        self.messages['floorplan'] = FloorPlanMessages(self.logger,
                                                       protocol_version)
        self.messages['building'] = BuildingMessages(self.logger,
                                                     protocol_version)
        self.messages['network'] = NetworkMessages(self.logger,
                                                   protocol_version)
        self.messages['node'] = NodeMessages(self.logger,
                                             protocol_version)
