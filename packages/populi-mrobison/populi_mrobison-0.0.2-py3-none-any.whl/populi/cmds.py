...
def add_address(
    ...
    :param primary: Boolean. Use if you want to mark the address as primary or not primary. e.g. 1 or 0
    :param public: Boolean. Use if you want to mark the address as public or not public. e.g. 1 or 0
...
def add_application_note(
    ...
    :param public: Boolean. e.g. 1 or 0 (the default is 0).
    :returns: String containing xml or an lxml element.
    """
...
def add_course_instance_assignment(
    ...
    :param extra_credit: Boolean. e.g. 1 or 0 (the default is 0).
    ...
    :param proctored: Boolean. e.g. 1 or 0 (the default is 0).
    ...
    :param peer_grade: Boolean. e.g. 1 or 0 (the default is 0).
    ...
    :param anonymous_reviews: Boolean. e.g. 1 or 0 (the default is 0).
    ...
    :param allow_review_comments: Boolean. e.g. 1 or 0. Only used when review_visibility is not NEVER (the default is 0).
...
def add_email_address(
    ...
    :param primary: Boolean. Use if you want to mark the email address as primary or not primary. e.g. 1 or 0
    :param public: Boolean. Use if you want to mark the email address as public or not public. e.g. 1 or 0
    :returns: String containing xml or an lxml element.
    """
...
def add_inquiry(
    ...
    :param create_response: Create a response thread and/or email a thank you message on create? Boolean. Defaults to false.
...
def add_payment(
    ...
    :param automatically_apply_to_invoices: Boolean. Pass in 1 if you want the payment to automatically apply to invoices. Defaults to 0.
...
def add_phone_number(
    ...
    :param primary: Boolean. Use if you want to mark the phone number as primary or not primary. e.g. 1 or 0
    :param public: Boolean. Use if you want to mark the phone number as public or not public. e.g. 1 or 0
    :returns: String containing xml or an lxml element.
    """
...
def add_user(
    ...
    :param send_welcome_email: Boolean. Send a welcome email to the person's primary email address. If this is not passed in the default is true.
    :returns: String containing xml or an lxml element.
    """
...
def create_course_instance_meeting(
    ...
    :param counts_toward_attendance_hours: Boolean. e.g. 1 or 0
    :param counts_toward_clinical_hours: Boolean. e.g. 1 or 0
...
def get_application_templates(show_online_only: str = None):
    ...
    :param show_online_only: Boolean. Default false. If true only application templates that are set to show online will be returned.
    :returns: String containing xml or an lxml element.
    """
...
def get_news(limit: str = None, offset: str = None):
    """
    Returns the Populi news feed, ordered most recent to least recent (with pinned articles at the top).

    :param limit: The maximim number of articles you'd like returned (defaults to 50).
    :param offset: If a limit is specified, you can also specify an offset.
    :returns: String containing xml or an lxml element.
    """

    return get_anonymous('getNews', limit=limit, offset=offset)
...
def get_person(person_id: str = None, return_image_data: str = None):
    ...
    :param person_id: The numeric ID of the person.
    :param return_image_data: Boolean (e.g. 1 or 0). Returning binary image data will result in slower response times. Defaults to 0.
    :returns: String containing xml or an lxml element.
    """
...
def get_term_course_instances(term_id: str = None):
    """
    ...
    return get_anonymous('getTermCourseInstances', term_id=term_id)
...
def get_todos(completed: str = None, limit: str = None):
    """
    ...
    :param limit: The maximum number of todos you'd like returned.
    :returns: String containing xml or an lxml element.
    """
...
def get_transcript(
    ...
    :param person_id: The numeric ID of the person you're interested in.
    :param pdf: Boolean. If set to true, pdf content will be returned instead of xml.
    ...
    :param official: (Requires the "pdf" parameter to be set to true) Boolean. If set to true, the official transcript pdf content will be returned.
    :param recipient: (Requires the "pdf" parameter to be set to true) String. The recipient who will be receiving this transcript.
    :param include_course_desciptions: (Requires the "pdf" parameter to be set to true) Boolean. If set to true, course descriptions will be returned in the pdf content. Note: course descriptions will always be returned in the xml. The parameter has no effect on custom layouts.
    :returns: String containing xml or an lxml element.
    """
...
def get_updated_people(start_time: str = None):
    """
    ...
    return get_anonymous('getUpdatedPeople', start_time=start_time)
...
def search_people(search_term: str = None, limit: str = None):
    ...
    :param limit: The maximum number of matches you'd like returned - defaults to 10.
    :returns: String containing xml or an lxml element.
    """
...
def set_person_citizenship(
    ...
    :param resident_alien: Boolean. e.g. 1 or 0.
    :returns: String containing xml or an lxml element.
    """
...
def set_person_race_ethnicity(
    ...
    :param person_id: The numeric ID of the person you're interested in.
    :param hispanic_or_latino: Boolean.
    :param race_ids: An array of race IDs.
    :returns: String containing xml or an lxml element.
    """
...
def set_student_assignment_grade(
    ...
    :param recalculate_final_grade: Boolean (e.g. 1 or 0). If set to 0, the final grade will be not be recalculated. Defaults to 1.
    :returns: String containing xml or an lxml element.
    """
...
def update_address(
    ...
    :param type: Person addresses: HOME, WORK, BILLING, SCHOOL, SHIPPING, OTHER
    :param primary: Boolean. Use if you want to mark the address as primary or not primary. e.g. 1 or 0
    :param old: Boolean. Use if you want to mark the address as old or not old. e.g. 1 or 0
    :param public: Boolean. Use if you want to mark the address as public or not public. e.g. 1 or 0
    :returns: String containing xml or an lxml element.
    """
...
def update_course_instance_assignment(
    ...
    :param extra_credit: Boolean. e.g. 1 or 0.
    ...
    :param proctored: Boolean. e.g. 1 or 0.
    :param test_submit_feedback: SCORE (score when available), FEEDBACK (score and response feedback - the default), ANSWERS (score, respsnse feedback, and correct answers).
    :param test_end_feedback: SCORE (score when available), FEEDBACK (score and response feedback), ANSWERS (score, respsnse feedback, and correct answers - the default).
    :param peer_grade: Boolean. e.g. 1 or 0.
    ...
    :param anonymous_reviews: Boolean. e.g. 1 or 0.
    ...
    :param allow_review_comments: Boolean. e.g. 1 or 0. Only used when review_visibility is not NEVER.
    :param reviews_time_due: When reviews are due (e.g. 2017-06-30 23:59:59 - must be in the course instance's timezone).
    :param reviews_closed_date_time: When reviews are closed (e.g. 2017-06-30 23:59:59 - must be in the course instance's timezone).
    :returns: String containing xml or an lxml element.
    """
...
def update_email_address(
    ...
    :param type: Person email addresses: HOME, WORK, SCHOOL, OTHER
    :param primary: Boolean. Use if you want to mark the email address as primary or not primary. e.g. 1 or 0
    :param old: Boolean. Use if you want to mark the email address as old or not old. e.g. 1 or 0
    :param public: Boolean. Use if you want to mark the email address as public or not public. e.g. 1 or 0
    :returns: String containing xml or an lxml element.
    """
...
def update_phone_number(
    ...
    :param type: Person phone numbers: HOME, WORK, MOBILE, SCHOOL, FAX, OTHER
    :param primary: Boolean. Use if you want to mark the phone number as primary or not primary. e.g. 1 or 0
    :param old: Boolean. Use if you want to mark the phone number as old or not old. e.g. 1 or 0
    :param public: Boolean. Use if you want to mark the phone number as public or not public. e.g. 1 or 0
    :returns: String containing xml or an lxml element.
    """
...
def update_student_attendance(
    ...
    :param status: PRESENT, ABSENT, TARDY, EXCUSED
    :returns: String containing xml or an lxml element.
    """
