...
class _RunBase(ChainedIdentity, HasRunPortal):
    ...
    def __init__(self, experiment, run_id, outputs=None, logs=None,
        ...
        self._data_container_id = _run_dto_as_dict.get("data_container_id", None)
        self._client._data_container_id = self._data_container_id
        ...
        self._latest_status = _run_dto_as_dict.get("status", None)
