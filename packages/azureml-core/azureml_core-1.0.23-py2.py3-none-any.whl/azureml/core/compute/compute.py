...
class ComputeTarget(ABC):
    ...
    def create(workspace, name, provisioning_configuration):
        ...
        Provision a Compute object associated with the provided workspace. This creates a new compute target rather
        than attaching an existing one. See https://docs.microsoft.com/azure/machine-learning/service/how-to-auto-
        train-remote#create-resource for an example of creating a resource using a provisioning_configuration.
    ...
    def attach(workspace, name, attach_configuration):
        ...
        Attach a Compute object associated with the provided workspace. The type of object to pass to
        attach_configuration is a :class:`azureml.core.compute.compute.ComputeTargetAttachConfiguration`
