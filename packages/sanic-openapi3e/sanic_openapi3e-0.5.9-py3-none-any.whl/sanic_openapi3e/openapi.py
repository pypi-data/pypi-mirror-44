...
def build_openapi_spec(app, _):
    ...
    openapi = _build_openapi_spec(
        app, hide_openapi_self, hide_excluded=True, show_unused_tags=show_unused_tags, hide_sanic_static=hide_sanic_static
    )
    global _openapi
    ...
    if show_excluded:
        openapi_all = _build_openapi_spec(
            app, hide_openapi_self, hide_excluded=False, show_unused_tags=True, hide_sanic_static=False
        )
        global _openapi_all
...
def _build_openapi_spec(
    app, hide_openapi_self=True, hide_excluded=True, show_unused_tags=False, hide_sanic_static=True
):
    """
    Build the OpenAPI spec.
    ...
    for _uri, _route in app.router.routes_all.items():
        ...
        for _method, _func in pathitem_operations:
            ...
            if path_item.x_exclude and hide_excluded:
                continue
            if _func.__module__ == sanic.static and hide_sanic_static:
                continue
