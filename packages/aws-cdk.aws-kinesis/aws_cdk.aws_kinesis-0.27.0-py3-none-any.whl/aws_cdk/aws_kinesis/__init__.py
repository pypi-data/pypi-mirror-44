...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-kinesis", "0.27.0", __name__, "aws-kinesis@0.27.0.jsii.tgz")
...
class IStream(aws_cdk.cdk.IConstruct, aws_cdk.aws_logs.ILogSubscriptionDestination, jsii.compat.Protocol):
    ...
    def grant_read(self, identity: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        ...

    @jsii.member(jsii_name="grantReadWrite")
    def grant_read_write(self, identity: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        ...

    @jsii.member(jsii_name="grantWrite")
    def grant_write(self, identity: typing.Optional[aws_cdk.aws_iam.IPrincipal]=None) -> None:
        ...
